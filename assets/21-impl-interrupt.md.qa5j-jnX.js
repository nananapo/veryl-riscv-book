...
</code></pre></div><p><span class="caption">▼リスト15.6: get_device関数でACLINTの範囲を定義する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30b8d657175dccf8efd21d31bfd9084bbdb422bb~1..30b8d657175dccf8efd21d31bfd9084bbdb422bb#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> MMAP_ACLINT_BEGIN &lt;= addr &amp;&amp; addr &lt;= MMAP_ACLINT_END {
    <span class="hljs-keyword">return</span> Device::ACLINT;
}
</code></pre></div><p>ACLINTとのインターフェースを追加し、 reset_all_device_masters関数にインターフェースをリセットするコードを追加します ( リスト7、 リスト8 )。</p><p><span class="caption">▼リスト15.7: ポートにACLINTのインターフェースを追加する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30b8d657175dccf8efd21d31bfd9084bbdb422bb~1..30b8d657175dccf8efd21d31bfd9084bbdb422bb#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> mmio_controller (
    clk          : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">clock</span>         ,
    rst          : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">reset</span>         ,
...
</code></pre></div><p><span class="caption">▼リスト15.8: インターフェースの要求部分をリセットする (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30b8d657175dccf8efd21d31bfd9084bbdb422bb~1..30b8d657175dccf8efd21d31bfd9084bbdb422bb#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> reset_all_device_masters () {
...
</code></pre></div><p><code>ready</code>、<code>rvalid</code>を取得する関数にACLINTを登録します ( リスト9、 リスト10 )。</p><p><span class="caption">▼リスト15.9: get_device_ready関数にACLINTのreadyを追加 (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30b8d657175dccf8efd21d31bfd9084bbdb422bb~1..30b8d657175dccf8efd21d31bfd9084bbdb422bb#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: <span class="hljs-keyword">return</span> aclint_membus.ready;
</code></pre></div><p><span class="caption">▼リスト15.10: get_device_rvalid関数にACLINTのrvalidを追加 (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30b8d657175dccf8efd21d31bfd9084bbdb422bb~1..30b8d657175dccf8efd21d31bfd9084bbdb422bb#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: <span class="hljs-keyword">return</span> aclint_membus.rvalid;
</code></pre></div><p>ACLINTの<code>rvalid</code>、<code>rdata</code>を<code>req_core</code>に割り当てます ( リスト11 )。</p><p><span class="caption">▼リスト15.11: ACLINTへのアクセス結果をreqに割り当てる (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30b8d657175dccf8efd21d31bfd9084bbdb422bb~1..30b8d657175dccf8efd21d31bfd9084bbdb422bb#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: req &lt;&gt; aclint_membus;
</code></pre></div><p>ACLINTのインターフェースに要求を割り当てます ( リスト12 )。</p><p><span class="caption">▼リスト15.12: ACLINTにreqを割り当ててアクセス要求する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30b8d657175dccf8efd21d31bfd9084bbdb422bb~1..30b8d657175dccf8efd21d31bfd9084bbdb422bb#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: {
    aclint_membus      &lt;&gt; req;
...
</code></pre></div><p><span class="caption">▼リスト15.14: mmio_controllerモジュールと接続するインターフェースのインスタンス化 (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30b8d657175dccf8efd21d31bfd9084bbdb422bb~1..30b8d657175dccf8efd21d31bfd9084bbdb422bb#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> aclint_membus  : Membus;
</code></pre></div><p>aclint_memoryモジュールをインスタンス化し、 mmio_controllerモジュールと接続します ( リスト15、 リスト16 )。</p><p><span class="caption">▼リスト15.15: aclint_memoryモジュールをインスタンス化する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30b8d657175dccf8efd21d31bfd9084bbdb422bb~1..30b8d657175dccf8efd21d31bfd9084bbdb422bb#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> aclintm: aclint_memory (
    clk                    ,
    rst                    ,
    membus: aclint_membus  ,
    aclint: aclint_core_bus,
);
</code></pre></div><p><span class="caption">▼リスト15.16: mmio_controllerモジュールと接続する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30b8d657175dccf8efd21d31bfd9084bbdb422bb~1..30b8d657175dccf8efd21d31bfd9084bbdb422bb#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> mmioc: mmio_controller (
    clk                           ,
    rst                           ,
...
</code></pre></div><p><span class="caption">▼リスト15.18: coreモジュールにaclint_ifインターフェースを接続する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30b8d657175dccf8efd21d31bfd9084bbdb422bb~1..30b8d657175dccf8efd21d31bfd9084bbdb422bb#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> c: core (
    clk                      ,
    rst                      ,
...
</code></pre></div><p>aclint_memoryモジュールに<code>msip0</code>レジスタを作成し、読み書きできるようにします ( リスト22、 リスト23、 リスト24 )。</p><p><span class="caption">▼リスト15.22: msip0レジスタの定義 (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9bb0576a17a9d788a6e469f2f9d36047ddfb4325~1..9bb0576a17a9d788a6e469f2f9d36047ddfb4325#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> msip0: <span class="hljs-keyword">logic</span>;
</code></pre></div><p><span class="caption">▼リスト15.23: msip0レジスタを0でリセットする (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9bb0576a17a9d788a6e469f2f9d36047ddfb4325~1..9bb0576a17a9d788a6e469f2f9d36047ddfb4325#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
        membus.rvalid = <span class="hljs-number">0</span>;
        membus.rdata  = <span class="hljs-number">0</span>;
        <span class="custom-hl-bold">msip0         = <span class="hljs-number">0</span>;</span>
</code></pre></div><p><span class="caption">▼リスト15.24: msip0レジスタの書き込み、読み込み (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9bb0576a17a9d788a6e469f2f9d36047ddfb4325~1..9bb0576a17a9d788a6e469f2f9d36047ddfb4325#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> membus.valid {
...
</code></pre></div><h3 id="mstatusのmie、mpieビットを実装する" tabindex="-1">mstatusのMIE、MPIEビットを実装する <a class="header-anchor" href="#mstatusのmie、mpieビットを実装する" aria-label="Permalink to “mstatusのMIE、MPIEビットを実装する”">​</a></h3><p>mstatus.MIE、MPIEを変更できるようにします ( リスト33、 リスト34 )。</p><p><span class="caption">▼リスト15.33: 書き込みマスクを変更する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b156570a8b9199e49b50ffe2b6576cf755fe2899~1..b156570a8b9199e49b50ffe2b6576cf755fe2899#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> MSTATUS_WMASK : UIntX = <span class="hljs-number">&#39;h0000_0000_0000_0088</span> <span class="hljs-keyword">as</span> UIntX;
</code></pre></div><p><span class="caption">▼リスト15.34: レジスタの場所を変数に割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b156570a8b9199e49b50ffe2b6576cf755fe2899~1..b156570a8b9199e49b50ffe2b6576cf755fe2899#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// mstatus bits</span>
...
</code></pre></div><p>トラップが発生するとき、mstatus.MPIEにmstatus.MIE、mstatus.MIEに<code>0</code>を設定します ( リスト35 )。 また、MRET命令でmstatus.MIEにmstatus.MPIE、mstatus.MPIEに<code>1</code>を設定します。</p><p><span class="caption">▼リスト15.35: トラップ、MRET命令の動作の実装 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b156570a8b9199e49b50ffe2b6576cf755fe2899~1..b156570a8b9199e49b50ffe2b6576cf755fe2899#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> raise_trap {
...
</code></pre></div><p><span class="caption">▼リスト15.37: mem_is_newをcan_intrに割り当てる (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/77dd715216bd55681a9683108df58efab35d48cd~1..77dd715216bd55681a9683108df58efab35d48cd#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>rs1_data   : memq_rdata.rs1_data  ,
<span class="custom-hl-bold">can_intr   : mems_is_new          ,</span>
rdata      : csru_rdata           ,
</code></pre></div><p>トラップが発生するときにmemunitモジュールを無効にします ( リスト38 )。 今まではEXステージまでに例外が発生することが分かっていたら無効にしていましたが、 csrunitモジュールからトラップが発生するかどうかの情報を直接得るようにします。</p><p><span class="caption">▼リスト15.38: validの条件を変更する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/77dd715216bd55681a9683108df58efab35d48cd~1..77dd715216bd55681a9683108df58efab35d48cd#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> memu: memunit (
    clk                                   ,
    rst                                   ,
    valid : mems_valid &amp;&amp; !<span class="custom-hl-bold">csru_raise_trap</span>,
</code></pre></div><h4 id="割り込みの判定" tabindex="-1">割り込みの判定 <a class="header-anchor" href="#割り込みの判定" aria-label="Permalink to “割り込みの判定”">​</a></h4><p>割り込みを起こすかどうか(<code>raise_intrrupt</code>)、 割り込みのcause(<code>intrrupt_cause</code>)、 トラップベクタ(<code>interrupt_vector</code>)を示す変数を作成します (リスト39)。</p><p><span class="caption">▼リスト15.39: 割り込みを判定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/77dd715216bd55681a9683108df58efab35d48cd~1..77dd715216bd55681a9683108df58efab35d48cd#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// Interrupt</span>
...
</code></pre></div><p>トラップ情報の変数に、割り込みの情報を割り当てます (リスト40)。 本書では例外を優先します。</p><p><span class="caption">▼リスト15.40: トラップを制御する変数に割り込みの値を割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/77dd715216bd55681a9683108df58efab35d48cd~1..77dd715216bd55681a9683108df58efab35d48cd#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">assign</span> raise_trap = raise_expt || <span class="custom-hl-bold">raise_interrupt ||</span> trap_return;
...
<span class="custom-hl-bold">    <span class="hljs-keyword">default</span>        : <span class="hljs-number">0</span>,</span>
<span class="custom-hl-bold">};</span>
</code></pre></div><p>割り込みの時にMRET命令の判定が<code>0</code>になるようにします (リスト41)。</p><p><span class="caption">▼リスト15.41: 割り込みが発生するとき、trap_returnを0にする (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/77dd715216bd55681a9683108df58efab35d48cd~1..77dd715216bd55681a9683108df58efab35d48cd#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// Trap Return</span>
<span class="hljs-keyword">assign</span> trap_return = valid &amp;&amp; is_mret &amp;&amp; !raise_expt <span class="custom-hl-bold">&amp;&amp; !raise_interrupt</span>;
</code></pre></div><p>トラップが発生するとき、 例外のときはmtvalレジスタに例外に固有の情報、割り込みの時は<code>0</code>が書き込まれます。</p><p>割り込みの時に各CSR、mtvalレジスタの値が設定されるようにします (リスト42)。</p><p><span class="caption">▼リスト15.42: 例外が発生したときにのみmtvalレジスタに書き込む (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/77dd715216bd55681a9683108df58efab35d48cd~1..77dd715216bd55681a9683108df58efab35d48cd#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> raise_trap {
...
</code></pre></div><p><span class="caption">▼リスト15.49: レジスタを0でリセットする (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/75cf9fa8cb0b12f40d1810b07c081aea20be7bdb~1..75cf9fa8cb0b12f40d1810b07c081aea20be7bdb#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
        membus.rvalid = <span class="hljs-number">0</span>;
        membus.rdata  = <span class="hljs-number">0</span>;
...
</code></pre></div><p><span class="caption">▼リスト15.50: mtime、mtimecmpの書き込み、読み込み (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/75cf9fa8cb0b12f40d1810b07c081aea20be7bdb~1..75cf9fa8cb0b12f40d1810b07c081aea20be7bdb#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> membus.wen {
    <span class="hljs-keyword">let</span> M: <span class="hljs-keyword">logic</span>&lt;MEMBUS_DATA_WIDTH&gt; = membus.wmask_expand();
    <span class="hljs-keyword">let</span> D: <span class="hljs-keyword">logic</span>&lt;MEMBUS_DATA_WIDTH&gt; = membus.wdata &amp; M;
    <span class="hljs-keyword">case</span> addr {
        MMAP_ACLINT_MSIP    : msip0     = D[<span class="hljs-number">0</span>] | msip0 &amp; ~M[<span class="hljs-number">0</span>];
...
</code></pre></div><p>aclint_ifインターフェースに<code>mtip</code>を作成し、タイマ割り込みが発生する条件を設定します ( リスト51、 リスト52 )。</p><p><span class="caption">▼リスト15.51: mtipをインターフェースに追加する (aclint_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/75cf9fa8cb0b12f40d1810b07c081aea20be7bdb~1..75cf9fa8cb0b12f40d1810b07c081aea20be7bdb#diff-4a970aed66e74f1c5e4a4397d31cedb3bb820d7d48d43d55e416807cb192c5ea">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> msip: <span class="hljs-keyword">logic</span>;
...
</code></pre></div><p><span class="caption">▼リスト15.52: mtipにタイマ割り込みが発生する条件を設定する (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/75cf9fa8cb0b12f40d1810b07c081aea20be7bdb~1..75cf9fa8cb0b12f40d1810b07c081aea20be7bdb#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    aclint.msip = msip0;
    <span class="custom-hl-bold">aclint.mtip = mtime &gt;= mtimecmp0;</span>
}
</code></pre></div><h3 id="mip-mtip、割り込み原因を設定する" tabindex="-1">mip.MTIP、割り込み原因を設定する <a class="header-anchor" href="#mip-mtip、割り込み原因を設定する" aria-label="Permalink to “mip.MTIP、割り込み原因を設定する”">​</a></h3><p>mipレジスタのMTIPビットにaclint_ifインターフェースの<code>mtip</code>を接続します (リスト53)。</p><p><span class="caption">▼リスト15.53: mip.MTIPにインターフェースのmtipを割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/75cf9fa8cb0b12f40d1810b07c081aea20be7bdb~1..75cf9fa8cb0b12f40d1810b07c081aea20be7bdb#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> mip: UIntX = {
    <span class="hljs-number">1&#39;b0</span> <span class="hljs-keyword">repeat</span> XLEN - <span class="hljs-number">12</span>, <span class="hljs-comment">// 0, LCOFIP</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// MEIP</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// 0</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// SEIP</span>
...
</code></pre></div><p>WFI命令で割り込みが発生するとき、mepcレジスタに<code>pc + 4</code>を書き込むようにします ( リスト57、 リスト58 )。</p><p><span class="caption">▼リスト15.57: WFI命令の判定 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f1cab4899641af211ef0a18ef5354d5682a1c708~1..f1cab4899641af211ef0a18ef5354d5682a1c708#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> is_wfi: <span class="hljs-keyword">logic</span> = inst_bits == <span class="hljs-number">32&#39;h10500073</span>;
</code></pre></div><p><span class="caption">▼リスト15.58: WFI命令のとき、mepcをpc+4にする (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f1cab4899641af211ef0a18ef5354d5682a1c708~1..f1cab4899641af211ef0a18ef5354d5682a1c708#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> raise_expt || raise_interrupt {
...
</code></pre></div><p>mtimeレジスタの値をACLINTモジュールからcsrunitに渡します ( リスト60、 リスト61 )。</p><p><span class="caption">▼リスト15.60: mtimeをインターフェースに追加する (aclint_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/3d41b6f01e611899d47a4b17c62ebe77f0197fff~1..3d41b6f01e611899d47a4b17c62ebe77f0197fff#diff-4a970aed66e74f1c5e4a4397d31cedb3bb820d7d48d43d55e416807cb192c5ea">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="custom-hl-bold"><span class="hljs-keyword">import</span> eei::*;</span>
...
</code></pre></div><p><span class="caption">▼リスト15.61: mtimeをインターフェースに割り当てる (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/3d41b6f01e611899d47a4b17c62ebe77f0197fff~1..3d41b6f01e611899d47a4b17c62ebe77f0197fff#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    aclint.msip  = msip0;
    aclint.mtip  = mtime &gt;= mtimecmp0;
    <span class="custom-hl-bold">aclint.mtime = mtime;</span>
}
</code></pre></div><p>time、instret、cycleレジスタを読み込めるようにします (リスト62)。</p><p><span class="caption">▼リスト15.62: rdataにインターフェースのmtimeを割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/3d41b6f01e611899d47a4b17c62ebe77f0197fff~1..3d41b6f01e611899d47a4b17c62ebe77f0197fff#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::CYCLE   : mcycle,
CsrAddr::TIME    : aclint.mtime,
CsrAddr::INSTRET : minstret,
</code></pre></div><hr class="footnotes-sep"><section class="footnotes"><ol class="footnotes-list"><li id="fn1" class="footnote-item"><p>コンパイル、実行方法は<a href="./12-impl-mmio.html">「11.6.4 出力をテストする」</a>を参考にしてください。 <a href="#fnref1" class="footnote-backref">↩︎</a></p></li><li id="fn2" class="footnote-item"><p>mhpmcounterレジスタと同じ値をとるhpmcounterレジスタもありますが、mhpmcounterレジスタを実装していないので実装しません。 <a href="#fnref2" class="footnote-backref">↩︎</a></p></li></ol></section>`,242)])])}const v=a(r,[["render",b]]);export{j as __pageData,v as default};
