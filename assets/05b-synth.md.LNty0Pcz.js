...
</code></pre></div><p>書き込みマスクはすべて書き込み可にします(リスト2)。</p><p><span class="caption">▼リスト8.2: LEDの制御用レジスタの書き込みマスク (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7f162d05df55da92391cd1d69f0a8255882977b8~1..7f162d05df55da92391cd1d69f0a8255882977b8#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> LED_WMASK   : UIntX = <span class="hljs-number">&#39;hffff_ffff_ffff_ffff</span>;
</code></pre></div><p>LEDの制御用レジスタをcsrunitモジュールのポートに定義します。CSRの幅はUIntXです(リスト3)。</p><p><span class="caption">▼リスト8.3: LEDの制御用レジスタを定義する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7f162d05df55da92391cd1d69f0a8255882977b8~1..7f162d05df55da92391cd1d69f0a8255882977b8#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> csrunit (
...
</code></pre></div><p><code>rdata</code>と<code>wmask</code>にLEDの制御用レジスタの値を割り当てます(リスト4)。</p><p><span class="caption">▼リスト8.4: rdataとwmaskに値を割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7f162d05df55da92391cd1d69f0a8255882977b8~1..7f162d05df55da92391cd1d69f0a8255882977b8#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// read</span>
...
wmask = <span class="hljs-keyword">case</span> csr_addr {
...
</code></pre></div><p>リセット時にLEDの制御用レジスタの値を0に設定します(リスト5)。</p><p><span class="caption">▼リスト8.5: リセット値の設定 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7f162d05df55da92391cd1d69f0a8255882977b8~1..7f162d05df55da92391cd1d69f0a8255882977b8#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if_reset</span> {
...
</code></pre></div><p>LEDの制御用レジスタへの書き込み処理を実装します(リスト6)。</p><p><span class="caption">▼リスト8.6: LEDの制御用レジスタへの書き込み (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7f162d05df55da92391cd1d69f0a8255882977b8~1..7f162d05df55da92391cd1d69f0a8255882977b8#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> csr_addr {
    ...
    <span class="custom-hl-bold">led     : <span class="hljs-keyword">output</span>  UIntX                                    ,</span>
</code></pre></div><p><span class="caption">▼リスト8.8: csrunitモジュールのledポートと接続する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7f162d05df55da92391cd1d69f0a8255882977b8~1..7f162d05df55da92391cd1d69f0a8255882977b8#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> csru: csrunit (
    clk                            ,
    rst                            ,
    valid   : mems_valid           ,
    pc      : mems_pc              ,
...
</code></pre></div><p><span class="caption">▼リスト8.10: coreモジュールのledポートと接続する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7f162d05df55da92391cd1d69f0a8255882977b8~1..7f162d05df55da92391cd1d69f0a8255882977b8#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> c: core (
    clk       ,
    rst       ,
    i_membus  ,
    d_membus  ,
...
</code></pre></div><p>CSRの読み書きによってLED制御用のポートを制御できるようになりました。</p><h3 id="テストを作成する" tabindex="-1">テストを作成する <a class="header-anchor" href="#テストを作成する" aria-label="Permalink to “テストを作成する”">​</a></h3><h4 id="ledを点灯させるプログラム" tabindex="-1">LEDを点灯させるプログラム <a class="header-anchor" href="#ledを点灯させるプログラム" aria-label="Permalink to “LEDを点灯させるプログラム”">​</a></h4><p>LEDを点灯させるプログラムを作成します(リスト11、リスト12)。 CSRRWI命令で<code>0x800</code>に12(<code>&#39;b01100</code>)を書き込みます。</p><p><span class="caption">▼リスト8.11: LEDを点灯させるプログラム (test/led.asm)</span> <a href="https://github.com/nananapo/bluecore/compare/3510e0743530e034c56d50a81fada26d74da0b73~1..3510e0743530e034c56d50a81fada26d74da0b73#diff-284afde569993ef66f621362c3367f42ad28b59b7784a967fb76fecfaf1cdf34">差分をみる</a></p><div class="language-asm"><button title="Copy Code" class="copy"></button><span class="lang">asm</span><pre class="hljs"><code>80065073 //  0: csrrwi x0, 0x800, 12
00000067 //  4: jal x0, 0
</code></pre></div><p><span class="caption">▼リスト8.12: LEDを点灯させるプログラム (test/led.hex)</span> <a href="https://github.com/nananapo/bluecore/compare/3510e0743530e034c56d50a81fada26d74da0b73~1..3510e0743530e034c56d50a81fada26d74da0b73#diff-bb7cb663c9af36f3d1c8abf0808fcce6ba06f23d970b15280e94460c26a9fe8e">差分をみる</a></p><div class="language-hex"><button title="Copy Code" class="copy"></button><span class="lang">hex</span><pre class="hljs"><code>0000006780065073
</code></pre></div><h4 id="ledを点滅させるプログラム" tabindex="-1">LEDを点滅させるプログラム <a class="header-anchor" href="#ledを点滅させるプログラム" aria-label="Permalink to “LEDを点滅させるプログラム”">​</a></h4><p>LEDを点滅させるプログラムを作成します(リスト13、リスト14)。 これはちょっと複雑です。</p><p><span class="caption">▼リスト8.13: LEDを点滅させるプログラム (test/led_counter.asm)</span> <a href="https://github.com/nananapo/bluecore/compare/3510e0743530e034c56d50a81fada26d74da0b73~1..3510e0743530e034c56d50a81fada26d74da0b73#diff-790bb5a898a4cda6cc0bb5372bcef8a568ba4515bad7cde1b6eada40dd3bf722">差分をみる</a></p><div class="language-asm"><button title="Copy Code" class="copy"></button><span class="lang">asm</span><pre class="hljs"><code>000f40b7 //  0: lui x1, 244
...
</code></pre></div><h3 id="プロジェクトを作成する" tabindex="-1">プロジェクトを作成する <a class="header-anchor" href="#プロジェクトを作成する" aria-label="Permalink to “プロジェクトを作成する”">​</a></h3><p>新規プロジェクトを作成します。 GOWIN FPGA Designerを開いて、Quick Startの<code>New Project...</code>を選択します。 選択したら表示されるウィンドウでは、FPGA Design Projectを選択してOKを押してください(図6)。</p><p><img src="`+t+'" alt="FPGA Design Projectを選択する"> プロジェクト名と場所を指定します。 プロジェクト名はtangnano9k、場所は好きな場所に指定してください(図7)。</p><p><img src="'+r+'" alt="プロジェクト名と場所の指定"> ターゲットのFPGAを選択します。 <code>GW1NR-LV9QN88PC6/I5</code>を選択して、Nextを押してください(図8)。</p><p><img src="'+i+'" alt="ターゲットを選択する"> プロジェクトが作成されました(図9)。</p><p><img src="'+h+'" alt="プロジェクトが作成された"></p><h3 id="設定を変更する" tabindex="-1">設定を変更する <a class="header-anchor" href="#設定を変更する" aria-label="Permalink to “設定を変更する”">​</a></h3><p>プロジェクトのデフォルト設定ではSystemVerilogを利用できないため、設定を変更します。</p><p>ProjectのConfigurationから、設定画面を開きます(図10)。</p><p><img src="'+f+'" alt="設定画面を開く"> SynthesizeのVerilog Languageを<code>System Verilog 2017</code>に設定します。 同じ画面でトップモジュール(Top Module/Entity)を設定できるため、<code>core_top_tang</code>を指定します(図11)。</p><p><img src="'+b+`" alt="設定を変更する"></p><h3 id="設計ファイルを追加する" tabindex="-1">設計ファイルを追加する <a class="header-anchor" href="#設計ファイルを追加する" aria-label="Permalink to “設計ファイルを追加する”">​</a></h3><p>Verylのソースファイルをビルドして、 生成されるファイルリスト(<code>core.f</code>)を利用して、 生成されたSystemVerilogソースファイルをプロジェクトに追加します。</p><p>Gowin FPGA Programmerでファイルを追加するには、 ウィンドウ下部のConsole画面で<code>add_file</code>を実行します。 しかし、<code>add_file</code>はファイルリストの読み込みに対応していないので、 ファイルリストを読み込んで<code>add_file</code>を実行するスクリプトを作成します(リスト16)。</p><p><span class="caption">▼リスト8.16: add_files.tcl</span> <a href="https://github.com/nananapo/bluecore/compare/2f9e7b7e91d258b26c5d7f9b55007afff481891a~1..2f9e7b7e91d258b26c5d7f9b55007afff481891a#diff-8283e6a9dfc65ef0dd7452f296df23cf3b41035c897450800e5915214043eafe">差分をみる</a></p><div class="language-tcl"><button title="Copy Code" class="copy"></button><span class="lang">tcl</span><pre class="hljs"><code><span class="hljs-keyword">set</span> file_list [<span class="hljs-keyword">open</span> <span class="hljs-string">&quot;ファイルリストのパス&quot;</span> r]
...
</code></pre></div><p><code>IO_LOC</code>で接続する場所の名前を指定します。</p><p>場所の名前はTang Nano 9Kのデータシートで確認できます。 例えば図17と図18から、 LEDは<code>10</code>、<code>11</code>、<code>13</code>、<code>14</code>、<code>15</code>、<code>16</code>に割り当てられていることが分かります。 また、LEDが負論理(<code>1</code>で消灯、<code>0</code>で点灯)であることが分かります。 水晶発信器とボタンについても、データシートを見て確認してください。</p><p><img src="`+j+'" alt="LED"><img src="'+k+'" alt="PIN10_IOL～の接続先"></p><h4 id="タイミング制約" tabindex="-1">タイミング制約 <a class="header-anchor" href="#タイミング制約" aria-label="Permalink to “タイミング制約”">​</a></h4><p>FPGAが何MHzで動くかをタイミング制約ファイルに記述します。</p><p>物理制約ファイルと同じようにAdd Fileを選択して、 タイミング制約ファイルを作成します(図19)。</p><p><img src="'+E+'" alt="タイミング制約ファイルを選択する"> 名前は<code>timing.sdc</code>にします(図20)。</p><p><img src="'+P+`" alt="名前を設定する"> タイミング制約ファイルには、次のように記述します(リスト19)。</p><p><span class="caption">▼リスト8.19: タイミング制約ファイル (timing.sdc)</span> <a href="https://github.com/nananapo/bluecore/compare/2f9e7b7e91d258b26c5d7f9b55007afff481891a~1..2f9e7b7e91d258b26c5d7f9b55007afff481891a#diff-3e6d45fecec520db4054200018c09a23e1ddc0f244d284912592561fddd47210">差分をみる</a></p><div class="language-sdc"><button title="Copy Code" class="copy"></button><span class="lang">sdc</span><pre class="hljs"><code>create_clock -name clk -period 37.037 -waveform {0 18.518} [get_ports {clk}]
