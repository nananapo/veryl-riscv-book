...
</code></pre></div><p><span class="caption">▼リスト18.4: masterにexptを追加する (membus_if.veryl, core_data_if.veryl, core_inst_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9e7879dc3f5ef27804a750564e20ee8a08de8049~1..9e7879dc3f5ef27804a750564e20ee8a08de8049#diff-5b8ff8b1b43eb415d367759fb46872980d16065c43c0a71a75fec85e987ad460">差分をみる</a></p>`,65),s("div",{class:"language-veryl"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"veryl"),s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"modport"),a(` master {
    valid       : `),s("span",{class:"hljs-keyword"},"output"),a(`,
`),s("span",{class:"foldable-code"},[s("span",{class:"fold-trigger",onclick:"this.parentElement.classList.add('expanded')"}),s("span",{class:"fold-content"},[a("    ready       : "),s("span",{class:"hljs-keyword"},"input"),a(` ,
    addr        : `),s("span",{class:"hljs-keyword"},"output"),a(`,
    wen         : `),s("span",{class:"hljs-keyword"},"output"),a(`,
    wdata       : `),s("span",{class:"hljs-keyword"},"output"),a(`,
    wmask       : `),s("span",{class:"hljs-keyword"},"output"),a(`,
`)])]),a("    rvalid      : "),s("span",{class:"hljs-keyword"},"input"),a(` ,
    rdata       : `),s("span",{class:"hljs-keyword"},"input"),a(` ,
    `),s("span",{class:"custom-hl-bold"},[a("expt        : "),s("span",{class:"hljs-keyword"},"input"),a(" ,")]),a(`
    wmask_expand: `),s("span",{class:"hljs-keyword"},"import"),a(`,
}
`)])])],-1),e(`<p><span class="caption">▼リスト18.5: responseにexptを追加する (membus_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9e7879dc3f5ef27804a750564e20ee8a08de8049~1..9e7879dc3f5ef27804a750564e20ee8a08de8049#diff-5b8ff8b1b43eb415d367759fb46872980d16065c43c0a71a75fec85e987ad460">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">modport</span> response {
...
`)])])],-1),s("p",null,[s("span",{class:"caption"},"▼リスト18.21: csrunitモジュールにメモリアドレスとインターフェースを割り当てる (core.veryl)"),a(),s("a",{href:"https://github.com/nananapo/bluecore/compare/9e7879dc3f5ef27804a750564e20ee8a08de8049~1..9e7879dc3f5ef27804a750564e20ee8a08de8049#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510"},"差分をみる")],-1),s("div",{class:"language-veryl"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"veryl"),s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"inst"),a(` csru: csrunit (
    clk                               ,
`),s("span",{class:"foldable-code"},[s("span",{class:"fold-trigger",onclick:"this.parentElement.classList.add('expanded')"}),s("span",{class:"fold-content"},[a(`    rst                               ,
    valid      : mems_valid           ,
    pc         : mems_pc              ,
