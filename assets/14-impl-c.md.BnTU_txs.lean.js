import{_ as e,c as p,o as c,ah as n,j as s,a,bF as r,bG as d}from"./chunks/framework.HhScKIQu.js";const j=JSON.parse('{"title":"C拡張の実装","description":"","frontmatter":{},"headers":[],"relativePath":"14-impl-c.md","filePath":"14-impl-c.md"}'),t={name:"14-impl-c.md"};function o(i,l,h,b,f,m){return c(),p("div",null,[...l[0]||(l[0]=[n("",126),s("div",{class:"language-veryl"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"veryl"),s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"if"),a(" offset == "),s("span",{class:"hljs-number"},"6"),a(` {
