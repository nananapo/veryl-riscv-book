...
</code></pre></div><p><span class="caption">▼リスト18.5: responseにexptを追加する (membus_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-5b8ff8b1b43eb415d367759fb46872980d16065c43c0a71a75fec85e987ad460">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">modport</span> response {
...
</code></pre></div><h4 id="mmio-controllerモジュールの対応" tabindex="-1">mmio_controllerモジュールの対応 <a class="header-anchor" href="#mmio-controllerモジュールの対応" aria-label="Permalink to “mmio_controllerモジュールの対応”">​</a></h4><p>mmio_controllerモジュールで構造体の値をすべて<code>0</code>に設定します ( リスト6、 リスト7 )。 いまのところ、デバイスは例外を発生させません。</p><p><span class="caption">▼リスト18.6: exptを0に設定する (membus_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p>mmio_controllerモジュールからの例外情報を <code>core_data_if</code>、<code>core_inst_if</code>インターフェースに伝達します。</p><p><span class="caption">▼リスト18.7: exptを伝達する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p><code>fetch_fifo</code>から<code>issue_fifo</code>に例外情報を伝達します ( リスト11)、 リスト12、 リスト13 )。 offsetが<code>6</code>で例外が発生しているとき、 32ビット幅の命令の上位16ビットを取得せずにすぐに<code>issue_fifo</code>に例外を書き込みます。</p><p><span class="caption">▼リスト18.11: fetch_fifoからissue_fifoに例外情報を伝達する (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p><code>issue_fifo</code>からcoreモジュールに例外情報を伝達します (リスト14)。</p><p><span class="caption">▼リスト18.14: issue_fifoからcoreモジュールに例外情報を伝達する (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><h4 id="amounitモジュールの対応" tabindex="-1">amounitモジュールの対応 <a class="header-anchor" href="#amounitモジュールの対応" aria-label="Permalink to “amounitモジュールの対応”">​</a></h4><p><code>state</code>が<code>State::Init</code>以外の時に例外が発生した場合、 すぐに結果を返すようにします ( リスト15、 リスト16、 リスト17、 )。 例外が発生したクロックでは要求を受け付けないようにします。</p><p><span class="caption">▼リスト18.15: slaveにexptを割り当てる (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p><span class="caption">▼リスト18.16: 例外が発生したらすぐに結果を返し、readyを0にする (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>        <span class="hljs-keyword">default</span>: {}
    }
...
</code></pre></div><p><span class="caption">▼リスト18.17: 例外が発生していたらmasterに要求するのをやめる (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>        State::AMOStoreValid: accept_request_comb();
        <span class="hljs-keyword">default</span>             : {}
    }
...
</code></pre></div><p>例外が発生したら、<code>state</code>を<code>State::Init</code>にリセットします (リスト18)。</p><p><span class="caption">▼リスト18.18: 例外が発生していたらstateをInitにリセットする (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> on_clock () {
    <span class="custom-hl-bold"><span class="hljs-keyword">if</span> state != State::Init &amp;&amp; master.expt.valid {</span>
...
</code></pre></div><h4 id="ロード、ストア命令のpage-fault例外の実装" tabindex="-1">ロード、ストア命令のpage fault例外の実装 <a class="header-anchor" href="#ロード、ストア命令のpage-fault例外の実装" aria-label="Permalink to “ロード、ストア命令のpage fault例外の実装”">​</a></h4><p>ロード命令、ストア命令、A拡張の命令のメモリアクセス中にページフォルト例外が発生していたとき、 Load page fault例外、Store/AMO page fault例外を発生させます。</p><p>csrunitモジュールに、 メモリにアクセスする命令の例外情報を監視するためのポートを作成します ( リスト20、 リスト21 )。</p><p><span class="caption">▼リスト18.20: メモリアドレス、例外の監視用のポートを追加する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p>`,136),s("div",{class:"language-veryl"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"veryl"),s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"module"),a(` csrunit (
...
`)])])],-1),e(`<p>例外を発生させます (リスト22、 リスト23)。</p><p><span class="caption">▼リスト18.22: メモリアクセス中に例外が発生しているかをチェックする (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> expt_memory_fault    : <span class="hljs-keyword">logic</span> = membus.rvalid &amp;&amp; membus.expt.valid;
</code></pre></div><p><span class="caption">▼リスト18.23: 例外を発生させる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> raise_expt: <span class="hljs-keyword">logic</span> = valid &amp;&amp; (expt_info.valid || expt_write_readonly_csr || expt_csr_priv_violation || expt_zicntr_priv || expt_trap_return_priv <span class="custom-hl-bold">|| expt_memory_fault</span>);
...
</code></pre></div><p>xtvalに例外が発生したアドレスを設定します (リスト24)。</p><p><span class="caption">▼リスト18.24: 例外の原因を設定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/489e60eeec364b79f1b16fd323f3370924a603db~1..489e60eeec364b79f1b16fd323f3370924a603db#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> expt_value: UIntX = <span class="hljs-keyword">switch</span> {
...
`)])])],-1),e(`<p>xtvalを生成するとき、オフセットを足します ( リスト27、 リスト28 )。</p><p><span class="caption">▼リスト18.27: 命令アドレスにオフセットを足す (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/db7d2c57893ec808b8a0dabbef6ad6c1d2bd66bd~1..db7d2c57893ec808b8a0dabbef6ad6c1d2bd66bd#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>exq_wdata.expt.valid = <span class="hljs-number">1</span>;
...
</code></pre></div><h2 id="satpレジスタの作成" tabindex="-1">satpレジスタの作成 <a class="header-anchor" href="#satpレジスタの作成" aria-label="Permalink to “satpレジスタの作成”">​</a></h2><p>satpレジスタを実装します ( リスト29、 リスト30、 リスト31、 リスト32、 リスト33 )。 すべてのフィールドを読み書きできるように設定して、 値を<code>0</code>でリセットします。</p><p><span class="caption">▼リスト18.29: satpレジスタを作成する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a~1..4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> satp      : UIntX ;
</code></pre></div><p><span class="caption">▼リスト18.30: satpレジスタを0でリセットする (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a~1..4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>satp       = <span class="hljs-number">0</span>;
</code></pre></div><p><span class="caption">▼リスト18.31: rdataにsatpレジスタの値を設定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a~1..4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::SATP      : satp,
</code></pre></div><p><span class="caption">▼リスト18.32: 書き込みマスクの定義 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a~1..4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> SATP_WMASK      : UIntX = <span class="hljs-number">&#39;hffff_ffff_ffff_ffff</span>;
</code></pre></div><p><span class="caption">▼リスト18.33: wmaskに書き込みマスクを設定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a~1..4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::SATP      : SATP_WMASK,
</code></pre></div><p>satpレジスタは、 MODEフィールドに書き込もうとしている値がサポートしないMODEなら、 satpレジスタの変更を全ビットについて無視すると定められています。</p><p>本章ではBareとSv39だけをサポートするため、 MODEには<code>0</code>と<code>8</code>のみ書き込めるようにして、 それ以外の値を書き込もうとしたらsatpレジスタへの書き込みを無視します ( リスト34、 リスト35 )。</p><p><span class="caption">▼リスト18.34: satに書き込む値を生成する関数 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a~1..4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> validate_satp (
...
</code></pre></div><p><span class="caption">▼リスト18.35: satpレジスタに書き込む (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a~1..4503a7102982ed7d8f2f2e1615e73bbc2c9cd14a#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::SATP      : satp       = validate_satp(satp, wdata);
</code></pre></div><h2 id="mstatusのmxr、sum、mprvビットの実装" tabindex="-1">mstatusのMXR、SUM、MPRVビットの実装 <a class="header-anchor" href="#mstatusのmxr、sum、mprvビットの実装" aria-label="Permalink to “mstatusのMXR、SUM、MPRVビットの実装”">​</a></h2><p>mstatusレジスタのMXR、SUM、MPRVビットを変更できるようにします ( リスト36、 リスト37 )。</p><p><span class="caption">▼リスト18.36: 書き込みマスクの変更 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fba738edd38b9a068608d0b2edabdd41f3525a18~1..fba738edd38b9a068608d0b2edabdd41f3525a18#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> MSTATUS_WMASK   : UIntX = <span class="hljs-number">&#39;h0000_0000_006</span><span class="custom-hl-bold">e</span>_19aa <span class="hljs-keyword">as</span> UIntX;
</code></pre></div><p><span class="caption">▼リスト18.37: 書き込みマスクの変更 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fba738edd38b9a068608d0b2edabdd41f3525a18~1..fba738edd38b9a068608d0b2edabdd41f3525a18#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> SSTATUS_WMASK   : UIntX = <span class="hljs-number">&#39;h0000_0000_000</span><span class="custom-hl-bold">c</span>_0122 <span class="hljs-keyword">as</span> UIntX;
</code></pre></div><p>それぞれのビットを示す変数を作成します ( リスト38、 リスト39 )。</p><p><span class="caption">▼リスト18.38: mstatusのMXR、SUM、MPRVビットを示す変数を作成する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fba738edd38b9a068608d0b2edabdd41f3525a18~1..fba738edd38b9a068608d0b2edabdd41f3525a18#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> mstatus_mxr : <span class="hljs-keyword">logic</span>    = mstatus[<span class="hljs-number">19</span>];
...
</code></pre></div><p>mstatus.MPRVは、M-mode以外のモードに戻るときに<code>0</code>に設定されると定められています。 そのため、<code>trap_mode_next</code>を確認して<code>0</code>を設定します。</p><p><span class="caption">▼リスト18.39: mstatus.MPRVをMRET、SRET命令で0に設定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fba738edd38b9a068608d0b2edabdd41f3525a18~1..fba738edd38b9a068608d0b2edabdd41f3525a18#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>} <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> trap_return {
...
</code></pre></div><h2 id="アドレス変換モジュール-ptw-の実装" tabindex="-1">アドレス変換モジュール(PTW)の実装 <a class="header-anchor" href="#アドレス変換モジュール-ptw-の実装" aria-label="Permalink to “アドレス変換モジュール(PTW)の実装”">​</a></h2><p>ページテーブルエントリをフェッチしてアドレス変換を行うptwモジュールを作成します。 まず、MODEがBareのとき(仮想アドレス = 物理アドレス)の動作を実装し、 Sv39を<a href="./24-impl-paging.html">「18.9 Sv39の実装」</a>で実装します。</p><h3 id="csrのインターフェースを実装する" tabindex="-1">CSRのインターフェースを実装する <a class="header-anchor" href="#csrのインターフェースを実装する" aria-label="Permalink to “CSRのインターフェースを実装する”">​</a></h3><p>ページングで使用するCSRを、csrunitモジュールからptwモジュールに渡すためのインターフェースを定義します。</p><p><code>src/ptw_ctrl_if.veryl</code>を作成し、次のように記述します (リスト40)。</p><p><span class="caption">▼リスト18.40: ptw_ctrl_if.veryl</span> <a href="https://github.com/nananapo/bluecore/compare/fe8939c6b9efd5e3b9824e3360653111ef54b8e1~1..fe8939c6b9efd5e3b9824e3360653111ef54b8e1#diff-ba3da29ff5998250e8bc14fd0c49d19d26129a864886b9a8d7a487e4e8b08266">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">import</span> eei::*;
...
</code></pre></div><p><code>slave</code>はcoreモジュール側からの仮想アドレスによる要求を受け付けるためのインターフェースです。 <code>master</code>はmmio_conterollerモジュール側に物理アドレスによるアクセスを行うためのインターフェースです。</p><p><code>is_inst</code>を使い、ページングが有効かどうか判定します (リスト42)。</p><p><span class="caption">▼リスト18.42: ページングが有効かどうかを判定する (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fe8939c6b9efd5e3b9824e3360653111ef54b8e1~1..fe8939c6b9efd5e3b9824e3360653111ef54b8e1#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> paging_enabled: <span class="hljs-keyword">logic</span> = ctrl.is_enabled(is_inst);
</code></pre></div><p>状態の管理のために<code>State</code>型を定義します (リスト43)。</p><p><span class="caption">▼リスト18.43: 状態の定義 (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fe8939c6b9efd5e3b9824e3360653111ef54b8e1~1..fe8939c6b9efd5e3b9824e3360653111ef54b8e1#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">enum</span> State {
    IDLE,
    EXECUTE_READY,
    EXECUTE_VALID,
}
...
</code></pre></div><p>状態に基づいて、<code>ready</code>と結果を<code>slave</code>に割り当てます (リスト47)。</p><p><span class="caption">▼リスト18.47: slaveに結果を割り当てる (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fe8939c6b9efd5e3b9824e3360653111ef54b8e1~1..fe8939c6b9efd5e3b9824e3360653111ef54b8e1#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    slave.ready  = <span class="hljs-number">0</span>;
    slave.rvalid = <span class="hljs-number">0</span>;
    slave.rdata  = <span class="hljs-number">0</span>;
...
</code></pre></div><p>状態を遷移する処理を記述します (リスト48)。 要求を受け入れるとき、<code>slave_saved</code>に要求を保存します。</p><p><span class="caption">▼リスト18.48: 状態を遷移する (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fe8939c6b9efd5e3b9824e3360653111ef54b8e1~1..fe8939c6b9efd5e3b9824e3360653111ef54b8e1#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> accept_request_ff () {
...
</code></pre></div><p>今処理している要求、 または今のクロックから処理し始める要求が命令フェッチによるものか判定する変数を作成します (リスト51)。</p><p><span class="caption">▼リスト18.51: ptwモジュールが処理する要求が命令フェッチによるものかを判定する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fe8939c6b9efd5e3b9824e3360653111ef54b8e1~1..fe8939c6b9efd5e3b9824e3360653111ef54b8e1#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> ptw_is_inst  : <span class="hljs-keyword">logic</span> = (i_membus.ready &amp;&amp; i_membus.valid) || <span class="hljs-comment">// inst ack or</span>
...
</code></pre></div><p>csrunitモジュールとptwモジュールを<code>ptw_ctrl_if</code>インターフェースで接続するために、 coreモジュールにポートを追加します ( リスト53、 リスト54 )。</p><p><span class="caption">▼リスト18.53: coreモジュールにptw_ctrl_ifインターフェースを追加する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fe8939c6b9efd5e3b9824e3360653111ef54b8e1~1..fe8939c6b9efd5e3b9824e3360653111ef54b8e1#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> core (
    clk     : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">clock</span>               ,
    rst     : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">reset</span>               ,
...
</code></pre></div><p><span class="caption">▼リスト18.54: ptw_ctrl_ifインターフェースを割り当てる (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fe8939c6b9efd5e3b9824e3360653111ef54b8e1~1..fe8939c6b9efd5e3b9824e3360653111ef54b8e1#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> c: core (
    clk                      ,
    rst                      ,
...
</code></pre></div><p>csrunitモジュールにポートを追加し、CSRを割り当てます ( リスト55、 リスト56、 リスト57 )。</p><p><span class="caption">▼リスト18.55: csunitモジュールにptw_ctrl_ifインターフェースを追加する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fe8939c6b9efd5e3b9824e3360653111ef54b8e1~1..fe8939c6b9efd5e3b9824e3360653111ef54b8e1#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>    membus     : <span class="hljs-keyword">modport</span> core_data_if::master    ,
    <span class="custom-hl-bold">ptw_ctrl   : <span class="hljs-keyword">modport</span> ptw_ctrl_if::master     ,</span>
) {
</code></pre></div><p><span class="caption">▼リスト18.56: csrunitモジュールのインスタンスにptw_ctrl_ifインターフェースを割り当てる (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fe8939c6b9efd5e3b9824e3360653111ef54b8e1~1..fe8939c6b9efd5e3b9824e3360653111ef54b8e1#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>    membus     : d_membus             ,
    <span class="custom-hl-bold">ptw_ctrl                          ,</span>
);
</code></pre></div><p><span class="caption">▼リスト18.57: インターフェースにCSRの値を割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/fe8939c6b9efd5e3b9824e3360653111ef54b8e1~1..fe8939c6b9efd5e3b9824e3360653111ef54b8e1#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    ptw_ctrl.priv = mode;
    ptw_ctrl.satp = satp;
...
</code></pre></div><h3 id="pteの定義" tabindex="-1">PTEの定義 <a class="header-anchor" href="#pteの定義" aria-label="Permalink to “PTEの定義”">​</a></h3><p>Sv39のPTEのビットを分かりやすく取得するために、 次のインターフェースを定義します。</p><p><code>src/pte.veryl</code>を作成し、次のように記述します (リスト59)。</p><p><span class="caption">▼リスト18.59: pte.veryl</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-259fd1758d5312bfecd7c564016b28fdf09aaa9ff7822ed5d891a9ccc02ae337">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">import</span> eei::*;
...
</code></pre></div><p>PTEの値を使った関数を定義します (リスト60)。</p><p><span class="caption">▼リスト18.60: PTEの値を使った関数を定義する (pte.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-259fd1758d5312bfecd7c564016b28fdf09aaa9ff7822ed5d891a9ccc02ae337">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// leaf PTEか判定する</span>
...
</code></pre></div><h3 id="ptwモジュールの実装" tabindex="-1">ptwモジュールの実装 <a class="header-anchor" href="#ptwモジュールの実装" aria-label="Permalink to “ptwモジュールの実装”">​</a></h3><p>sv39utilパッケージをimportします (リスト61)。</p><p><span class="caption">▼リスト18.61: sv39utilパッケージをimportする (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">import</span> sv39util::*;
</code></pre></div><p>PTE39インターフェースをインスタンス化します (リスト62)。 <code>value</code>には<code>master</code>のロード結果を割り当てます。</p><p><span class="caption">▼リスト18.62: PTE39インターフェースをインスタンス化する (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> pte      : PTE39;
<span class="hljs-keyword">assign</span> pte.value = master.rdata;
</code></pre></div><p><img src="`+_+`" alt="状態の遷移図 (点線の状態で新しく要求を受け付け、二重丸の状態で結果を返す)"></p><p class="caption" style="text-align:center;font-weight:bold;">▲図12: 状態の遷移図 (点線の状態で新しく要求を受け付け、二重丸の状態で結果を返す)</p><p>仮想アドレスを変換するための状態を追加します (リスト63)。 本章ではページングが有効な時に、 <code>state</code>が図12のように遷移するようにします。</p><p><span class="caption">▼リスト18.63: 状態の定義 (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">enum</span> State {
    IDLE,
...
</code></pre></div><p>現在のPTEのlevel(<code>level</code>)、 PTEのアドレス(<code>taddr</code>)を格納するためのレジスタを定義します ( リスト64、 リスト65 )。</p><p><span class="caption">▼リスト18.64: レジスタの定義 (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> physical_addr: Addr    ;
...
</code></pre></div><p><span class="caption">▼リスト18.65: レジスタをリセットする (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> on_reset () {
    state             = State::IDLE;
    physical_addr     = <span class="hljs-number">0</span>;
...
</code></pre></div><p>PTEのフェッチのために<code>master</code>に要求を割り当てます (リスト66)。 PTEは<code>taddr</code>を使ってアクセスします。</p><p><span class="caption">▼リスト18.66: masterに要求を割り当てる (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> state {
    State::IDLE         : accept_request_comb();
...
</code></pre></div><p><code>slave</code>への結果の割り当てで、ページフォルト例外が発生していた場合の結果を割り当てます (リスト67)。</p><p><span class="caption">▼リスト18.67: ページフォルト例外のときの結果を割り当てる (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>State::PAGE_FAULT: {
...
</code></pre></div><p>ページングが有効なときに要求を受け入れる動作を実装します (リスト68)。 仮想アドレスが有効かどうかでページフォルト例外を判定し、<code>taddr</code>レジスタに最初のPTEのアドレスを割り当てます。 <code>level</code>の初期値は<code>LEVELS - 1</code>とします。</p><p><span class="caption">▼リスト18.68: ページングが有効なときの要求の受け入れ (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> paging_enabled {
...
</code></pre></div><p>ページフォルト例外が発生したとき、状態を<code>State::IDLE</code>に戻します (リスト69)。</p><p><span class="caption">▼リスト18.69: ページフォルト例外が発生したときの状態遷移 (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>State::PAGE_FAULT: state = State::IDLE;
</code></pre></div><p>ページにアクセスする権限があるかをPTEと要求から判定する関数を定義します (リスト70)。 条件の詳細は<a href="./24-impl-paging.html">「18.3 Sv39のアドレス変換」</a>を確認してください。</p><p><span class="caption">▼リスト18.70: ページにアクセスする権限があるかを判定する関数 (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> check_permission (
...
</code></pre></div><p>PTEをフェッチしてページフォルト例外を判定し、次のPTEのフェッチの遷移を実装します (リスト71)。 A、Dビットが設定されていない場合はページフォルト例外とします。</p><p><span class="caption">▼リスト18.71: PTEのフェッチとPTEの確認 (ptw.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/051e243b31c9860c519e90c68dd8c92b50da25f7~1..051e243b31c9860c519e90c68dd8c92b50da25f7#diff-a52c5378935697b09ca8e4279dc7723a88ef9145fbc6490a573d5ee19c86f0b5">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>State::WALK_READY: <span class="hljs-keyword">if</span> master.ready {
...
</code></pre></div><h3 id="特権レベルの確認、mstatus-tvmを実装する" tabindex="-1">特権レベルの確認、mstatus.TVMを実装する <a class="header-anchor" href="#特権レベルの確認、mstatus-tvmを実装する" aria-label="Permalink to “特権レベルの確認、mstatus.TVMを実装する”">​</a></h3><p>S-mode未満の特権レベルでSFENCE.VMA命令を実行しようとしたとき、 Illegal instruction例外が発生します。</p><p>mstatus.TVMはS-modeのときにsatpレジスタにアクセスできるか、 SFENCE.VMA命令を実行できるかを制御するビットです。 mstatus.TVMが<code>1</code>にされているとき、Illegal instruction例外が発生します。</p><p>mstatus.TVMを書き込めるようにします (リスト73)。</p><p><span class="caption">▼リスト18.73: mstatusレジスタの書き込みマスクを変更する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/1889c3b76f2334b7e654b02ce814ce4dceedf5bd~1..1889c3b76f2334b7e654b02ce814ce4dceedf5bd#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> MSTATUS_WMASK   : UIntX = <span class="hljs-number">&#39;h0000_0000_00</span><span class="custom-hl-bold"><span class="hljs-number">7</span></span>e_19aa <span class="hljs-keyword">as</span> UIntX;
</code></pre></div><p><span class="caption">▼リスト18.74: mstatus.TVMを示す変数を作成する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/1889c3b76f2334b7e654b02ce814ce4dceedf5bd~1..1889c3b76f2334b7e654b02ce814ce4dceedf5bd#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> mstatus_tvm : <span class="hljs-keyword">logic</span>    = mstatus[<span class="hljs-number">20</span>];
</code></pre></div><p>特権レベルを確認して、例外を発生させます ( リスト75、 リスト76、 リスト77 )。</p><p><span class="caption">▼リスト18.75: SFENCE.VMA命令かどうかを判定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/1889c3b76f2334b7e654b02ce814ce4dceedf5bd~1..1889c3b76f2334b7e654b02ce814ce4dceedf5bd#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> is_sfence_vma: <span class="hljs-keyword">logic</span> = ctrl.is_csr &amp;&amp; ctrl.funct7 == <span class="hljs-number">7&#39;b0001001</span> &amp;&amp; ctrl.funct3 == <span class="hljs-number">0</span> &amp;&amp; rd_addr == <span class="hljs-number">0</span>;
</code></pre></div><p><span class="caption">▼リスト18.76: SFENCE.VMA命令の例外を判定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/1889c3b76f2334b7e654b02ce814ce4dceedf5bd~1..1889c3b76f2334b7e654b02ce814ce4dceedf5bd#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> expt_tvm: <span class="hljs-keyword">logic</span> = (is_sfence_vma &amp;&amp; mode &lt;: PrivMode::S) || (mstatus_tvm &amp;&amp; mode == PrivMode::S &amp;&amp; (is_wsc &amp;&amp; csr_addr == CsrAddr::SATP || is_sfence_vma));
</code></pre></div><p><span class="caption">▼リスト18.77: 例外を発生させる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/1889c3b76f2334b7e654b02ce814ce4dceedf5bd~1..1889c3b76f2334b7e654b02ce814ce4dceedf5bd#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> raise_expt: <span class="hljs-keyword">logic</span> = valid &amp;&amp; (expt_info.valid || expt_write_readonly_csr || expt_csr_priv_violation || expt_zicntr_priv || expt_trap_return_priv || expt_memory_fault <span class="custom-hl-bold">|| expt_tvm</span>);
<span class="hljs-keyword">let</span> expt_cause: UIntX = <span class="hljs-keyword">switch</span> {
    expt_info.valid        : expt_info.cause,
    expt_write_readonly_csr: CsrCause::ILLEGAL_INSTRUCTION,
    expt_csr_priv_violation: CsrCause::ILLEGAL_INSTRUCTION,
...
</code></pre></div><p><span class="caption">▼リスト18.80: csrunitモジュールのflushフラグをcsru_flushに割り当てる (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/1a84bbcd5ded87b45c7a95f782d2b0b409bc9509~1..1a84bbcd5ded87b45c7a95f782d2b0b409bc9509#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="custom-hl-bold">flush      : csru_flush           ,</span>
minstret                          ,
</code></pre></div><p>satp、mstatus、sstatusレジスタが変更されるときに<code>flush</code>を<code>1</code>にします (リスト81)。</p><p><span class="caption">▼リスト18.81: satp、mstatus、sstatusレジスタが変更されるときにflushを1にする (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/1a84bbcd5ded87b45c7a95f782d2b0b409bc9509~1..1a84bbcd5ded87b45c7a95f782d2b0b409bc9509#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> wsc_flush: <span class="hljs-keyword">logic</span> = is_wsc &amp;&amp; (csr_addr == CsrAddr::SATP || csr_addr == CsrAddr::MSTATUS || csr_addr == CsrAddr::SSTATUS);
<span class="hljs-keyword">assign</span> flush     = valid &amp;&amp; wsc_flush;
</code></pre></div><p><code>flush</code>が<code>1</code>のとき、制御ハザードが発生したことにしてパイプラインをフラッシュします (リスト82)。</p><p><span class="caption">▼リスト18.82: csru_flushが1のときにパイプラインをフラッシュする (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/1a84bbcd5ded87b45c7a95f782d2b0b409bc9509~1..1a84bbcd5ded87b45c7a95f782d2b0b409bc9509#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">assign</span> control_hazard         = mems_valid &amp;&amp; (csru_raise_trap || mems_ctrl.is_jump || memq_rdata.br_taken <span class="custom-hl-bold">|| csru_flush</span>);
