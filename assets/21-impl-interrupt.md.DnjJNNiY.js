...
</code></pre></div><p>例外のトラップベクタを、mtvecレジスタの下位2ビットを<code>0</code>にしたアドレス(Direct)に変更します ( リスト46、 リスト47 )。 新しく<code>expt_vector</code>を定義し、<code>trap_vector</code>に割り当てます。</p><p><span class="caption">▼リスト15.46: 例外のトラップベクタ (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ea7fd48e8c55fbcb9af5a1070caf7037fbd26c73~1..ea7fd48e8c55fbcb9af5a1070caf7037fbd26c73#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> expt_vector: Addr = {mtvec[<span class="hljs-keyword">msb</span>:<span class="hljs-number">2</span>], <span class="hljs-number">2&#39;b0</span>};
</code></pre></div><p><span class="caption">▼リスト15.47: expt_vectorをtrap_vectorに割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ea7fd48e8c55fbcb9af5a1070caf7037fbd26c73~1..ea7fd48e8c55fbcb9af5a1070caf7037fbd26c73#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">assign</span> trap_vector = <span class="hljs-keyword">switch</span> {
...
</code></pre></div><p><span class="caption">▼リスト15.49: レジスタを0でリセットする (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/456496f2ca1fe73779657804b18252206bdc45e3~1..456496f2ca1fe73779657804b18252206bdc45e3#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
        membus.rvalid = <span class="hljs-number">0</span>;
        membus.rdata  = <span class="hljs-number">0</span>;
...
</code></pre></div><p><span class="caption">▼リスト15.50: mtime、mtimecmpの書き込み、読み込み (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/456496f2ca1fe73779657804b18252206bdc45e3~1..456496f2ca1fe73779657804b18252206bdc45e3#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> membus.wen {
    <span class="hljs-keyword">let</span> M: <span class="hljs-keyword">logic</span>&lt;MEMBUS_DATA_WIDTH&gt; = membus.wmask_expand();
    <span class="hljs-keyword">let</span> D: <span class="hljs-keyword">logic</span>&lt;MEMBUS_DATA_WIDTH&gt; = membus.wdata &amp; M;
    <span class="hljs-keyword">case</span> addr {
        MMAP_ACLINT_MSIP    : msip0     = D[<span class="hljs-number">0</span>] | msip0 &amp; ~M[<span class="hljs-number">0</span>];
...
</code></pre></div><p>WFI命令で割り込みが発生するとき、mepcレジスタに<code>pc + 4</code>を書き込むようにします ( リスト57、 リスト58 )。</p><p><span class="caption">▼リスト15.57: WFI命令の判定 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/844eacece3020fc838e4784ed86a8a4fa6c7b06d~1..844eacece3020fc838e4784ed86a8a4fa6c7b06d#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> is_wfi: <span class="hljs-keyword">logic</span> = inst_bits == <span class="hljs-number">32&#39;h10500073</span>;
</code></pre></div><p><span class="caption">▼リスト15.58: WFI命令のとき、mepcをpc+4にする (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/844eacece3020fc838e4784ed86a8a4fa6c7b06d~1..844eacece3020fc838e4784ed86a8a4fa6c7b06d#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> raise_expt || raise_interrupt {
...
</code></pre></div><p>mtimeレジスタの値をACLINTモジュールからcsrunitに渡します ( リスト60、 リスト61 )。</p><p><span class="caption">▼リスト15.60: mtimeをインターフェースに追加する (aclint_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/3d5af4f4849f5591002a1ed2b9a8f5e956c06c88~1..3d5af4f4849f5591002a1ed2b9a8f5e956c06c88#diff-4a970aed66e74f1c5e4a4397d31cedb3bb820d7d48d43d55e416807cb192c5ea">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="custom-hl-bold"><span class="hljs-keyword">import</span> eei::*;</span>
...
</code></pre></div><p><span class="caption">▼リスト15.61: mtimeをインターフェースに割り当てる (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/3d5af4f4849f5591002a1ed2b9a8f5e956c06c88~1..3d5af4f4849f5591002a1ed2b9a8f5e956c06c88#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    aclint.msip  = msip0;
    aclint.mtip  = mtime &gt;= mtimecmp0;
    <span class="custom-hl-bold">aclint.mtime = mtime;</span>
}
</code></pre></div><p>time、instret、cycleレジスタを読み込めるようにします (リスト62)。</p><p><span class="caption">▼リスト15.62: rdataにインターフェースのmtimeを割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/3d5af4f4849f5591002a1ed2b9a8f5e956c06c88~1..3d5af4f4849f5591002a1ed2b9a8f5e956c06c88#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::CYCLE   : mcycle,
