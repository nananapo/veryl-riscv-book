...
</code></pre></div><p>IDステージにある命令は、 EXステージが命令を受け入れられるとき(<code>exq_wready</code>)、 IDステージを完了してEXステージに処理を進められます。 この仕組みは、 <code>if_fifo_rready</code>に<code>exq_wready</code>を割り当てることで実現できます。</p><p>最後に、命令が現在のクロックで供給されたかどうかを示す変数<code>id_is_new</code>は必要ないため削除します (リスト9)。</p><p><span class="caption">▼リスト7.9: ids_is_newを削除する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/d473c0ad515f29d07c8d1d156f026187807cff98~1..d473c0ad515f29d07c8d1d156f026187807cff98#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="custom-hl-del"><span class="hljs-keyword">var</span> ids_is_new   : <span class="hljs-keyword">logic</span>   ;</span>
</code></pre></div><h3 id="exステージを実装する" tabindex="-1">EXステージを実装する <a class="header-anchor" href="#exステージを実装する" aria-label="Permalink to “EXステージを実装する”">​</a></h3><p>EXステージでは、 整数演算命令のときはALUで計算し、 分岐命令のときは分岐判定を行います。</p><p>まず、EXステージに存在する命令の情報を<code>exq_rdata</code>から取り出します(リスト10)。</p><p><span class="caption">▼リスト7.10: 変数の定義 (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/d473c0ad515f29d07c8d1d156f026187807cff98~1..d473c0ad515f29d07c8d1d156f026187807cff98#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> exs_valid    : <span class="hljs-keyword">logic</span>    = exq_rvalid;
...
</code></pre></div><p>次に、EXステージで扱う変数の名前を変更します。 変数の名前に<code>exs_</code>をつけます (リスト11)。</p><p><span class="caption">▼リスト7.11: 変数名を変更する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/d473c0ad515f29d07c8d1d156f026187807cff98~1..d473c0ad515f29d07c8d1d156f026187807cff98#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// レジスタ番号</span>
...
</code></pre></div><p>最後に、MEMステージに命令とデータを渡します。 MEMステージにデータを渡すために、 <code>memq_wdata</code>にデータを割り当てます (リスト12)。</p><p><span class="caption">▼リスト7.12: MEMステージにデータを渡す (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/d473c0ad515f29d07c8d1d156f026187807cff98~1..d473c0ad515f29d07c8d1d156f026187807cff98#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p><code>mem_is_new</code>には、<code>id_is_new</code>の更新に利用していたコードを利用します(リスト14)。</p><p><span class="caption">▼リスト7.14: mem_is_newの更新 (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/d473c0ad515f29d07c8d1d156f026187807cff98~1..d473c0ad515f29d07c8d1d156f026187807cff98#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
...
</code></pre></div><p>次に、MEMモジュールで使う変数に合わせて、 memunitモジュールとcsrunitモジュールのポートに割り当てている変数名を変更します (リスト15)。</p><p><span class="caption">▼リスト7.15: 変数名を変更する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/d473c0ad515f29d07c8d1d156f026187807cff98~1..d473c0ad515f29d07c8d1d156f026187807cff98#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> memu: memunit (
    clk                          ,
    rst                          ,
...
</code></pre></div><p>フェッチ先が変わったことを表す変数<code>control_hazard</code>と、 新しいフェッチ先を示す信号<code>control_hazard_pc_next</code>では、 EXステージで計算したデータとCSRステージのトラップ情報を利用します (リスト16)。</p><p><span class="caption">▼リスト7.16: ジャンプの判定処理 (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/d473c0ad515f29d07c8d1d156f026187807cff98~1..d473c0ad515f29d07c8d1d156f026187807cff98#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p>MEMステージにある命令は、 memunitモジュールが処理中ではなく(<code>!memy_stall</code>)、 WBステージが命令を受け入れられるとき(<code>wbq_wready</code>)、 MEMステージを完了してWBステージに処理を進められます。 この仕組みは、<code>memq_rready</code>と<code>wbq_wvalid</code>を確認してください。</p><h3 id="wbステージを実装する" tabindex="-1">WBステージを実装する <a class="header-anchor" href="#wbステージを実装する" aria-label="Permalink to “WBステージを実装する”">​</a></h3><p>WBステージでは、命令の結果をレジスタにライトバックします。 WBステージが完了したら命令の処理は終わりなので、命令を破棄します。</p><p>まず、WBステージに存在する命令の情報を<code>wbq_rdata</code>から取り出します (リスト18)。</p><p><span class="caption">▼リスト7.18: 変数の定義 (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/d473c0ad515f29d07c8d1d156f026187807cff98~1..d473c0ad515f29d07c8d1d156f026187807cff98#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> wbs_valid    : <span class="hljs-keyword">logic</span>    = wbq_rvalid;
...
</code></pre></div><p><span class="caption">▼リスト7.26: MEMステージとのデータ依存の検知 (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/786582d2c9c230f7cdbc56524c529abf00ee9cc9~1..786582d2c9c230f7cdbc56524c529abf00ee9cc9#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p><span class="caption">▼リスト7.27: WBステージとのデータ依存の検知 (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/786582d2c9c230f7cdbc56524c529abf00ee9cc9~1..786582d2c9c230f7cdbc56524c529abf00ee9cc9#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    exs_wb_data_hazard = wbs_valid &amp;&amp; wbs_ctrl.rwb_en &amp;&amp; (wbs_rd_addr == exs_rs1_addr || wbs_rd_addr == exs_rs2_addr);
}
</code></pre></div><p>次に、データ依存があるときに、データハザードを発生させます (リスト28)。 データハザードを起こすためには、 EXステージのFIFOの<code>rready</code>とMEMステージの<code>wvalid</code>に、 データハザードが発生していないという条件を加えます。</p><p><span class="caption">▼リスト7.28: データ依存があるときにデータハザードを起こす (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/786582d2c9c230f7cdbc56524c529abf00ee9cc9~1..786582d2c9c230f7cdbc56524c529abf00ee9cc9#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    <span class="hljs-comment">// EX -&gt; MEM</span>
...
</code></pre></div><p>最後に、データハザードが発生しているかどうかをデバッグ表示します (リスト29)。</p><p><span class="caption">▼リスト7.29: データハザードが発生しているかをデバッグ表示する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/786582d2c9c230f7cdbc56524c529abf00ee9cc9~1..786582d2c9c230f7cdbc56524c529abf00ee9cc9#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>$display(<span class="hljs-string">&quot;EX -----&quot;</span>);
<span class="hljs-keyword">if</span> exs_valid {
    $display(<span class="hljs-string">&quot;  %h : %h&quot;</span>, exq_rdata.addr, exq_rdata.bits);
    $display(<span class="hljs-string">&quot;  op1     : %h&quot;</span>, exs_op1);
    $display(<span class="hljs-string">&quot;  op2     : %h&quot;</span>, exs_op2);
