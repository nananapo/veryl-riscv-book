import{_ as l,c,o as p,ah as n,j as a,a as s,bB as d,bC as t}from"./chunks/framework.CEJaIMET.js";const y=JSON.parse('{"title":"A拡張の実装","description":"","frontmatter":{},"headers":[],"relativePath":"13-impl-a.md","filePath":"13-impl-a.md"}'),o={name:"13-impl-a.md"};function r(b,e,m,h,i,f){return p(),c("div",null,[...e[0]||(e[0]=[n("",91),a("div",{class:"language-veryl"},[a("button",{title:"Copy Code",class:"copy"}),a("span",{class:"lang"},"veryl"),a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-keyword"},"case"),s(` state {
