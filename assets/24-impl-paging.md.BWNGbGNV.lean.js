import{_ as c,c as l,o as p,ah as e,j as s,a,bW as d,bX as t,bY as o,bZ as r,b_ as i,b$ as f,c0 as b,c1 as h,c2 as u,c3 as m,c4 as y,c5 as _}from"./chunks/framework.BNheOMQd.js";const T=JSON.parse('{"title":"S-modeの実装 (2. 仮想記憶システム)","description":"","frontmatter":{},"headers":[],"relativePath":"24-impl-paging.md","filePath":"24-impl-paging.md"}'),v={name:"24-impl-paging.md"};function j(w,n,g,k,E,C){return p(),l("div",null,[...n[0]||(n[0]=[e("",65),s("div",{class:"language-veryl"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"veryl"),s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"modport"),a(` master {
...
`)])])],-1),e("",47),s("div",{class:"language-veryl"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"veryl"),s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"module"),a(` csrunit (
...
`)])])],-1),e("",216)])])}const S=c(v,[["render",j]]);export{T as __pageData,S as default};
