...
</code></pre></div><p><span class="caption">▼リスト15.8: インターフェースの要求部分をリセットする (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/8672c5ff71e2f445f19f54e3f0caeec95fa999bf~1..8672c5ff71e2f445f19f54e3f0caeec95fa999bf#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> reset_all_device_masters () {
...
</code></pre></div><p>core、csrunitモジュールにaclint_ifポートを追加し、 csrunitモジュールとaclint_memoryモジュールを接続します ( リスト17、 リスト18、 リスト19、 リスト20 )。</p><p><span class="caption">▼リスト15.17: coreモジュールにACLINTのデバイスとのインターフェースを追加する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/8672c5ff71e2f445f19f54e3f0caeec95fa999bf~1..8672c5ff71e2f445f19f54e3f0caeec95fa999bf#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> core (
    clk     : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">clock</span>               ,
    rst     : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">reset</span>               ,
...
</code></pre></div><p><span class="caption">▼リスト15.18: coreモジュールにaclint_ifインターフェースを接続する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/8672c5ff71e2f445f19f54e3f0caeec95fa999bf~1..8672c5ff71e2f445f19f54e3f0caeec95fa999bf#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> c: core (
    clk                      ,
    rst                      ,
...
</code></pre></div><p>aclint_memoryモジュールに<code>msip0</code>レジスタを作成し、読み書きできるようにします ( リスト22、 リスト23、 リスト24 )。</p><p><span class="caption">▼リスト15.22: msip0レジスタの定義 (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/61c7019a517a181213bd5494e853386b04cb8382~1..61c7019a517a181213bd5494e853386b04cb8382#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> msip0: <span class="hljs-keyword">logic</span>;
</code></pre></div><p><span class="caption">▼リスト15.23: msip0レジスタを0でリセットする (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/61c7019a517a181213bd5494e853386b04cb8382~1..61c7019a517a181213bd5494e853386b04cb8382#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
        membus.rvalid = <span class="hljs-number">0</span>;
        membus.rdata  = <span class="hljs-number">0</span>;
        <span class="custom-hl-bold">msip0         = <span class="hljs-number">0</span>;</span>
</code></pre></div><p><span class="caption">▼リスト15.24: msip0レジスタの書き込み、読み込み (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/61c7019a517a181213bd5494e853386b04cb8382~1..61c7019a517a181213bd5494e853386b04cb8382#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> membus.valid {
...
</code></pre></div><h3 id="mstatusのmie、mpieビットを実装する" tabindex="-1">mstatusのMIE、MPIEビットを実装する <a class="header-anchor" href="#mstatusのmie、mpieビットを実装する" aria-label="Permalink to “mstatusのMIE、MPIEビットを実装する”">​</a></h3><p>mstatus.MIE、MPIEを変更できるようにします ( リスト33、 リスト34 )。</p><p><span class="caption">▼リスト15.33: 書き込みマスクを変更する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f4cdc4a86ddbd7a14d5700476895da7be91e71d6~1..f4cdc4a86ddbd7a14d5700476895da7be91e71d6#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> MSTATUS_WMASK : UIntX = <span class="hljs-number">&#39;h0000_0000_0000_0088</span> <span class="hljs-keyword">as</span> UIntX;
</code></pre></div><p><span class="caption">▼リスト15.34: レジスタの場所を変数に割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f4cdc4a86ddbd7a14d5700476895da7be91e71d6~1..f4cdc4a86ddbd7a14d5700476895da7be91e71d6#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// mstatus bits</span>
...
</code></pre></div><p><span class="caption">▼リスト15.49: レジスタを0でリセットする (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9ebc39ab311a92ad70e3cb207f426af7ad290b6f~1..9ebc39ab311a92ad70e3cb207f426af7ad290b6f#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
        membus.rvalid = <span class="hljs-number">0</span>;
        membus.rdata  = <span class="hljs-number">0</span>;
...
</code></pre></div><p><span class="caption">▼リスト15.50: mtime、mtimecmpの書き込み、読み込み (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9ebc39ab311a92ad70e3cb207f426af7ad290b6f~1..9ebc39ab311a92ad70e3cb207f426af7ad290b6f#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> membus.wen {
    <span class="hljs-keyword">let</span> M: <span class="hljs-keyword">logic</span>&lt;MEMBUS_DATA_WIDTH&gt; = membus.wmask_expand();
    <span class="hljs-keyword">let</span> D: <span class="hljs-keyword">logic</span>&lt;MEMBUS_DATA_WIDTH&gt; = membus.wdata &amp; M;
    <span class="hljs-keyword">case</span> addr {
        MMAP_ACLINT_MSIP    : msip0     = D[<span class="hljs-number">0</span>] | msip0 &amp; ~M[<span class="hljs-number">0</span>];
...
</code></pre></div><p>aclint_ifインターフェースに<code>mtip</code>を作成し、タイマ割り込みが発生する条件を設定します ( リスト51、 リスト52 )。</p><p><span class="caption">▼リスト15.51: mtipをインターフェースに追加する (aclint_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9ebc39ab311a92ad70e3cb207f426af7ad290b6f~1..9ebc39ab311a92ad70e3cb207f426af7ad290b6f#diff-4a970aed66e74f1c5e4a4397d31cedb3bb820d7d48d43d55e416807cb192c5ea">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> msip: <span class="hljs-keyword">logic</span>;
...
</code></pre></div><p><span class="caption">▼リスト15.52: mtipにタイマ割り込みが発生する条件を設定する (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9ebc39ab311a92ad70e3cb207f426af7ad290b6f~1..9ebc39ab311a92ad70e3cb207f426af7ad290b6f#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    aclint.msip = msip0;
    <span class="custom-hl-bold">aclint.mtip = mtime &gt;= mtimecmp0;</span>
}
</code></pre></div><h3 id="mip-mtip、割り込み原因を設定する" tabindex="-1">mip.MTIP、割り込み原因を設定する <a class="header-anchor" href="#mip-mtip、割り込み原因を設定する" aria-label="Permalink to “mip.MTIP、割り込み原因を設定する”">​</a></h3><p>mipレジスタのMTIPビットにaclint_ifインターフェースの<code>mtip</code>を接続します (リスト53)。</p><p><span class="caption">▼リスト15.53: mip.MTIPにインターフェースのmtipを割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9ebc39ab311a92ad70e3cb207f426af7ad290b6f~1..9ebc39ab311a92ad70e3cb207f426af7ad290b6f#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> mip: UIntX = {
    <span class="hljs-number">1&#39;b0</span> <span class="hljs-keyword">repeat</span> XLEN - <span class="hljs-number">12</span>, <span class="hljs-comment">// 0, LCOFIP</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// MEIP</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// 0</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// SEIP</span>
...
</code></pre></div><p>割り込み原因を優先順位に応じて設定します。 タイマ割り込みはソフトウェア割り込みよりも優先順位が低いため、 ソフトウェア割り込みの下で原因を設定します (リスト54)。</p><p><span class="caption">▼リスト15.54: タイマ割り込みのcauseを設定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9ebc39ab311a92ad70e3cb207f426af7ad290b6f~1..9ebc39ab311a92ad70e3cb207f426af7ad290b6f#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="custom-hl-bold"><span class="hljs-keyword">let</span> interrupt_pending: UIntX = mip &amp; mie;</span>
...
</code></pre></div><p>WFI命令で割り込みが発生するとき、mepcレジスタに<code>pc + 4</code>を書き込むようにします ( リスト57、 リスト58 )。</p><p><span class="caption">▼リスト15.57: WFI命令の判定 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b0a24c05d62a4ffdb5e6264591058ef070a4e7fc~1..b0a24c05d62a4ffdb5e6264591058ef070a4e7fc#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> is_wfi: <span class="hljs-keyword">logic</span> = inst_bits == <span class="hljs-number">32&#39;h10500073</span>;
</code></pre></div><p><span class="caption">▼リスト15.58: WFI命令のとき、mepcをpc+4にする (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b0a24c05d62a4ffdb5e6264591058ef070a4e7fc~1..b0a24c05d62a4ffdb5e6264591058ef070a4e7fc#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> raise_expt || raise_interrupt {
...
</code></pre></div><p>mtimeレジスタの値をACLINTモジュールからcsrunitに渡します ( リスト60、 リスト61 )。</p><p><span class="caption">▼リスト15.60: mtimeをインターフェースに追加する (aclint_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f6395a50ceae44cc0f86ca8e15f0955dc8bbee22~1..f6395a50ceae44cc0f86ca8e15f0955dc8bbee22#diff-4a970aed66e74f1c5e4a4397d31cedb3bb820d7d48d43d55e416807cb192c5ea">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="custom-hl-bold"><span class="hljs-keyword">import</span> eei::*;</span>
...
</code></pre></div><p><span class="caption">▼リスト15.61: mtimeをインターフェースに割り当てる (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f6395a50ceae44cc0f86ca8e15f0955dc8bbee22~1..f6395a50ceae44cc0f86ca8e15f0955dc8bbee22#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    aclint.msip  = msip0;
    aclint.mtip  = mtime &gt;= mtimecmp0;
    <span class="custom-hl-bold">aclint.mtime = mtime;</span>
}
</code></pre></div><p>time、instret、cycleレジスタを読み込めるようにします (リスト62)。</p><p><span class="caption">▼リスト15.62: rdataにインターフェースのmtimeを割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f6395a50ceae44cc0f86ca8e15f0955dc8bbee22~1..f6395a50ceae44cc0f86ca8e15f0955dc8bbee22#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::CYCLE   : mcycle,
