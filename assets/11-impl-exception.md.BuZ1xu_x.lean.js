import{_ as l,c,o as p,ah as e,j as s,a,bB as d}from"./chunks/framework.BNheOMQd.js";const h=JSON.parse('{"title":"例外の実装","description":"","frontmatter":{},"headers":[],"relativePath":"11-impl-exception.md","filePath":"11-impl-exception.md"}'),t={name:"11-impl-exception.md"};function o(r,n,b,i,m,f){return p(),c("div",null,[...n[0]||(n[0]=[e("",24),s("div",{class:"language-veryl"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"veryl"),s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"always_comb"),a(` {
...
`)])])],-1),e("",118)])])}const _=l(t,[["render",o]]);export{h as __pageData,_ as default};
