...
</code></pre></div><p><code>MEM_DATA_WIDTH</code>、<code>MEM_ADDR_WIDTH</code>を使っている部分を<code>MEMBUS_DATA_WIDTH</code>、<code>XLEN</code>に置き換えます。 <code>MEMBUS_DATA_WIDTH</code>と<code>XLEN</code>を使うmembus_ifインターフェースに別名<code>Membus</code>をつけて利用します ( リスト2、 リスト3、 リスト4、 リスト5 )。</p><p><span class="caption">▼リスト11.2: 別名の定義 (membus_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-5b8ff8b1b43eb415d367759fb46872980d16065c43c0a71a75fec85e987ad460">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">alias</span> <span class="hljs-keyword">interface</span> Membus = membus_if::&lt;eei::MEMBUS_DATA_WIDTH, eei::XLEN&gt;;
</code></pre></div><p><span class="caption">▼リスト11.3: Membusに置き換える (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> core (
...
</code></pre></div><p><span class="caption">▼リスト11.4: Membusに置き換える (memunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-d3618e86de098826661fabd111bec51452d943d3e486d18f9c3aa96b2dd9a89e">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>membus: <span class="hljs-keyword">modport</span> <span class="custom-hl-bold">Membus</span>::master, <span class="hljs-comment">// メモリとのinterface</span>
</code></pre></div><p><span class="caption">▼リスト11.5: 定数名を変更する (memunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-d3618e86de098826661fabd111bec51452d943d3e486d18f9c3aa96b2dd9a89e">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> req_wen  : <span class="hljs-keyword">logic</span>                       ;
...
</code></pre></div><p>topモジュールでインスタンス化しているmembus_ifインターフェースのジェネリックパラメータを変更します (リスト6)。</p><p><span class="caption">▼リスト11.6: ジェネリックパラメータを変更する / Membusに置き換える (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> membus  : membus_if::&lt;<span class="custom-hl-bold">RAM</span>_DATA_WIDTH, <span class="custom-hl-bold">RAM</span>_ADDR_WIDTH&gt;;
...
</code></pre></div><p>addr_to_memaddr関数をジェネリック関数にして、呼び出すときにRAMのパラメータを使用するように変更します ( リスト7、 リスト8、 )。</p><p><span class="caption">▼リスト11.7: addr_to_memaddr関数をジェネリック関数に変更する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// アドレスをデータ単位でのアドレスに変換する</span>
...
</code></pre></div><p><span class="caption">▼リスト11.8: ジェネリックパラメータを指定する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>membus.valid = i_membus.valid | d_membus.valid;
...
</code></pre></div><p>メモリに読み込むHEXファイルを指定するパラメータの名前を変更します ( リスト9、 リスト10 )。</p><p><span class="caption">▼リスト11.9: パラメータ名を変更する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> top #(
...
</code></pre></div><p><span class="caption">▼リスト11.10: パラメータ名を変更する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> ram: memory::&lt;<span class="custom-hl-bold">RAM</span>_DATA_WIDTH, <span class="custom-hl-bold">RAM</span>_ADDR_WIDTH&gt; #(
    FILEPATH_IS_ENV: <span class="custom-hl-bold">RAM</span>_FILEPATH_IS_ENV,
    FILEPATH       : <span class="custom-hl-bold">RAM</span>_FILEPATH       ,
) (
</code></pre></div><p>シミュレータ用のC++プログラムも変更します ( リスト11、 リスト12、 リスト13 )。</p><p><span class="caption">▼リスト11.11: 引数の名称を変える (tb_verilator.cpp)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-cb1447535f2400768c9115df1ccdcc7be37fd2670577cc465b330f5968ee3013">差分をみる</a></p><div class="language-cpp"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="hljs"><code><span class="hljs-keyword">if</span> (argc &lt; <span class="hljs-number">2</span>) {
...
</code></pre></div><p><span class="caption">▼リスト11.12: 環境変数名を変える (tb_verilator.cpp)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-cb1447535f2400768c9115df1ccdcc7be37fd2670577cc465b330f5968ee3013">差分をみる</a></p><div class="language-cpp"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="hljs"><code><span class="hljs-comment">// 環境変数でメモリの初期化用ファイルを指定する</span>
...
</code></pre></div><p><span class="caption">▼リスト11.13: 環境変数名を変える (tb_verilator.cpp)</span> <a href="https://github.com/nananapo/bluecore/compare/a0a54c52e8a4f09128ca26eca83c8f63e30e3de1~1..a0a54c52e8a4f09128ca26eca83c8f63e30e3de1#diff-cb1447535f2400768c9115df1ccdcc7be37fd2670577cc465b330f5968ee3013">差分をみる</a></p><div class="language-cpp"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="hljs"><code><span class="hljs-comment">// 環境変数を元に戻す</span>
...
</code></pre></div><h2 id="mmio-controllerモジュールの作成" tabindex="-1">mmio_controllerモジュールの作成 <a class="header-anchor" href="#mmio-controllerモジュールの作成" aria-label="Permalink to “mmio_controllerモジュールの作成”">​</a></h2><p>アクセスするアドレスに応じてアクセス先のデバイスを切り替えるモジュールを実装します。</p><p><code>src/mmio_controller.veryl</code>を作成し、次のように記述します ( リスト14 )。</p><p><span class="caption">▼リスト11.14: mmio_controller.veryl</span> <a href="https://github.com/nananapo/bluecore/compare/b4cb8c17f4a8204d23a671508bc577c7afb02306~1..b4cb8c17f4a8204d23a671508bc577c7afb02306#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">import</span> eei::*;
...
</code></pre></div><p>mmio_controllerモジュールの関数の引数にmembus_ifインターフェースを使うために、 新しくmodportを宣言します (リスト15)。</p><p><span class="caption">▼リスト11.15: modport宣言を追加する (membus_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b4cb8c17f4a8204d23a671508bc577c7afb02306~1..b4cb8c17f4a8204d23a671508bc577c7afb02306#diff-5b8ff8b1b43eb415d367759fb46872980d16065c43c0a71a75fec85e987ad460">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">modport</span> all_input {
...
</code></pre></div><p>RAMとのインターフェースを追加し、 reset_all_device_masters関数に要求をリセットするコードを追加します ( リスト19、 リスト20 )。</p><p><span class="caption">▼リスト11.19: RAMとのインターフェースを追加する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0b39cbc80d0312e22146084b26f7e6149e4555e3~1..0b39cbc80d0312e22146084b26f7e6149e4555e3#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> mmio_controller (
    clk       : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">clock</span>         ,
    rst       : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">reset</span>         ,
    req_core  : <span class="hljs-keyword">modport</span> Membus::slave ,
...
</code></pre></div><p><code>ready</code>、<code>rvalid</code>を取得する関数にRAMを登録します ( リスト21、 リスト22 )。</p><p><span class="caption">▼リスト11.21: インターフェースのreadyを返す (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0b39cbc80d0312e22146084b26f7e6149e4555e3~1..0b39cbc80d0312e22146084b26f7e6149e4555e3#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> get_device_ready (
    device: <span class="hljs-keyword">input</span> Device,
) -&gt; <span class="hljs-keyword">logic</span> {
...
</code></pre></div><p><span class="caption">▼リスト11.22: インターフェースのrvalidを返す (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0b39cbc80d0312e22146084b26f7e6149e4555e3~1..0b39cbc80d0312e22146084b26f7e6149e4555e3#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> get_device_rvalid (
    device: <span class="hljs-keyword">input</span> Device,
) -&gt; <span class="hljs-keyword">logic</span> {
    <span class="custom-hl-bold"><span class="hljs-keyword">case</span> device {</span>
...
</code></pre></div><p>RAMの<code>rvalid</code>、<code>rdata</code>を<code>req_core</code>に割り当てます (リスト23)。</p><p><span class="caption">▼リスト11.23: RAMへのアクセス結果をreqに割り当てる (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0b39cbc80d0312e22146084b26f7e6149e4555e3~1..0b39cbc80d0312e22146084b26f7e6149e4555e3#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> assign_device_slave (
    device: <span class="hljs-keyword">input</span>   Device          ,
    req   : <span class="hljs-keyword">modport</span> Membus::response,
) {
    req.rvalid = <span class="hljs-number">1</span>;
...
</code></pre></div><p>RAMのインターフェースに要求を割り当てます (リスト24)。 ここでRAMのベースアドレスを引いたアドレスを割り当てることで、<code>MMAP_RAM_BEGIN</code>が<code>0</code>になるようにしています。</p><p><span class="caption">▼リスト11.24: RAMにreqを割り当ててアクセス要求する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0b39cbc80d0312e22146084b26f7e6149e4555e3~1..0b39cbc80d0312e22146084b26f7e6149e4555e3#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> assign_device_master (
    req: <span class="hljs-keyword">modport</span> Membus::all_input,
) {
...
</code></pre></div><p><span class="caption">▼リスト11.26: ポート名を変更する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0b39cbc80d0312e22146084b26f7e6149e4555e3~1..0b39cbc80d0312e22146084b26f7e6149e4555e3#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> ram: memory::&lt;RAM_DATA_WIDTH, RAM_ADDR_WIDTH&gt; #(
...
</code></pre></div><p>coreモジュールからRAMへのメモリアクセスを調停する処理を、 coreモジュールからmmio_controllerモジュールへのアクセスを調停する処理に変更します (リスト27)。</p><p><span class="caption">▼リスト11.27: 調停する対象をmmio_membusに変更する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0b39cbc80d0312e22146084b26f7e6149e4555e3~1..0b39cbc80d0312e22146084b26f7e6149e4555e3#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// <span class="custom-hl-bold">mmio_controller</span>へのメモリアクセスを調停する</span>
<span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
...
</code></pre></div><p>mmio_controllerをインスタンス化し、RAMと接続します。 ( リスト28、 リスト29 )。 RAMのアドレスへの変換は調停処理から接続部分に移動しています。</p><p><span class="caption">▼リスト11.28: mmio_controllerモジュールをインスタンス化する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0b39cbc80d0312e22146084b26f7e6149e4555e3~1..0b39cbc80d0312e22146084b26f7e6149e4555e3#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> mmioc: mmio_controller (
    clk                        ,
    rst                        ,
    req_core  : mmio_membus    ,
    ram_membus: mmio_ram_membus,
);
</code></pre></div><p><span class="caption">▼リスト11.29: mmio_controllerモジュールとRAMを接続する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0b39cbc80d0312e22146084b26f7e6149e4555e3~1..0b39cbc80d0312e22146084b26f7e6149e4555e3#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p>riscv-testsの終了判定用のアドレスを<code>MMAP_RAM_BEGIN</code>基準のアドレスに変更します (リスト34)。</p><p><span class="caption">▼リスト11.34: .tohostのアドレスを変更する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0b39cbc80d0312e22146084b26f7e6149e4555e3~1..0b39cbc80d0312e22146084b26f7e6149e4555e3#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>#[ifdef(TEST_MODE)]
<span class="hljs-keyword">always_ff</span> {
...
</code></pre></div><p>ROMとのインターフェースを追加します ( リスト37、 リスト38 )。 reset_all_device_masters関数でインターフェースをリセットします。</p><p><span class="caption">▼リスト11.37: ROMとのインターフェースを追加する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> mmio_controller (
    clk       : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">clock</span>         ,
    rst       : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">reset</span>         ,
    req_core  : <span class="hljs-keyword">modport</span> Membus::slave ,
...
</code></pre></div><p><span class="caption">▼リスト11.38: インターフェースの要求部分をリセットする (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> reset_all_device_masters () {
    reset_membus_master(ram_membus);
    <span class="custom-hl-bold">reset_membus_master(rom_membus);</span>
}
</code></pre></div><p><code>ready</code>、<code>rvalid</code>を取得する関数にROMを登録します ( リスト39、 リスト40 )。</p><p><span class="caption">▼リスト11.39: インターフェースのreadyを返す (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> device {
...
</code></pre></div><p><span class="caption">▼リスト11.40: インターフェースのrvalidを返す (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> device {
...
</code></pre></div><p>ROMの<code>rvalid</code>、<code>rdata</code>を<code>req_core</code>に割り当てます ( リスト41 )。</p><p><span class="caption">▼リスト11.41: assign_device_slave関数でROMの結果をreqに割り当てる (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> device {
    Device::RAM: req &lt;&gt; ram_membus;
    <span class="custom-hl-bold">Device::ROM: req &lt;&gt; rom_membus;</span>
    <span class="hljs-keyword">default</span>    : {}
}
</code></pre></div><p>ROMのインターフェースに要求を割り当てます ( リスト42 )。 RAMと同じようにメモリマップのベースアドレスを引いたアドレスを割り当てます。</p><p><span class="caption">▼リスト11.42: get_device関数でROMにreqを割り当ててアクセス要求する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> get_device(req.addr) {
    Device::RAM: {
        ram_membus      &lt;&gt; req;
...
</code></pre></div><h3 id="romの初期値のパラメータを作成する" tabindex="-1">ROMの初期値のパラメータを作成する <a class="header-anchor" href="#romの初期値のパラメータを作成する" aria-label="Permalink to “ROMの初期値のパラメータを作成する”">​</a></h3><p>topモジュールにROMの初期値を指定するパラメータを定義します ( リスト43 )。</p><p><span class="caption">▼リスト11.43: パラメータを定義する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> top #(
    <span class="hljs-keyword">param</span> RAM_FILEPATH_IS_ENV: <span class="hljs-keyword">bit</span>    = <span class="hljs-number">1</span>              ,
    <span class="hljs-keyword">param</span> RAM_FILEPATH       : <span class="hljs-keyword">string</span> = <span class="hljs-string">&quot;RAM_FILE_PATH&quot;</span>,
...
</code></pre></div><p><span class="caption">▼リスト11.45: ROMのHEXファイルのパスを生成する (tb_verilator.cpp)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-cb1447535f2400768c9115df1ccdcc7be37fd2670577cc465b330f5968ee3013">差分をみる</a></p><div class="language-cpp"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="hljs"><code><span class="hljs-comment">// メモリの初期値を格納しているファイル名</span>
...
</code></pre></div><p><span class="caption">▼リスト11.46: 引数の数が変わったのでインデックスを変更する (tb_verilator.cpp)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-cb1447535f2400768c9115df1ccdcc7be37fd2670577cc465b330f5968ee3013">差分をみる</a></p><div class="language-cpp"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="hljs"><code><span class="hljs-type">unsigned</span> <span class="hljs-type">long</span> <span class="hljs-type">long</span> cycles = <span class="hljs-number">0</span>;
...
</code></pre></div><p><span class="caption">▼リスト11.47: 環境変数を変更する (tb_verilator.cpp)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-cb1447535f2400768c9115df1ccdcc7be37fd2670577cc465b330f5968ee3013">差分をみる</a></p><div class="language-cpp"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="hljs"><code><span class="custom-hl-bold"><span class="hljs-type">const</span> <span class="hljs-type">char</span>* original_env_rom = <span class="hljs-built_in">getenv</span>(<span class="hljs-string">&quot;ROM_FILE_PATH&quot;</span>);</span>
...
</code></pre></div><p>テストを実行するためのPythonプログラムでROMのHEXファイルを指定できるようにします ( リスト49、 リスト50、 リスト51 )。 デフォルト値はカレントディレクトリの<code>bootrom.hex</code>にしておきます。</p><p><span class="caption">▼リスト11.49: 引数--romを追加する (test/test.py)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-354b34bf98c7e65e1214431540698436073d5e2caf243680551ce1014ba0afde">差分をみる</a></p><div class="language-py"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="hljs"><code>parser.add_argument(<span class="hljs-string">&quot;--rom&quot;</span>, default=<span class="hljs-string">&quot;bootrom.hex&quot;</span>, <span class="hljs-built_in">help</span>=<span class="hljs-string">&quot;hex file of rom&quot;</span>)
</code></pre></div><p><span class="caption">▼リスト11.50: シミュレータにROMのHEXファイルのパスを渡す (test/test.py)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-354b34bf98c7e65e1214431540698436073d5e2caf243680551ce1014ba0afde">差分をみる</a></p><div class="language-py"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="hljs"><code><span class="hljs-keyword">def</span> <span class="hljs-title function_">test</span>(<span class="hljs-params"><span class="custom-hl-bold">romhex, </span>file_name</span>):
...
</code></pre></div><p><span class="caption">▼リスト11.51: test関数にROMのHEXファイルのパスを渡す (test/test.py)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-354b34bf98c7e65e1214431540698436073d5e2caf243680551ce1014ba0afde">差分をみる</a></p><div class="language-py"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="hljs"><code><span class="hljs-keyword">for</span> hexpath <span class="hljs-keyword">in</span> dir_walk(args.<span class="hljs-built_in">dir</span>):
...
</code></pre></div><h3 id="romとmmio-controllerモジュールを接続する" tabindex="-1">ROMとmmio_controllerモジュールを接続する <a class="header-anchor" href="#romとmmio-controllerモジュールを接続する" aria-label="Permalink to “ROMとmmio_controllerモジュールを接続する”">​</a></h3><p>ROMをインスタンス化してmmio_controllerモジュールと接続します。</p><p>ROMとmmio_controllerモジュールを接続するインターフェース(<code>mmio_rom_membus</code>)、 ROMのインターフェース(<code>rom_membus</code>)を定義します (リスト52)。</p><p><span class="caption">▼リスト11.52: ROMのインターフェースの定義 (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> mmio_membus    : Membus;
...
</code></pre></div><p>ROMをインスタンス化します ( リスト53 )。 パラメータにはtopモジュールのパラメータを割り当てます。</p><p><span class="caption">▼リスト11.53: ROMをインスタンス化する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> rom: memory::&lt;ROM_DATA_WIDTH, ROM_ADDR_WIDTH&gt; #(
...
</code></pre></div><p>mmio_controllerモジュールに<code>rom_membus</code>を接続します ( リスト54 )。</p><p><span class="caption">▼リスト11.54: ROMのインターフェースを接続する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> mmioc: mmio_controller (
    clk                        ,
    rst                        ,
    req_core  : mmio_membus    ,
    ram_membus: mmio_ram_membus,
...
</code></pre></div><p>mmio_controllerモジュールとROMを接続します。 アドレスの変換のためにaddr_to_memaddr関数を使用しています ( リスト55 )。</p><p><span class="caption">▼リスト11.55: mmio_controllerモジュールとROMを接続する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/ee64607bced1124d449cebfa9ad4312bd145329c~1..ee64607bced1124d449cebfa9ad4312bd145329c#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><h3 id="mmio-controllerモジュールにデバイスを追加する" tabindex="-1">mmio_controllerモジュールにデバイスを追加する <a class="header-anchor" href="#mmio-controllerモジュールにデバイスを追加する" aria-label="Permalink to “mmio_controllerモジュールにデバイスを追加する”">​</a></h3><p>mmio_controllerモジュールにデバイスを追加します。</p><p><code>Device</code>型に<code>Device::DEBUG</code>を追加します ( リスト59 )。</p><p><span class="caption">▼リスト11.59: Device型にデバッグ用の入出力デバイスを追加する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b91dffb8e50664669b048356bdbfc7d6a2e37145~1..b91dffb8e50664669b048356bdbfc7d6a2e37145#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">enum</span> Device {
    UNKNOWN,
    RAM,
    ROM,
...
</code></pre></div><p><span class="caption">▼リスト11.61: インターフェースの要求部分をリセットする (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b91dffb8e50664669b048356bdbfc7d6a2e37145~1..b91dffb8e50664669b048356bdbfc7d6a2e37145#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> reset_all_device_masters () {
    reset_membus_master(ram_membus);
    reset_membus_master(rom_membus);
    <span class="custom-hl-bold">reset_membus_master(dbg_membus);</span>
}
</code></pre></div><p>デバイスの位置を設定します。 最初にチェックすることで、他のデバイスとアドレスを被らせたとしてもデバッグ用の入出力デバイスを優先します ( リスト62 )。</p><p><span class="caption">▼リスト11.62: get_device関数でデバイスの範囲を定義する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b91dffb8e50664669b048356bdbfc7d6a2e37145~1..b91dffb8e50664669b048356bdbfc7d6a2e37145#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> get_device (
    addr: <span class="hljs-keyword">input</span> Addr,
) -&gt; Device {
...
</code></pre></div><p>インターフェースを設定します ( リスト63、 リスト64、 リスト65、 リスト66 )。 この変更はROMを追加したときとほとんど同じです。</p><p><span class="caption">▼リスト11.63: assign_device_master関数の変更 (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b91dffb8e50664669b048356bdbfc7d6a2e37145~1..b91dffb8e50664669b048356bdbfc7d6a2e37145#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> get_device(req.addr) {
    Device::RAM: {
        ram_membus      &lt;&gt; req;
        ram_membus.addr -= MMAP_RAM_BEGIN;
    }
...
</code></pre></div><p><span class="caption">▼リスト11.64: assign_device_slave関数の変更 (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b91dffb8e50664669b048356bdbfc7d6a2e37145~1..b91dffb8e50664669b048356bdbfc7d6a2e37145#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> device {
    Device::RAM  : req &lt;&gt; ram_membus;
    Device::ROM  : req &lt;&gt; rom_membus;
    <span class="custom-hl-bold">Device::DEBUG: req &lt;&gt; dbg_membus;</span>
    <span class="hljs-keyword">default</span>      : {}
}
</code></pre></div><p><span class="caption">▼リスト11.65: get_device_ready関数の変更 (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b91dffb8e50664669b048356bdbfc7d6a2e37145~1..b91dffb8e50664669b048356bdbfc7d6a2e37145#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> device {
    Device::RAM  : <span class="hljs-keyword">return</span> ram_membus.ready;
...
</code></pre></div><p><span class="caption">▼リスト11.66: get_device_rvalid関数の変更 (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b91dffb8e50664669b048356bdbfc7d6a2e37145~1..b91dffb8e50664669b048356bdbfc7d6a2e37145#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> device {
    Device::RAM  : <span class="hljs-keyword">return</span> ram_membus.rvalid;
...
</code></pre></div><p>topモジュールにデバッグ用の入出力デバイスのインターフェース(<code>dbg_membus</code>)を定義し、 mmio_controllerモジュールと接続します ( リスト67、 リスト68 )。</p><p><span class="caption">▼リスト11.67: インターフェースのインスタンス化 (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b91dffb8e50664669b048356bdbfc7d6a2e37145~1..b91dffb8e50664669b048356bdbfc7d6a2e37145#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> ram_membus     : membus_if::&lt;RAM_DATA_WIDTH, RAM_ADDR_WIDTH&gt;;
...
</code></pre></div><p><span class="caption">▼リスト11.68: インターフェースを接続する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b91dffb8e50664669b048356bdbfc7d6a2e37145~1..b91dffb8e50664669b048356bdbfc7d6a2e37145#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> mmioc: mmio_controller (
    clk                        ,
    rst                        ,
...
</code></pre></div><h3 id="出力を実装する" tabindex="-1">出力を実装する <a class="header-anchor" href="#出力を実装する" aria-label="Permalink to “出力を実装する”">​</a></h3><p><code>dbg_membus</code>を使い、デバッグ出力処理を実装します。 既存のriscv-testsの終了検知処理を次のように書き換えます ( リスト69 )。</p><p><span class="caption">▼リスト11.69: riscv-testsの終了検知処理をデバッグ用の入出力デバイスに変更する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b91dffb8e50664669b048356bdbfc7d6a2e37145~1..b91dffb8e50664669b048356bdbfc7d6a2e37145#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// デバッグ用のIO</span>
<span class="hljs-keyword">always_ff</span> {
...
</code></pre></div><p><code>test/debug_output.c</code>を作成し、次のように記述します ( リスト71 )。 これは<code>Hello,world!</code>と出力するプログラムです。</p><p><span class="caption">▼リスト11.71: Hello,world!を出力するプログラム (test/debug_output.c)</span> <a href="https://github.com/nananapo/bluecore/compare/e82d3fa2770ebe10d6c4c26d44a1d9c445c22b77~1..e82d3fa2770ebe10d6c4c26d44a1d9c445c22b77#diff-275c81fc897533424e3007ff6c97845ded45b9ed448f68034c1c4e96cdfab294">差分をみる</a></p><div class="language-c"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="hljs"><code><span class="hljs-meta">#<span class="hljs-keyword">define</span> DEBUG_REG ((volatile unsigned long long*)0x40000000)</span>
...
</code></pre></div><p>ここで、read関数の呼び出しでシミュレータを止めず(<code>O_NONBLOCK</code>)、 シェルが入力をバッファリングしなくする(<code>~ICANON</code>)ために設定を変えるコードを挿入します。 また、シェルが文字列をローカルエコー(入力した文字列を表示)しないようにします(<code>~ECHO</code>) ( リスト83、 リスト84、 リスト85 )。</p><p><span class="caption">▼リスト11.83: includeを追加する (src/tb_verilator.cpp)</span> <a href="https://github.com/nananapo/bluecore/compare/30bbf6c4dcb0b12212c5cf838785a04e53419c6d~1..30bbf6c4dcb0b12212c5cf838785a04e53419c6d#diff-cb1447535f2400768c9115df1ccdcc7be37fd2670577cc465b330f5968ee3013">差分をみる</a></p><div class="language-cpp"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="hljs"><code><span class="hljs-meta">#<span class="hljs-keyword">include</span> <span class="hljs-string">&lt;fcntl.h&gt;</span></span>
...
</code></pre></div><p><span class="caption">▼リスト11.84: 設定を変更、復元する関数の定義 (src/tb_verilator.cpp)</span> <a href="https://github.com/nananapo/bluecore/compare/30bbf6c4dcb0b12212c5cf838785a04e53419c6d~1..30bbf6c4dcb0b12212c5cf838785a04e53419c6d#diff-cb1447535f2400768c9115df1ccdcc7be37fd2670577cc465b330f5968ee3013">差分をみる</a></p><div class="language-cpp"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="hljs"><code><span class="hljs-keyword">struct</span> <span class="hljs-title class_">termios</span> old_setting;
...
</code></pre></div><p><span class="caption">▼リスト11.85: 設定を変える関数をmain関数から呼び出す (src/tb_verilator.cpp)</span> <a href="https://github.com/nananapo/bluecore/compare/30bbf6c4dcb0b12212c5cf838785a04e53419c6d~1..30bbf6c4dcb0b12212c5cf838785a04e53419c6d#diff-cb1447535f2400768c9115df1ccdcc7be37fd2670577cc465b330f5968ee3013">差分をみる</a></p><div class="language-cpp"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="hljs"><code><span class="hljs-function"><span class="hljs-type">int</span> <span class="hljs-title">main</span><span class="hljs-params">(<span class="hljs-type">int</span> argc, <span class="hljs-type">char</span>** argv)</span> </span>{
...
</code></pre></div><p><code>src/util.veryl</code>にget_input_dpic関数を呼び出す関数を実装します ( リスト86 )。</p><p><span class="caption">▼リスト11.86: get_input関数を定義する (src/util.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30bbf6c4dcb0b12212c5cf838785a04e53419c6d~1..30bbf6c4dcb0b12212c5cf838785a04e53419c6d#diff-6b4b63d3522250a8618dfa5acc419267d8fb3cf26815d4da6936aadf5c81d945">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">embed</span> (inline) sv{{{
...
</code></pre></div><p>デバッグ用の入出力デバイスのロードで<code>util::get_input</code>の結果を返すようにします ( リスト87 )。 このコードは合成できないので、有効化オプション<code>ENABLE_DEBUG_INPUT</code>をつけます。</p><p><span class="caption">▼リスト11.87: 読み込みでget_input関数を呼び出す (src/top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/30bbf6c4dcb0b12212c5cf838785a04e53419c6d~1..30bbf6c4dcb0b12212c5cf838785a04e53419c6d#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    dbg_membus.ready  = <span class="hljs-number">1</span>;
    dbg_membus.rvalid = dbg_membus.valid;
    <span class="hljs-keyword">if</span> dbg_membus.valid {
        <span class="hljs-keyword">if</span> dbg_membus.wen {
...
</code></pre></div><h3 id="入力をテストする" tabindex="-1">入力をテストする <a class="header-anchor" href="#入力をテストする" aria-label="Permalink to “入力をテストする”">​</a></h3><p>実装した入出力デバイスで文字を入出力できることを確認します。</p><p><code>test/debug_input.c</code>を作成し、次のように記述します ( リスト88 )。 これは入力された文字に<code>1</code>を足した値を出力するプログラムです。</p><p><span class="caption">▼リスト11.88: test/debug_input.c</span> <a href="https://github.com/nananapo/bluecore/compare/30bbf6c4dcb0b12212c5cf838785a04e53419c6d~1..30bbf6c4dcb0b12212c5cf838785a04e53419c6d#diff-ecd81d575697e5c25714cf67759e2d0e84cc519b5c93a473ea5e173eaf03d0ad">差分をみる</a></p><div class="language-c"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="hljs"><code><span class="hljs-meta">#<span class="hljs-keyword">define</span> DEBUG_REG ((volatile unsigned long long*)0x40000000)</span>
