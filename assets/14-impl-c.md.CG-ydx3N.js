...
</code></pre></div><p><code>rvalid</code>、<code>rready</code>、<code>raddr</code>、<code>rdata</code>は、 coreモジュールのFIFO(<code>if_fifo</code>)の<code>wvalid</code>、<code>wready</code>、<code>wdata.addr</code>、<code>wdata.bits</code>と同じ役割を果たします。 <code>is_hazard</code>、<code>next_pc</code>は制御ハザードの情報を伝えるための変数です。</p><h3 id="coreモジュールのifステージを削除する" tabindex="-1">coreモジュールのIFステージを削除する <a class="header-anchor" href="#coreモジュールのifステージを削除する" aria-label="Permalink to “coreモジュールのIFステージを削除する”">​</a></h3><p>coreモジュールのIFステージを削除し、 core_inst_ifインターフェースで代替します<sup class="footnote-ref"><a href="#fn2" id="fnref2">[2]</a></sup>。</p><p>coreモジュールの<code>i_membus</code>の型を<code>core_inst_if</code>に変更します (リスト5)。</p><p><span class="caption">▼リスト13.5: i_membusの型を変更する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>i_membus: <span class="hljs-keyword">modport</span> <span class="custom-hl-bold">core_inst_if</span>::master,
</code></pre></div><p>IFステージ部分のコードを次のように変更します (リスト6)。</p><p><span class="caption">▼リスト13.6: IFステージの変更 (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">///////////////////////////////// IF Stage /////////////////////////////////</span>
...
</code></pre></div><p><span class="caption">▼リスト13.8: EXステージに進められるときにrreadyを1にする (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p><code>core_if</code>はcoreモジュールとのインターフェース、 <code>mem_if</code>はメモリとのインターフェースです。</p><p>fetchとissue、issueとcore_ifの間のFIFOを作成します (リスト10、 リスト11)。</p><p><span class="caption">▼リスト13.10: fetchとissueを繋ぐFIFOの作成 (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">struct</span> fetch_fifo_type {
    addr: Addr                    ,
...
</code></pre></div><p>メモリへのアクセス処理(fetch)を実装します。 FIFOに空きがあるとき、64ビットの値を読み込んでPCを<code>8</code>進めます (リスト12、 リスト13、 リスト14)。 この処理はcoreモジュールの元のIFステージとほとんど同じです。</p><p><span class="caption">▼リスト13.12: PCと状態管理用の変数の定義 (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> fetch_pc          : Addr ;
...
</code></pre></div><p><span class="caption">▼リスト13.13: メモリへの要求の割り当て (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p><span class="caption">▼リスト13.14: PC、状態の更新 (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
...
</code></pre></div><p><span class="caption">▼リスト13.17: issue_fifoに32ビットずつ命令を格納する (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// fetch_fifo &lt;-&gt; issue_fifo</span>
<span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><h3 id="inst-fetcherモジュールとcoreモジュールを接続する" tabindex="-1">inst_fetcherモジュールとcoreモジュールを接続する <a class="header-anchor" href="#inst-fetcherモジュールとcoreモジュールを接続する" aria-label="Permalink to “inst_fetcherモジュールとcoreモジュールを接続する”">​</a></h3><p>topモジュールで、core_inst_ifをインスタンス化します。 (リスト19)。</p><p><span class="caption">▼リスト13.19: インターフェースの定義 (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> i_membus_core: core_inst_if;
</code></pre></div><p>inst_fetcherモジュールをインスタンス化し、coreモジュールと接続します ( リスト20、 リスト21 )。</p><p><span class="caption">▼リスト13.20: inst_fetcherモジュールのインスタンス化 (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> fetcher: inst_fetcher (
    clk                   ,
    rst                   ,
    core_if: i_membus_core,
    mem_if : i_membus     ,
);
</code></pre></div><p><span class="caption">▼リスト13.21: インターフェースを変更する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> c: core (
    clk                    ,
    rst                    ,
...
</code></pre></div><p>inst_fetcherモジュールが64ビットのデータを32ビットの命令の列に変換してくれるようになったので、 <code>d_membus</code>との調停のところで32ビットずつ選択する必要がなくなりました。 そのため、<code>rdata</code>をそのまま割り当てて、<code>memarb_last_iaddr</code>変数とビットの選択処理を削除します (リスト22、 リスト23、 リスト24)。</p><p><span class="caption">▼リスト13.22: 使用しない変数を削除する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> memarb_last_i: <span class="hljs-keyword">logic</span>;
<span class="custom-hl-del"><span class="hljs-keyword">var</span> memarb_last_iaddr: Addr;</span>
</code></pre></div><p><span class="caption">▼リスト13.23: 使用しない変数を削除する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/0f7899577e56ef5df611caa3f7c04a5e2d347336~1..0f7899577e56ef5df611caa3f7c04a5e2d347336#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
...
</code></pre></div><p><code>issue_pc_offset</code>が<code>6</code>のとき、変数にデータを保存します (リスト26)。</p><p><span class="caption">▼リスト13.26: offsetが6のとき、変数に命令の下位16ビットとアドレスを保存する (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/94ff66e55586ccd17d9b355d76c42c5c9e6c0173~1..94ff66e55586ccd17d9b355d76c42c5c9e6c0173#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
        issue_pc_offset      = <span class="hljs-number">0</span>;
...
</code></pre></div><p><code>issue_pc_offset</code>が<code>2</code>、<code>6</code>の場合の<code>issue_fifo</code>への書き込みを実装します (リスト27)。 <code>6</code>の場合、保存していた16ビットと新しく読み出した16ビットを結合した値、保存していたアドレスを書き込みます。</p><p><span class="caption">▼リスト13.27: issue_fifoにoffsetが2、6の命令を格納する (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/94ff66e55586ccd17d9b355d76c42c5c9e6c0173~1..94ff66e55586ccd17d9b355d76c42c5c9e6c0173#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> !core_if.is_hazard &amp;&amp; fetch_fifo_rvalid {
...
</code></pre></div><p>inst_fetcherモジュールで、<code>is_rvc</code>を<code>0</code>に設定してcoreモジュールに供給します (リスト31、 リスト32、 リスト33)。</p><p><span class="caption">▼リスト13.31: issue_fifo_type型にis_rvcフラグを追加する (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f4dc1e9c1895373f57b1f97f5f710741787fa590~1..f4dc1e9c1895373f57b1f97f5f710741787fa590#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">struct</span> issue_fifo_type {
    addr  : Addr ,
    bits  : Inst ,
    <span class="custom-hl-bold">is_rvc: <span class="hljs-keyword">logic</span>,</span>
}
</code></pre></div><p><span class="caption">▼リスト13.32: is_rvcフラグを0に設定する (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f4dc1e9c1895373f57b1f97f5f710741787fa590~1..f4dc1e9c1895373f57b1f97f5f710741787fa590#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p>`,126),s("div",{class:"language-veryl"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"veryl"),s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"if"),a(" offset == "),s("span",{class:"hljs-number"},"6"),a(` {
...
`)])])],-1),l(`<p><span class="caption">▼リスト13.33: is_rvcフラグを接続する (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f4dc1e9c1895373f57b1f97f5f710741787fa590~1..f4dc1e9c1895373f57b1f97f5f710741787fa590#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    issue_fifo_flush  = core_if.is_hazard;
    issue_fifo_rready = core_if.rready;
    core_if.rvalid    = issue_fifo_rvalid;
    core_if.raddr     = issue_fifo_rdata.addr;
...
</code></pre></div><p>ジャンプ命令でライトバックする値は次の命令のアドレスであるため、 RVC命令の場合はPCに<code>2</code>を足した値を設定します (リスト38)。</p><p><span class="caption">▼リスト13.38: 次の命令のアドレスを変える (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f4dc1e9c1895373f57b1f97f5f710741787fa590~1..f4dc1e9c1895373f57b1f97f5f710741787fa590#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> wbs_wb_data: UIntX    = <span class="hljs-keyword">switch</span> {
...
</code></pre></div><p>rvc_conveterモジュールのポートを定義します。 <code>src/rvc_converter.veryl</code>を作成し、次のように記述します (リスト40)。</p><p><span class="caption">▼リスト13.40: ポートの定義 (rvc_converter.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/c88655b32d323ed448453e03a51aac1d2f20c382~1..c88655b32d323ed448453e03a51aac1d2f20c382#diff-6be9c4012aad1c763d3ecf0967de694dd7c9324ba05422733b3a84c8a811a97c">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">import</span> eei::*;
...
</code></pre></div><p>RVC命令のとき、変換された32ビット幅の命令を<code>issue_fifo</code>に書き込み、 <code>issue_pc_offset</code>を<code>4</code>ではなく<code>2</code>増やすようにします (リスト45、 リスト46)。</p><p><span class="caption">▼リスト13.45: RVC命令のときのオフセットの更新 (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/c88655b32d323ed448453e03a51aac1d2f20c382~1..c88655b32d323ed448453e03a51aac1d2f20c382#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// offsetが6な32ビット命令の場合、</span>
...
</code></pre></div><p><span class="caption">▼リスト13.46: RVC命令のときのissue_fifoへの書き込み (inst_fetcher.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/c88655b32d323ed448453e03a51aac1d2f20c382~1..c88655b32d323ed448453e03a51aac1d2f20c382#diff-6e174507e7e639b62798d99d76de83f85f0201a5accd72b2a3190b528191b3b3">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> !core_if.is_hazard &amp;&amp; fetch_fifo_rvalid {
