...
</code></pre></div><p><span class="caption">▼リスト15.6: get_device関数でACLINTの範囲を定義する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> MMAP_ACLINT_BEGIN &lt;= addr &amp;&amp; addr &lt;= MMAP_ACLINT_END {
    <span class="hljs-keyword">return</span> Device::ACLINT;
}
</code></pre></div><p>ACLINTとのインターフェースを追加し、 reset_all_device_masters関数にインターフェースをリセットするコードを追加します ( リスト7、 リスト8 )。</p><p><span class="caption">▼リスト15.7: ポートにACLINTのインターフェースを追加する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> mmio_controller (
    clk          : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">clock</span>         ,
    rst          : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">reset</span>         ,
...
</code></pre></div><p><span class="caption">▼リスト15.8: インターフェースの要求部分をリセットする (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> reset_all_device_masters () {
...
</code></pre></div><p><code>ready</code>、<code>rvalid</code>を取得する関数にACLINTを登録します ( リスト9、 リスト10 )。</p><p><span class="caption">▼リスト15.9: get_device_ready関数にACLINTのreadyを追加 (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: <span class="hljs-keyword">return</span> aclint_membus.ready;
</code></pre></div><p><span class="caption">▼リスト15.10: get_device_rvalid関数にACLINTのrvalidを追加 (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: <span class="hljs-keyword">return</span> aclint_membus.rvalid;
</code></pre></div><p>ACLINTの<code>rvalid</code>、<code>rdata</code>を<code>req_core</code>に割り当てます ( リスト11 )。</p><p><span class="caption">▼リスト15.11: ACLINTへのアクセス結果をreqに割り当てる (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: req &lt;&gt; aclint_membus;
</code></pre></div><p>ACLINTのインターフェースに要求を割り当てます ( リスト12 )。</p><p><span class="caption">▼リスト15.12: ACLINTにreqを割り当ててアクセス要求する (mmio_controller.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-eb5f5642a61b8f62a17780d16b47a8273fc236beb095a754ff5288b0d30695c7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: {
    aclint_membus      &lt;&gt; req;
    aclint_membus.addr -= MMAP_ACLINT_BEGIN;
}
</code></pre></div><h3 id="aclintとmmio-controller、csrunitモジュールを接続する" tabindex="-1">ACLINTとmmio_controller、csrunitモジュールを接続する <a class="header-anchor" href="#aclintとmmio-controller、csrunitモジュールを接続する" aria-label="Permalink to “ACLINTとmmio_controller、csrunitモジュールを接続する”">​</a></h3><p>aclint_ifインターフェース(<code>aclint_core_bus</code>)、 aclint_memoryモジュールとmmio_controllerモジュールを接続するインターフェース(<code>aclint_membus</code>)をインスタンス化します ( リスト13、 リスト14 )。</p><p><span class="caption">▼リスト15.13: aclint_ifインターフェースのインスタンス化 (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> aclint_core_bus: aclint_if;
</code></pre></div><p><span class="caption">▼リスト15.14: mmio_controllerモジュールと接続するインターフェースのインスタンス化 (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> aclint_membus  : Membus;
</code></pre></div><p>aclint_memoryモジュールをインスタンス化し、 mmio_controllerモジュールと接続します ( リスト15、 リスト16 )。</p><p><span class="caption">▼リスト15.15: aclint_memoryモジュールをインスタンス化する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> aclintm: aclint_memory (
    clk                    ,
    rst                    ,
    membus: aclint_membus  ,
    aclint: aclint_core_bus,
);
</code></pre></div><p><span class="caption">▼リスト15.16: mmio_controllerモジュールと接続する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> mmioc: mmio_controller (
    clk                           ,
    rst                           ,
...
</code></pre></div><p>core、csrunitモジュールにaclint_ifポートを追加し、 csrunitモジュールとaclint_memoryモジュールを接続します ( リスト17、 リスト18、 リスト19、 リスト20 )。</p><p><span class="caption">▼リスト15.17: coreモジュールにACLINTのデバイスとのインターフェースを追加する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> core (
    clk     : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">clock</span>               ,
    rst     : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">reset</span>               ,
...
</code></pre></div><p><span class="caption">▼リスト15.18: coreモジュールにaclint_ifインターフェースを接続する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/190033eea82e79d17d09dd0e778f110634595fb0~1..190033eea82e79d17d09dd0e778f110634595fb0#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> c: core (
    clk                      ,
    rst                      ,
...
</code></pre></div><p>aclint_memoryモジュールに<code>msip0</code>レジスタを作成し、読み書きできるようにします ( リスト22、 リスト23、 リスト24 )。</p><p><span class="caption">▼リスト15.22: msip0レジスタの定義 (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/edc26deb2b2b12d01487743751fafdf19301d8bc~1..edc26deb2b2b12d01487743751fafdf19301d8bc#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> msip0: <span class="hljs-keyword">logic</span>;
</code></pre></div><p><span class="caption">▼リスト15.23: msip0レジスタを0でリセットする (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/edc26deb2b2b12d01487743751fafdf19301d8bc~1..edc26deb2b2b12d01487743751fafdf19301d8bc#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
        membus.rvalid = <span class="hljs-number">0</span>;
        membus.rdata  = <span class="hljs-number">0</span>;
        <span class="custom-hl-bold">msip0         = <span class="hljs-number">0</span>;</span>
</code></pre></div><p><span class="caption">▼リスト15.24: msip0レジスタの書き込み、読み込み (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/edc26deb2b2b12d01487743751fafdf19301d8bc~1..edc26deb2b2b12d01487743751fafdf19301d8bc#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> membus.valid {
...
</code></pre></div><h3 id="mip、mieレジスタを実装する" tabindex="-1">mip、mieレジスタを実装する <a class="header-anchor" href="#mip、mieレジスタを実装する" aria-label="Permalink to “mip、mieレジスタを実装する”">​</a></h3><p><img src="`+t+'" alt="mipレジスタ"></p><p class="caption" style="text-align:center;font-weight:bold;">▲図3: mipレジスタ</p><p><img src="'+d+`" alt="mieレジスタ"></p><p class="caption" style="text-align:center;font-weight:bold;">▲図4: mieレジスタ</p><p>mipレジスタのMSIPビット、mieレジスタのMSIEビットを実装します。 mie.MSIEはMSIPビットによる割り込み待機を許可するかを制御するビットです。 mip.MSIPとmie.MSIEは同じ位置のビットに配置されています。 mip.MSIPに書き込むことはできません。</p><p>csrunitモジュールにmieレジスタを作成します ( リスト26、 リスト27 )。</p><p><span class="caption">▼リスト15.26: mieレジスタの定義 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/96f19cc6fff8d264d93dadbb1e22f19656f3bc0e~1..96f19cc6fff8d264d93dadbb1e22f19656f3bc0e#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> mie     : UIntX ;
</code></pre></div><p><span class="caption">▼リスト15.27: mieレジスタを0でリセットする (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/96f19cc6fff8d264d93dadbb1e22f19656f3bc0e~1..96f19cc6fff8d264d93dadbb1e22f19656f3bc0e#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if_reset</span> {
    mode     = PrivMode::M;
...
</code></pre></div><p>mipレジスタを作成します。 MSIPビットをMSWIデバイスのMSIP0レジスタと接続し、 それ以外のビットは<code>0</code>に設定します (リスト28)。</p><p><span class="caption">▼リスト15.28: mipレジスタの定義 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/96f19cc6fff8d264d93dadbb1e22f19656f3bc0e~1..96f19cc6fff8d264d93dadbb1e22f19656f3bc0e#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> mip: UIntX = {
...
</code></pre></div><p>mie、mipレジスタの値を読み込めるようにします (リスト29)。</p><p><span class="caption">▼リスト15.29: rdataにmip、mieレジスタの値を割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/96f19cc6fff8d264d93dadbb1e22f19656f3bc0e~1..96f19cc6fff8d264d93dadbb1e22f19656f3bc0e#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::MTVEC   : mtvec,
<span class="custom-hl-bold">CsrAddr::MIP     : mip,</span>
<span class="custom-hl-bold">CsrAddr::MIE     : mie,</span>
CsrAddr::MCYCLE  : mcycle,
</code></pre></div><p>mieレジスタの書き込みマスクを設定して、MSIEビットを書き込めるようにします ( リスト30、 リスト31、 リスト32 )。 あとでMTIMEデバイスを実装するときにMTIEビットを使うため、 ここでMTIEビットも書き込めるようにしておきます。</p><p><span class="caption">▼リスト15.30: mieレジスタの書き込みマスクの定義 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/96f19cc6fff8d264d93dadbb1e22f19656f3bc0e~1..96f19cc6fff8d264d93dadbb1e22f19656f3bc0e#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> MIE_WMASK     : UIntX = <span class="hljs-number">&#39;h0000_0000_0000_0088</span> <span class="hljs-keyword">as</span> UIntX;
</code></pre></div><p><span class="caption">▼リスト15.31: wmaskに書き込みマスクを設定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/96f19cc6fff8d264d93dadbb1e22f19656f3bc0e~1..96f19cc6fff8d264d93dadbb1e22f19656f3bc0e#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::MTVEC   : MTVEC_WMASK,
<span class="custom-hl-bold">CsrAddr::MIE     : MIE_WMASK,</span>
CsrAddr::MSCRATCH: MSCRATCH_WMASK,
</code></pre></div><p><span class="caption">▼リスト15.32: mieレジスタの書き込み (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/96f19cc6fff8d264d93dadbb1e22f19656f3bc0e~1..96f19cc6fff8d264d93dadbb1e22f19656f3bc0e#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> is_wsc {
...
</code></pre></div><h3 id="mstatusのmie、mpieビットを実装する" tabindex="-1">mstatusのMIE、MPIEビットを実装する <a class="header-anchor" href="#mstatusのmie、mpieビットを実装する" aria-label="Permalink to “mstatusのMIE、MPIEビットを実装する”">​</a></h3><p>mstatus.MIE、MPIEを変更できるようにします ( リスト33、 リスト34 )。</p><p><span class="caption">▼リスト15.33: 書き込みマスクを変更する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/486dea10578bce8d85a3757bd1982e2f4f7dab27~1..486dea10578bce8d85a3757bd1982e2f4f7dab27#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> MSTATUS_WMASK : UIntX = <span class="hljs-number">&#39;h0000_0000_0000_0088</span> <span class="hljs-keyword">as</span> UIntX;
</code></pre></div><p><span class="caption">▼リスト15.34: レジスタの場所を変数に割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/486dea10578bce8d85a3757bd1982e2f4f7dab27~1..486dea10578bce8d85a3757bd1982e2f4f7dab27#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// mstatus bits</span>
...
</code></pre></div><p>プログラムでは、 mtvecにinterrupt_handler関数のアドレスを書き込み、 mstatus.MIE、mie.MSIEを<code>1</code>に設定して割り込みを許可してから MSIP0レジスタに1を書き込んでいます。</p><p>プログラムをコンパイルして実行<sup class="footnote-ref"><a href="#fn1" id="fnref1">[1]</a></sup>すると、 ソフトウェア割り込みが発生することでinterrupt_handlerにジャンプし、 デバッグ用のデバイスに<code>1</code>を書き込んで終了することを確認できます。</p><h2 id="mtvecのvectoredモードの実装" tabindex="-1">mtvecのVectoredモードの実装 <a class="header-anchor" href="#mtvecのvectoredモードの実装" aria-label="Permalink to “mtvecのVectoredモードの実装”">​</a></h2><p><img src="`+o+`" alt="mtvecレジスタ"></p><p class="caption" style="text-align:center;font-weight:bold;">▲図5: mtvecレジスタ</p><p>mtvecレジスタにはMODEフィールドがあり、 割り込みが発生するときのジャンプ先の決定方法を制御できます(図5)。</p><p>MODEがDirect(<code>2&#39;b00</code>)のとき、<code>mtvec.BASE &lt;&lt; 2</code>のアドレスにトラップします。 Vectored(<code>2&#39;b01</code>)のとき、<code>(mtvec.BASE &lt;&lt; 2) + 4 * cause</code>のアドレスにトラップします。 ここでcauseは割り込みのcauseのMSBを除いた値です。 例えばmachine software interruptの場合、<code>(mtvec.BASE &lt;&lt; 2) + 4 * 3</code>がジャンプ先になります。</p><p>例外のトラップベクタは、常にMODEがDirectとして計算します。</p><p>下位1ビットに書き込めるようにすることで、 mtvec.MODEにVectoredを書き込めるようにします (リスト44)。</p><p><span class="caption">▼リスト15.44: 書き込みマスクを変更する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/e5758b1f75a3038509d7cd62c83d0811d9d1185d~1..e5758b1f75a3038509d7cd62c83d0811d9d1185d#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> MTVEC_WMASK   : UIntX = <span class="hljs-number">&#39;hffff_ffff_ffff_fff</span><span class="custom-hl-bold">d</span>;
</code></pre></div><p>割り込みのトラップベクタをMODEとcauseに応じて変更します (リスト45)。</p><p><span class="caption">▼リスト15.45: 割り込みのトラップベクタを求める (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/e5758b1f75a3038509d7cd62c83d0811d9d1185d~1..e5758b1f75a3038509d7cd62c83d0811d9d1185d#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> interrupt_vector: Addr  = <span class="hljs-keyword">if</span> mtvec[<span class="hljs-number">0</span>] == <span class="hljs-number">0</span> ? {mtvec[<span class="hljs-keyword">msb</span>:<span class="hljs-number">2</span>], <span class="hljs-number">2&#39;b0</span>} : <span class="hljs-comment">// Direct</span>
...
</code></pre></div><p><span class="caption">▼リスト15.49: レジスタを0でリセットする (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b016f632703e3def340aee71c905536d4ff7e861~1..b016f632703e3def340aee71c905536d4ff7e861#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
        membus.rvalid = <span class="hljs-number">0</span>;
        membus.rdata  = <span class="hljs-number">0</span>;
...
</code></pre></div><p><span class="caption">▼リスト15.50: mtime、mtimecmpの書き込み、読み込み (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b016f632703e3def340aee71c905536d4ff7e861~1..b016f632703e3def340aee71c905536d4ff7e861#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> membus.wen {
    <span class="hljs-keyword">let</span> M: <span class="hljs-keyword">logic</span>&lt;MEMBUS_DATA_WIDTH&gt; = membus.wmask_expand();
    <span class="hljs-keyword">let</span> D: <span class="hljs-keyword">logic</span>&lt;MEMBUS_DATA_WIDTH&gt; = membus.wdata &amp; M;
    <span class="hljs-keyword">case</span> addr {
        MMAP_ACLINT_MSIP    : msip0     = D[<span class="hljs-number">0</span>] | msip0 &amp; ~M[<span class="hljs-number">0</span>];
...
</code></pre></div><p>aclint_ifインターフェースに<code>mtip</code>を作成し、タイマ割り込みが発生する条件を設定します ( リスト51、 リスト52 )。</p><p><span class="caption">▼リスト15.51: mtipをインターフェースに追加する (aclint_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b016f632703e3def340aee71c905536d4ff7e861~1..b016f632703e3def340aee71c905536d4ff7e861#diff-4a970aed66e74f1c5e4a4397d31cedb3bb820d7d48d43d55e416807cb192c5ea">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> msip: <span class="hljs-keyword">logic</span>;
...
</code></pre></div><p><span class="caption">▼リスト15.52: mtipにタイマ割り込みが発生する条件を設定する (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b016f632703e3def340aee71c905536d4ff7e861~1..b016f632703e3def340aee71c905536d4ff7e861#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    aclint.msip = msip0;
    <span class="custom-hl-bold">aclint.mtip = mtime &gt;= mtimecmp0;</span>
}
</code></pre></div><h3 id="mip-mtip、割り込み原因を設定する" tabindex="-1">mip.MTIP、割り込み原因を設定する <a class="header-anchor" href="#mip-mtip、割り込み原因を設定する" aria-label="Permalink to “mip.MTIP、割り込み原因を設定する”">​</a></h3><p>mipレジスタのMTIPビットにaclint_ifインターフェースの<code>mtip</code>を接続します (リスト53)。</p><p><span class="caption">▼リスト15.53: mip.MTIPにインターフェースのmtipを割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b016f632703e3def340aee71c905536d4ff7e861~1..b016f632703e3def340aee71c905536d4ff7e861#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> mip: UIntX = {
    <span class="hljs-number">1&#39;b0</span> <span class="hljs-keyword">repeat</span> XLEN - <span class="hljs-number">12</span>, <span class="hljs-comment">// 0, LCOFIP</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// MEIP</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// 0</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// SEIP</span>
...
</code></pre></div><p>割り込み原因を優先順位に応じて設定します。 タイマ割り込みはソフトウェア割り込みよりも優先順位が低いため、 ソフトウェア割り込みの下で原因を設定します (リスト54)。</p><p><span class="caption">▼リスト15.54: タイマ割り込みのcauseを設定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/b016f632703e3def340aee71c905536d4ff7e861~1..b016f632703e3def340aee71c905536d4ff7e861#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="custom-hl-bold"><span class="hljs-keyword">let</span> interrupt_pending: UIntX = mip &amp; mie;</span>
...
</code></pre></div><p>WFI命令で割り込みが発生するとき、mepcレジスタに<code>pc + 4</code>を書き込むようにします ( リスト57、 リスト58 )。</p><p><span class="caption">▼リスト15.57: WFI命令の判定 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9c9c7d11dccc1ffc7ba9ae677dbff11c118a16d2~1..9c9c7d11dccc1ffc7ba9ae677dbff11c118a16d2#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> is_wfi: <span class="hljs-keyword">logic</span> = inst_bits == <span class="hljs-number">32&#39;h10500073</span>;
</code></pre></div><p><span class="caption">▼リスト15.58: WFI命令のとき、mepcをpc+4にする (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/9c9c7d11dccc1ffc7ba9ae677dbff11c118a16d2~1..9c9c7d11dccc1ffc7ba9ae677dbff11c118a16d2#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> raise_expt || raise_interrupt {
...
</code></pre></div><p>mtimeレジスタの値をACLINTモジュールからcsrunitに渡します ( リスト60、 リスト61 )。</p><p><span class="caption">▼リスト15.60: mtimeをインターフェースに追加する (aclint_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7a62f378e1df2e0a81f615e761a36f6c176d5e7e~1..7a62f378e1df2e0a81f615e761a36f6c176d5e7e#diff-4a970aed66e74f1c5e4a4397d31cedb3bb820d7d48d43d55e416807cb192c5ea">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="custom-hl-bold"><span class="hljs-keyword">import</span> eei::*;</span>
...
</code></pre></div><p><span class="caption">▼リスト15.61: mtimeをインターフェースに割り当てる (aclint_memory.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7a62f378e1df2e0a81f615e761a36f6c176d5e7e~1..7a62f378e1df2e0a81f615e761a36f6c176d5e7e#diff-1badfc28e588ad23679fda7668c8b8d2caf435239977507b569c8acce1e86170">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    aclint.msip  = msip0;
    aclint.mtip  = mtime &gt;= mtimecmp0;
    <span class="custom-hl-bold">aclint.mtime = mtime;</span>
}
</code></pre></div><p>time、instret、cycleレジスタを読み込めるようにします (リスト62)。</p><p><span class="caption">▼リスト15.62: rdataにインターフェースのmtimeを割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7a62f378e1df2e0a81f615e761a36f6c176d5e7e~1..7a62f378e1df2e0a81f615e761a36f6c176d5e7e#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::CYCLE   : mcycle,
CsrAddr::TIME    : aclint.mtime,
CsrAddr::INSTRET : minstret,
</code></pre></div><hr class="footnotes-sep"><section class="footnotes"><ol class="footnotes-list"><li id="fn1" class="footnote-item"><p>コンパイル、実行方法は<a href="./12-impl-mmio.html">「11.6.4 出力をテストする」</a>を参考にしてください。 <a href="#fnref1" class="footnote-backref">↩︎</a></p></li><li id="fn2" class="footnote-item"><p>mhpmcounterレジスタと同じ値をとるhpmcounterレジスタもありますが、mhpmcounterレジスタを実装していないので実装しません。 <a href="#fnref2" class="footnote-backref">↩︎</a></p></li></ol></section>`,252)])])}const v=a(r,[["render",i]]);export{j as __pageData,v as default};
