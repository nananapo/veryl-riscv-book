...
</code></pre></div><p><span class="caption">▼リスト10.3: MEMステージのFIFOにExceptionInfoを追加する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4a973122dabbb71cb74067441e779f41727c6f0c~1..4a973122dabbb71cb74067441e779f41727c6f0c#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">struct</span> memq_type {
    addr      : Addr            ,
    bits      : Inst            ,
    ctrl      : InstCtrl        ,
    imm       : UIntX           ,
...
</code></pre></div><p>IDステージからEXステージに命令を渡すとき、 命令がECALL命令なら例外が発生することを伝えます (リスト4)。</p><p><span class="caption">▼リスト10.4: IDステージでECALL命令を判定する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4a973122dabbb71cb74067441e779f41727c6f0c~1..4a973122dabbb71cb74067441e779f41727c6f0c#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
`)])])],-1),e(`<p>csrunitモジュールを変更します。 <code>expt_info</code>ポートを追加して、MEMステージ以前の例外情報を受け取ります ( リスト6、 リスト7、 リスト8 )。</p><p><span class="caption">▼リスト10.6: csrunitモジュールに例外情報を受け取るためのポートを追加する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4a973122dabbb71cb74067441e779f41727c6f0c~1..4a973122dabbb71cb74067441e779f41727c6f0c#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> csrunit (
...
</code></pre></div><p><span class="caption">▼リスト10.8: csrunitモジュールに例外情報を供給する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4a973122dabbb71cb74067441e779f41727c6f0c~1..4a973122dabbb71cb74067441e779f41727c6f0c#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> csru: csrunit (
    clk                             ,
    rst                             ,
    valid    : mems_valid           ,
    pc       : mems_pc              ,
...
</code></pre></div><p>ECALL命令かどうかを判定する<code>is_ecall</code>変数を削除して、 例外の発生条件、例外の種類を示す値を変更します ( リスト9、 リスト10 )。</p><p><span class="caption">▼リスト10.9: csrunitモジュールでのECALL命令の判定を削除する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4a973122dabbb71cb74067441e779f41727c6f0c~1..4a973122dabbb71cb74067441e779f41727c6f0c#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// CSRR(W|S|C)[I]命令かどうか</span>
...
</code></pre></div><p><span class="caption">▼リスト10.10: ExceptionInfoを使って例外を起こす (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/4a973122dabbb71cb74067441e779f41727c6f0c~1..4a973122dabbb71cb74067441e779f41727c6f0c#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// Exception</span>
...
</code></pre></div><h3 id="mtvalレジスタを実装する" tabindex="-1">mtvalレジスタを実装する <a class="header-anchor" href="#mtvalレジスタを実装する" aria-label="Permalink to “mtvalレジスタを実装する”">​</a></h3><p>例外が発生すると、CPUはトラップベクタにジャンプして例外を処理します。 mcauseレジスタを読むことでどの例外が発生したかを判別できますが、 その例外の詳しい情報を知りたいことがあります。</p><p><img src="`+d+`" alt="mtvalレジスタ"></p><p class="caption" style="text-align:center;font-weight:bold;">▲図1: mtvalレジスタ</p><p>RISC-Vには、例外が発生したときのソフトウェアによるハンドリングを補助するために、 MXLENビットのmtvalレジスタが定義されています(図1)。 例外が発生したとき、CPUはmtvalレジスタに例外に固有の情報を書き込みます。 これ以降、例外に固有の情報のことをtvalと呼びます。</p><p><code>ExceptionInfo</code>構造体に例外に固有の情報を示す<code>value</code>を追加します (リスト11)。</p><p><span class="caption">▼リスト10.11: tvalをExceptionInfoに追加する (corectrl.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/67fb5eeeeb501eed7e201dd647c532f0ae255ed4~1..67fb5eeeeb501eed7e201dd647c532f0ae255ed4#diff-6e03bfb8e3afdba1e0b88b561d8b8e5e4f2a7ffc6c4efb228c5797053b78742c">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">struct</span> ExceptionInfo {
    valid: <span class="hljs-keyword">logic</span>   ,
    cause: CsrCause,
    <span class="custom-hl-bold">value: UIntX   ,</span>
}
</code></pre></div><p>ECALL命令はmtvalに書き込むような情報がないので<code>0</code>に設定します (リスト12)。</p><p><span class="caption">▼リスト10.12: ECALL命令のtvalを設定する (corectrl.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/67fb5eeeeb501eed7e201dd647c532f0ae255ed4~1..67fb5eeeeb501eed7e201dd647c532f0ae255ed4#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// exception</span>
...
</code></pre></div><p><code>CsrAddr</code>型にmtvalレジスタのアドレスを追加します (リスト13)。</p><p><span class="caption">▼リスト10.13: mtvalのアドレスを定義する (eei.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/67fb5eeeeb501eed7e201dd647c532f0ae255ed4~1..67fb5eeeeb501eed7e201dd647c532f0ae255ed4#diff-11470b1e7d69c89ea3723d114583fe520f6d8482422a151ad706be8ab57ea6b7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">enum</span> CsrAddr: <span class="hljs-keyword">logic</span>&lt;<span class="hljs-number">12</span>&gt; {
...
</code></pre></div><p>mtvalレジスタを実装して、書き込み、読み込みできるようにします ( リスト14、 リスト15、 リスト16、 リスト17、 リスト18 )。</p><p><span class="caption">▼リスト10.14: mtvalの書き込みマスクを定義する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/67fb5eeeeb501eed7e201dd647c532f0ae255ed4~1..67fb5eeeeb501eed7e201dd647c532f0ae255ed4#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> MTVAL_WMASK : UIntX = <span class="hljs-number">&#39;hffff_ffff_ffff_ffff</span>;
</code></pre></div><p><span class="caption">▼リスト10.15: mtvalレジスタを作成する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/67fb5eeeeb501eed7e201dd647c532f0ae255ed4~1..67fb5eeeeb501eed7e201dd647c532f0ae255ed4#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> mtvec : UIntX;
...
</code></pre></div><p><span class="caption">▼リスト10.16: mtvalの読み込みデータ、書き込みマスクを設定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/67fb5eeeeb501eed7e201dd647c532f0ae255ed4~1..67fb5eeeeb501eed7e201dd647c532f0ae255ed4#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p><span class="caption">▼リスト10.17: mtvalレジスタをリセットする (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/67fb5eeeeb501eed7e201dd647c532f0ae255ed4~1..67fb5eeeeb501eed7e201dd647c532f0ae255ed4#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
...
</code></pre></div><p><span class="caption">▼リスト10.18: mtvalに書き込めるようにする (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/67fb5eeeeb501eed7e201dd647c532f0ae255ed4~1..67fb5eeeeb501eed7e201dd647c532f0ae255ed4#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>} <span class="hljs-keyword">else</span> {
...
</code></pre></div><p>例外が発生するとき、mtvalレジスタに<code>expt_info.value</code>を書き込むようにします ( リスト19、 リスト20 )。</p><p><span class="caption">▼リスト10.19: tvalを変数に割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/67fb5eeeeb501eed7e201dd647c532f0ae255ed4~1..67fb5eeeeb501eed7e201dd647c532f0ae255ed4#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> raise_expt: <span class="hljs-keyword">logic</span> = valid &amp;&amp; expt_info.valid;
<span class="hljs-keyword">let</span> expt_cause: UIntX = expt_info.cause;
<span class="custom-hl-bold"><span class="hljs-keyword">let</span> expt_value: UIntX = expt_info.value;</span>
</code></pre></div><p><span class="caption">▼リスト10.20: 例外が発生するとき、mtvalにtvalを書き込む (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/67fb5eeeeb501eed7e201dd647c532f0ae255ed4~1..67fb5eeeeb501eed7e201dd647c532f0ae255ed4#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> valid {
...
</code></pre></div><h2 id="breakpoint例外の実装" tabindex="-1">Breakpoint例外の実装 <a class="header-anchor" href="#breakpoint例外の実装" aria-label="Permalink to “Breakpoint例外の実装”">​</a></h2><p>Breakpoint例外は、EBREAK命令によって引き起こされる例外です。 EBREAK命令はデバッガがプログラムを中断させる場合などに利用されます。 EBREAK命令はECALL命令と同様に例外を発生させるだけで、ほかに操作を行いません。 causeは<code>3</code>で、tvalは例外が発生した命令のアドレスになります。</p><p><code>CsrCause</code>型にBreakpoint例外のcauseを追加します (リスト21)。</p><p><span class="caption">▼リスト10.21: Breakpoint例外のcauseを定義する (eei.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/d59ed9411603746c6356a3161cba5bf6765a77e2~1..d59ed9411603746c6356a3161cba5bf6765a77e2#diff-11470b1e7d69c89ea3723d114583fe520f6d8482422a151ad706be8ab57ea6b7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">enum</span> CsrCause: UIntX {
    BREAKPOINT = <span class="hljs-number">3</span>,
    ENVIRONMENT_CALL_FROM_M_MODE = <span class="hljs-number">11</span>,
}
</code></pre></div><p>IDステージでEBREAK命令を判定して、tvalにPCを設定します (リスト22)。</p><p><span class="caption">▼リスト10.22: IDステージでEBREAK命令を判定する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/d59ed9411603746c6356a3161cba5bf6765a77e2~1..d59ed9411603746c6356a3161cba5bf6765a77e2#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>exq_wdata.expt = <span class="hljs-number">0</span>;
...
</code></pre></div><p><span class="caption">▼リスト10.24: inst_decoderモジュールのvalidポートと変数を接続する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/e10c4f558f1ae80f7d9cffb7071f12127e8588ca~1..e10c4f558f1ae80f7d9cffb7071f12127e8588ca#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> ids_valid     : <span class="hljs-keyword">logic</span>    = if_fifo_rvalid;
...
</code></pre></div><p>今のところ実装してある命令を有効な命令として判定する処理をalways_combブロックに記述します (リスト25)。</p><p><span class="caption">▼リスト10.25: 命令の有効判定を行う (inst_decoder.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/e10c4f558f1ae80f7d9cffb7071f12127e8588ca~1..e10c4f558f1ae80f7d9cffb7071f12127e8588ca#diff-0520643107a80d7dcd5de7ffc77443b16b7089aa9e14564e8201c524e6d0eec8">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>valid = <span class="hljs-keyword">case</span> op {
...
</code></pre></div><p>riscv-testsでメモリ読み書きの順序を保証するFENCE命令<sup class="footnote-ref"><a href="#fn4" id="fnref4">[4]</a></sup>を使用しているため、 opcodeがOP-MISCである命令を合法な命令として取り扱っています。 OP-MISCのopcode(<code>7&#39;b0001111</code>)をeeiパッケージに定義してください (リスト26)。</p><p><span class="caption">▼リスト10.26: OP-MISCのビット列を定義する (eei.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/e10c4f558f1ae80f7d9cffb7071f12127e8588ca~1..e10c4f558f1ae80f7d9cffb7071f12127e8588ca#diff-11470b1e7d69c89ea3723d114583fe520f6d8482422a151ad706be8ab57ea6b7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> OP_MISC_MEM : <span class="hljs-keyword">logic</span>&lt;<span class="hljs-number">7</span>&gt; = <span class="hljs-number">7&#39;b0001111</span>;
</code></pre></div><p><code>CsrCause</code>型にIllegal instruction例外のcauseを追加します (リスト27)。</p><p><span class="caption">▼リスト10.27: Illegal instruction例外のcauseを定義する (eei.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/e10c4f558f1ae80f7d9cffb7071f12127e8588ca~1..e10c4f558f1ae80f7d9cffb7071f12127e8588ca#diff-11470b1e7d69c89ea3723d114583fe520f6d8482422a151ad706be8ab57ea6b7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">enum</span> CsrCause: UIntX {
    <span class="custom-hl-bold">ILLEGAL_INSTRUCTION = <span class="hljs-number">2</span>,</span>
    BREAKPOINT = <span class="hljs-number">3</span>,
    ENVIRONMENT_CALL_FROM_M_MODE = <span class="hljs-number">11</span>,
}
</code></pre></div><p><code>valid</code>フラグを利用して、IDステージでIllegal instruction例外を発生させます (リスト28)。 tvalには、命令を右に詰めてゼロで拡張した値を設定します。</p><p><span class="caption">▼リスト10.28: 不正な命令のとき、例外を発生させる (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/e10c4f558f1ae80f7d9cffb7071f12127e8588ca~1..e10c4f558f1ae80f7d9cffb7071f12127e8588ca#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>exq_wdata.expt = <span class="hljs-number">0</span>;
...
</code></pre></div><p><span class="caption">▼リスト10.30: csrunitモジュールのポート定義を変更する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e~1..db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> csru: csrunit (
    clk                               ,
    rst                               ,
    valid      : mems_valid           ,
    pc         : mems_pc              ,
...
</code></pre></div><p>命令のfunct3とrs1のアドレスを利用して、書き込み先が読み込み専用レジスタかどうかを判定します<sup class="footnote-ref"><a href="#fn6" id="fnref6">[6]</a></sup> (リスト32)。 また、命令のビット列を利用できるようになったので、MRET命令の判定を命令のビット列の比較に書き換えています。</p><p><span class="caption">▼リスト10.32: 読み込み専用CSRへの書き込みが発生するか判定する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e~1..db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// CSRR(W|S|C)[I]命令かどうか</span>
<span class="hljs-keyword">let</span> is_wsc: <span class="hljs-keyword">logic</span> = ctrl.is_csr &amp;&amp; ctrl.funct3[<span class="hljs-number">1</span>:<span class="hljs-number">0</span>] != <span class="hljs-number">0</span>;
...
</code></pre></div><p>例外が発生するとき、causeとtvalを設定します (リスト33)。</p><p><span class="caption">▼リスト10.33: 読み込み専用CSRの書き込みで例外を発生させる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e~1..db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> raise_expt: <span class="hljs-keyword">logic</span> = valid &amp;&amp; (expt_info.valid || expt_write_readonly_csr);
...
<span class="hljs-keyword">let</span> expt_value: UIntX = <span class="custom-hl-bold"><span class="hljs-keyword">switch</span> {</span>
    ...
    <span class="custom-hl-bold"><span class="hljs-keyword">default</span>                                    : <span class="hljs-number">0</span></span>
<span class="custom-hl-bold">}</span>;
</code></pre></div><p>この変更により、レジスタにライトバックするようにデコードされた命令が csrunitモジュールでトラップを起こすようになりました。 トラップが発生するときにWBステージでライトバックしないように変更します ( リスト34、 リスト35、 リスト36 )。</p><p><span class="caption">▼リスト10.34: トラップが発生したかを示すlogicをwbq_typeに追加する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e~1..db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">struct</span> wbq_type {
    addr      : Addr    ,
    bits      : Inst    ,
    ctrl      : InstCtrl,
    imm       : UIntX   ,
...
</code></pre></div><p><span class="caption">▼リスト10.35: トラップが発生したかをWBステージに伝える (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e~1..db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>wbq_wdata.raise_trap = csru_raise_trap;
</code></pre></div><p><span class="caption">▼リスト10.36: トラップが発生しているとき、レジスタにデータを書き込まないようにする (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e~1..db43c40c7ce1b60c1c34c9aee2f1c1fa9327047e#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if</span> wbs_valid &amp;&amp; wbs_ctrl.rwb_en &amp;&amp; !wbq_rdata.raise_trap {
        regfile[wbs_rd_addr] = wbs_wb_data;
    }
}
</code></pre></div><h2 id="命令アドレスのミスアライン例外" tabindex="-1">命令アドレスのミスアライン例外 <a class="header-anchor" href="#命令アドレスのミスアライン例外" aria-label="Permalink to “命令アドレスのミスアライン例外”">​</a></h2><p>RISC-Vでは、命令アドレスがIALIGNビット境界に整列されていない場合に Instruction address misaligned例外が発生します。 causeは<code>0</code>で、tvalは命令のアドレスになります。</p><p>第13章「C拡張の実装」で実装するC拡張が実装されていない場合、 IALIGNは<code>32</code>と定義されています。 C拡張が定義されている場合は<code>16</code>になります。</p><p>IALIGNビット境界に整列されていない命令アドレスになるのはジャンプ命令、分岐命令を実行する場合です<sup class="footnote-ref"><a href="#fn7" id="fnref7">[7]</a></sup>。 PCの遷移先が整列されていない場合に例外が発生します。 分岐命令の場合、分岐が成立する場合にしか例外は発生しません。</p><p><code>CsrCause</code>型にInstruction address misaligned例外のcauseを追加します (リスト37)。</p><p><span class="caption">▼リスト10.37: Instruction address misaligned例外のcauseを定義する (eei.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/74a5baf7efb0bf66f82b4595481638165c600f35~1..74a5baf7efb0bf66f82b4595481638165c600f35#diff-11470b1e7d69c89ea3723d114583fe520f6d8482422a151ad706be8ab57ea6b7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">enum</span> CsrCause: UIntX {
...
</code></pre></div><p>EXステージでアドレスを確認して例外を判定します (リスト38)。 tvalは遷移先のアドレスになることに注意してください。</p><p><span class="caption">▼リスト10.38: EXステージでInstruction address misaligned例外の判定を行う (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/74a5baf7efb0bf66f82b4595481638165c600f35~1..74a5baf7efb0bf66f82b4595481638165c600f35#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>memq_wdata.jump_addr  = <span class="hljs-keyword">if</span> inst_is_br(exs_ctrl) ? exs_pc + exs_imm : exs_alu_result &amp; ~<span class="hljs-number">1</span>;
<span class="hljs-comment">// exception</span>
...
<span class="custom-hl-bold">    }</span>
<span class="custom-hl-bold">}</span>
</code></pre></div><h2 id="ロードストア命令のミスアライン例外" tabindex="-1">ロードストア命令のミスアライン例外 <a class="header-anchor" href="#ロードストア命令のミスアライン例外" aria-label="Permalink to “ロードストア命令のミスアライン例外”">​</a></h2><p>RISC-Vでは、ロード、ストア命令でアクセスするメモリのアドレスが、 ロード、ストアするビット幅に整列されていない場合に、 それぞれLoad address misaligned例外、Store/AMO address misaligned例外が発生します<sup class="footnote-ref"><a href="#fn8" id="fnref8">[8]</a></sup>。 例えばLW命令は4バイトに整列されたアドレス、LD命令は8バイトに整列されたアドレスにしかアクセスできません。 causeはそれぞれ<code>4</code>、<code>6</code>で、tvalはアクセスするメモリのアドレスになります。</p><p><code>CsrCause</code>型に例外のcauseを追加します (リスト39)。</p><p><span class="caption">▼リスト10.39: 例外のcauseを定義する (eei.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/509f1f94f5c9c78057e3b6bfe7583e8e2908e09c~1..509f1f94f5c9c78057e3b6bfe7583e8e2908e09c#diff-11470b1e7d69c89ea3723d114583fe520f6d8482422a151ad706be8ab57ea6b7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">enum</span> CsrCause: UIntX {
...
</code></pre></div><p>EXステージでアドレスを確認して例外を判定します (リスト40)。</p><p><span class="caption">▼リスト10.40: EXステージで例外の判定を行う (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/509f1f94f5c9c78057e3b6bfe7583e8e2908e09c~1..509f1f94f5c9c78057e3b6bfe7583e8e2908e09c#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> instruction_address_misaligned: <span class="hljs-keyword">logic</span> = memq_wdata.br_taken &amp;&amp; memq_wdata.jump_addr[<span class="hljs-number">1</span>:<span class="hljs-number">0</span>] != <span class="hljs-number">2&#39;b00</span>;
...
<span class="custom-hl-bold">    <span class="hljs-number">2&#39;b00</span>  : <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// B</span></span>
...
<span class="custom-hl-bold">    <span class="hljs-keyword">default</span>: <span class="hljs-number">1&#39;b0</span>,</span>
<span class="custom-hl-bold">};</span>
memq_wdata.expt = exq_rdata.expt;
...
</code></pre></div><p>例外が発生するときにmemunitモジュールが動作しないようにします (リスト41)。</p><p><span class="caption">▼リスト10.41: 例外が発生するとき、memunitのvalidを0にする (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/509f1f94f5c9c78057e3b6bfe7583e8e2908e09c~1..509f1f94f5c9c78057e3b6bfe7583e8e2908e09c#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> memu: memunit (
    clk                                   ,
    rst                                   ,
