import{_ as p,c as l,o as c,ah as n,j as s,a,bQ as d,bR as t,bS as o,bT as r,bU as i,bV as f,bW as b,bX as h,bY as u,bZ as m,b_ as y}from"./chunks/framework.0mWUHcXH.js";const P=JSON.parse('{"title":"S-modeの実装 (2. 仮想記憶システム)","description":"","frontmatter":{},"headers":[],"relativePath":"24-impl-paging.md","filePath":"24-impl-paging.md"}'),v={name:"24-impl-paging.md"};function _(j,e,w,g,k,E){return c(),l("div",null,[...e[0]||(e[0]=[n("",133),s("div",{class:"language-veryl"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"veryl"),s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"module"),a(` csrunit (
