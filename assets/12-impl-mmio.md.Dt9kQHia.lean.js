...
`)])])],-1),n("",99),s("div",{class:"language-veryl"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"veryl"),s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"const"),a(" RISCVTESTS_TOHOST_ADDR: Addr = "),s("span",{class:"custom-hl-bold"},"MMAP_RAM_BEGIN +"),a(),s("span",{class:"hljs-number"},"'h1000"),a(),s("span",{class:"hljs-keyword"},"as"),a(` Addr;
...
`)])])],-1),n("",10)])])}const _=l(t,[["render",d]]);export{f as __pageData,_ as default};
