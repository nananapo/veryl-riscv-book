import{_ as l,c,o as p,ah as n,j as a,a as s,bA as d,bB as t}from"./chunks/framework.0mWUHcXH.js";const y=JSON.parse('{"title":"A拡張の実装","description":"","frontmatter":{},"headers":[],"relativePath":"13-impl-a.md","filePath":"13-impl-a.md"}'),o={name:"13-impl-a.md"};function r(b,e,m,h,i,f){return p(),c("div",null,[...e[0]||(e[0]=[n("",91),a("div",{class:"language-veryl"},[a("button",{title:"Copy Code",class:"copy"}),a("span",{class:"lang"},"veryl"),a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-keyword"},"case"),s(` state {
...
`)])]),s(`        slave_saved.amoop  = slave.amoop;
        ...
        `),a("span",{class:"custom-hl-bold"},"}"),s(`
`)])])],-1),n("",53)])])}const j=l(o,[["render",r]]);export{y as __pageData,j as default};
