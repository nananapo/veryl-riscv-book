import{_ as p,c as l,o as c,ah as n,j as s,a,bV as d,bW as t,bX as o,bY as r,bZ as i,b_ as f,b$ as b,c0 as h,c1 as u,c2 as m,c3 as y,c4 as _}from"./chunks/framework.B0Vze7XN.js";const T=JSON.parse('{"title":"S-modeの実装 (2. 仮想記憶システム)","description":"","frontmatter":{},"headers":[],"relativePath":"24-impl-paging.md","filePath":"24-impl-paging.md"}'),v={name:"24-impl-paging.md"};function j(w,e,g,k,E,C){return c(),l("div",null,[...e[0]||(e[0]=[n("",133),s("div",{class:"language-veryl"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"veryl"),s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"module"),a(` csrunit (
...
`)])])],-1),n("",218)])])}const S=p(v,[["render",j]]);export{T as __pageData,S as default};
