import{_ as l,c as p,o as c,ah as e,j as a,a as s,aA as d,aB as t,aC as r,aD as o,aE as b,aF as i,aG as h}from"./chunks/framework.BNheOMQd.js";const v=JSON.parse('{"title":"CPUのパイプライン化","description":"","frontmatter":{},"headers":[],"relativePath":"05a-pipeline.md","filePath":"05a-pipeline.md"}'),m={name:"05a-pipeline.md"};function _(u,n,f,y,w,j){return c(),p("div",null,[...n[0]||(n[0]=[e("",66),a("div",{class:"language-veryl"},[a("button",{title:"Copy Code",class:"copy"}),a("span",{class:"lang"},"veryl"),a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-keyword"},"inst"),s(` id_ex_fifo: fifo #(
    DATA_TYPE: exq_type,
...
`)])])],-1),e("",105)])])}const q=l(m,[["render",_]]);export{v as __pageData,q as default};
