import{_ as n,c as p,o as l,ah as e,j as a,a as s,aG as o,aH as t,aI as d,aJ as r,aK as i,aL as b,aM as h,aN as f,aO as _,aP as m,aQ as u,aR as g,aS as y,aT as E,aU as j,aV as k,aW as P,aX as L,aY as C,aZ as D,a_ as w,a$ as v,b0 as A,b1 as T,b2 as x,b3 as I,b4 as M,b5 as N,b6 as O,b7 as R,b8 as S,b9 as q,ba as V,bb as F,bc as Y,bd as U,be as G,bf as H,bg as K,bh as W,bi as Q,bj as Z,bk as X,bl as z,bm as B,bn as $,bo as J,bp as aa,bq as sa,br as ea,bs as ca,bt as na,bu as pa,bv as la,bw as oa}from"./chunks/framework.n0uClWLT.js";const ma=JSON.parse('{"title":"CPUの合成","description":"","frontmatter":{},"headers":[],"relativePath":"05b-synth.md","filePath":"05b-synth.md"}'),ta={name:"05b-synth.md"};function da(ra,c,ia,ba,ha,fa){return l(),p("div",null,[...c[0]||(c[0]=[e('<h1 id="cpuの合成" tabindex="-1">CPUの合成 <a class="header-anchor" href="#cpuの合成" aria-label="Permalink to “CPUの合成”">​</a></h1><p>これまでの章では、RV64IのCPUを作成してパイプライン化しました。 今までは動作確認とテストはシミュレータで行っていましたが、 本章では実機(FPGA)でCPUを動かします。</p><p><img src="'+o+'" alt="PYNQ-Z1"></p><p class="caption">▲図1: PYNQ-Z1</p><h2 id="fpgaとは何か" tabindex="-1">FPGAとは何か？ <a class="header-anchor" href="#fpgaとは何か" aria-label="Permalink to “FPGAとは何か？”">​</a></h2><p>集積回路を製造するには手間と時間とお金が必要です。 FPGAを使うと、少しの手間と少しの時間、安価に集積回路の実現をお試しできます。</p><p><strong>FPGA</strong>(Field Programmable Gate Array)は、 任意の論理回路を実現できる集積回路のことです。 ハードウェア記述言語で設計した論理回路をFPGA上に設定することで、 実際に集積回路を製造しなくても実機で論理回路を再現できます。</p><p>「任意の論理回路を実現できる集積回路」は、 主にプロダクトターム方式、またはルックアップ・テーブル方式で構成されています。 本書では<strong>ルックアップ・テーブル</strong>(Lookup Table, <strong>LUT</strong>)方式のFPGAを利用します。</p><div id="lut_sample_truth" class="table"><p class="caption">表8.1: 真理値表の例</p><table><tr class="hline"><th>X</th><th>Y</th><th>A</th></tr><tr class="hline"><td>0</td><td>0</td><td>0</td></tr><tr class="hline"><td>0</td><td>1</td><td>1</td></tr><tr class="hline"><td>1</td><td>0</td><td>1</td></tr><tr class="hline"><td>1</td><td>1</td><td>0</td></tr></table></div> ![表1を実現するLUT](./images/05b-synth/lut.png) <p class="caption">▲図2: 表1を実現するLUT</p> LUTとは、真理値表を記憶素子に保存しておいて、 入力によって記憶された真理値を選択して出力する回路のことです。 例えば、2つの入力`X`と`Y`を受け取って`A`を出力する論理回路(表1)は、図2の回路で実現できます。 ここでマルチプレクサ(multiplexer, MUX)とは、複数の入力を選択信号によって選択して出力する回路のことです。 <p>図2では、記憶素子のデータを<code>Y</code>によって選択し、さらに<code>X</code>によって選択することで2入力1出力の真理値表の論理回路を実現しています。 入力がN個で出力がM個のLUTのことをN入力M出力LUTと呼びます。</p><p>ルックアップ・テーブル方式のFPGAは、多数のLUT、入出力装置、これらを相互接続するための配線によって構成されています。 また、乗算回路やメモリなどの部品はFPGAよりも専用の回路で実現した方が良い<sup class="footnote-ref"><a href="#fn1" id="fnref1">[1]</a></sup>ので、 メモリや乗算回路の部品が内蔵されていることがあります。</p><p>本書では2つのFPGA(Tang Nano 9K、PYNQ-Z1)を使用して実機でCPUを動作させます。 2024年11月12日時点ではどちらも秋月電子通商で入手できて、 Tang Nano 9Kは3000円くらい、 PYNQ-Z1は50000円くらいで入手できます。</p><h2 id="ledの制御" tabindex="-1">LEDの制御 <a class="header-anchor" href="#ledの制御" aria-label="Permalink to “LEDの制御”">​</a></h2><p><img src="'+t+'" alt="Tang Mega 138K ProのLED(6個)"></p><p class="caption">▲図3: Tang Mega 138K ProのLED(6個)</p> 大抵のFPGAボードにはLEDがついています。 本章では2つのテストプログラム(LEDを点灯させる、LEDを点滅させる)によって、CPUの動作確認を行います。 <p>LEDはトップモジュールのポートを経由して制御します(図4)。 ポートとLEDの接続方法は合成系によって異なるため、それらの接続方法は後で考えます。 CPUからLEDを制御するには、メモリ経由で制御する、CSRによって制御するなどの方法が考えられます。 本書ではLEDを制御するためのCSRを実装して、CSRをトップモジュールのポートに接続することでLEDを制御します。</p><p><img src="'+d+`" alt="CSRのLED制御用レジスタがLEDに接続される"></p><p class="caption">▲図4: CSRのLED制御用レジスタがLEDに接続される</p><h3 id="csrにled制御用レジスタを実装する" tabindex="-1">CSRにLED制御用レジスタを実装する <a class="header-anchor" href="#csrにled制御用レジスタを実装する" aria-label="Permalink to “CSRにLED制御用レジスタを実装する”">​</a></h3><p>RISC-VのCSRのアドレス空間には、読み込みと書き込みができるCSRを自由に定義できる場所(<code>0x800</code>から<code>0x8FF</code>)が用意されています<sup class="footnote-ref"><a href="#fn2" id="fnref2">[2]</a></sup>。 これの先頭アドレス<code>0x800</code>をLEDの制御用レジスタのアドレスとして実装を進めます。</p><p>まず、<code>CsrAddr</code>型にLED制御用レジスタのアドレスを追加します(リスト1)。</p><p><span class="caption">▼リスト8.1: LEDの制御用レジスタのアドレスを追加する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/f3cfc228fc0ec0a6b96c4da85a9f8be7bfdb3b17~1..f3cfc228fc0ec0a6b96c4da85a9f8be7bfdb3b17#diff-11470b1e7d69c89ea3723d114583fe520f6d8482422a151ad706be8ab57ea6b7">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">enum</span> CsrAddr: <span class="hljs-keyword">logic</span>&lt;<span class="hljs-number">12</span>&gt; {
...
</code></pre></div><p><img src="`+u+'" alt="コマンドを実行する"></p><p class="caption">▲図12: コマンドを実行する</p> ソースファイルを追加できました(図13)。 <p><img src="'+g+'" alt="ソースファイルの追加に成功した"></p><p class="caption">▲図13: ソースファイルの追加に成功した</p><h3 id="制約ファイルを作成する" tabindex="-1">制約ファイルを作成する <a class="header-anchor" href="#制約ファイルを作成する" aria-label="Permalink to “制約ファイルを作成する”">​</a></h3><h4 id="物理制約" tabindex="-1">物理制約 <a class="header-anchor" href="#物理制約" aria-label="Permalink to “物理制約”">​</a></h4><p>top_tangモジュールのclk、rst、ledポートを、 それぞれTang Nano 9Kの水晶発振器、ボタン、LEDに接続します。 接続の設定には物理制約ファイルを作成します。</p><p>新しくファイルを作成するので、プロジェクトを左クリックしてNew Fileを選択します(図14)。</p><p><img src="'+y+'" alt="New Fileを選択する"></p><p class="caption">▲図14: New Fileを選択する</p> 物理制約ファイルを選択します(図15)。 <p><img src="'+E+'" alt="物理制約ファイルを選択する"></p><p class="caption">▲図15: 物理制約ファイルを選択する</p> 名前は`tangnano9k.cst`にします(図16)。 <p><img src="'+j+`" alt="名前を設定する"></p><p class="caption">▲図16: 名前を設定する</p> 物理制約ファイルには、次のように記述します(リスト18)。 <p><span class="caption">▼リスト8.18: 物理制約ファイル (tangnano9k.cst)</span> <a href="https://github.com/nananapo/bluecore/compare/770939ec6d9bbe8675823c49e22e20eb1c4c5db5~1..770939ec6d9bbe8675823c49e22e20eb1c4c5db5#diff-c70d3c5fe63fe640ec329df49b4aa07be8d2b8d1a7fa428f623ccfa45af29764">差分をみる</a></p><div class="language-cst"><button title="Copy Code" class="copy"></button><span class="lang">cst</span><pre class="hljs"><code>// Clock and Reset
IO_LOC &quot;clk&quot; 52;
...
</code></pre></div><p><code>IO_LOC</code>で接続する場所の名前を指定します。</p><p>場所の名前はTang Nano 9Kのデータシートで確認できます。 例えば図17と図18から、 LEDは<code>10</code>、<code>11</code>、<code>13</code>、<code>14</code>、<code>15</code>、<code>16</code>に割り当てられていることが分かります。 また、LEDが負論理(<code>1</code>で消灯、<code>0</code>で点灯)であることが分かります。 水晶発信器とボタンについても、データシートを見て確認してください。</p><p><img src="`+k+'" alt="LED"></p><p class="caption">▲図17: LED</p> ![PIN10_IOL～の接続先](./images/05b-synth/tangnano9k_datasheet_ledpos.png) <p class="caption">▲図18: PIN10_IOL～の接続先</p><h4 id="タイミング制約" tabindex="-1">タイミング制約 <a class="header-anchor" href="#タイミング制約" aria-label="Permalink to “タイミング制約”">​</a></h4><p>FPGAが何MHzで動くかをタイミング制約ファイルに記述します。</p><p>物理制約ファイルと同じようにAdd Fileを選択して、 タイミング制約ファイルを作成します(図19)。</p><p><img src="'+P+'" alt="タイミング制約ファイルを選択する"></p><p class="caption">▲図19: タイミング制約ファイルを選択する</p> 名前は`timing.sdc`にします(図20)。 <p><img src="'+L+`" alt="名前を設定する"></p><p class="caption">▲図20: 名前を設定する</p> タイミング制約ファイルには、次のように記述します(リスト19)。 <p><span class="caption">▼リスト8.19: タイミング制約ファイル (timing.sdc)</span> <a href="https://github.com/nananapo/bluecore/compare/770939ec6d9bbe8675823c49e22e20eb1c4c5db5~1..770939ec6d9bbe8675823c49e22e20eb1c4c5db5#diff-3e6d45fecec520db4054200018c09a23e1ddc0f244d284912592561fddd47210">差分をみる</a></p><div class="language-sdc"><button title="Copy Code" class="copy"></button><span class="lang">sdc</span><pre class="hljs"><code>create_clock -name clk -period 37.037 -waveform {0 18.518} [get_ports {clk}]
...
</code></pre></div><p>ProcessタブのSynthesizeをクリックし、合成します(図21)。</p><p><img src="`+C+'" alt="Processタブ"></p><p class="caption">▲図21: Processタブ</p> そうすると、合成に失敗して図22のようなエラーが表示されます。 <p><img src="'+D+'" alt="合成するとエラーが発生する"></p><p class="caption">▲図22: 合成するとエラーが発生する</p> これは、Tang Nano 9Kに搭載されているメモリ用の部品の数が足りないために発生しているエラーです。 この問題を回避するために、eeiパッケージの`MEM_ADDR_WIDTH`の値を`10`に変更します[^23]。 メモリの幅を変更したら、Verylファイルをビルドしなおして、もう一度合成します。 <p><img src="'+w+'" alt="合成と配置配線に成功した"></p><p class="caption">▲図23: 合成と配置配線に成功した</p> 合成に成功したら、`Place &amp; Route`を押して、論理回路の配置配線情報を生成します(図23)。 それが終了したら、Tang Nano 9KをPCに接続して、Gowin Programmerを開いて設計をFPGAに書き込みます(図24)。 <p><img src="'+v+'" alt="Program / Configureボタンを押して書き込む"></p><p class="caption">▲図24: Program / Configureボタンを押して書き込む</p> Tang Nano 9Kの中央2つ以外のLEDが点灯していることを確認できます。 図5の左下のボタンを押すと全てのLEDが点灯します。 <p><img src="'+A+`" alt="LEDの制御用レジスタの値が12()なので中央2つのLEDが点灯せず、それ以外が点灯する"></p><p class="caption">▲図25: LEDの制御用レジスタの値が12(\`64&#39;b1100\`)なので中央2つのLEDが点灯せず、それ以外が点灯する</p><h4 id="ledの点滅を確認する" tabindex="-1">LEDの点滅を確認する <a class="header-anchor" href="#ledの点滅を確認する" aria-label="Permalink to “LEDの点滅を確認する”">​</a></h4><p><code>MEMORY_FILEPATH</code>パラメータの値を<code>test/led_counter.hex</code>のパスに設定します(リスト21)。</p><p><span class="caption">▼リスト8.21: 読み込むファイルを変更する (top_tang.sv)</span></p><div class="language-hex"><button title="Copy Code" class="copy"></button><span class="lang">hex</span><pre class="hljs"><code>core_top #(
    .MEMORY_FILEPATH_IS_ENV (0 ),
    .MEMORY_FILEPATH        (&quot;test/led_counter.hexへのパス&quot;)
) t (
</code></pre></div><p>合成、配置配線しなおして、設計をFPGAに書き込むとLEDが点滅します<sup class="footnote-ref"><a href="#fn3" id="fnref3">[3]</a></sup>。 図5の左下のボタンを押すと状態がリセットされます。</p>`,125),a("iframe",{width:"100%","max-width":"640",style:{"aspect-ratio":"16 / 9"},src:"https://www.youtube.com/embed/OpXiXha-ZnI",title:"tangnano9k test ledcounter",frameborder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",referrerpolicy:"strict-origin-when-cross-origin",allowfullscreen:""},null,-1),e('<h2 id="fpgaへの合成2-pynq-z1" tabindex="-1">FPGAへの合成② (PYNQ-Z1) <a class="header-anchor" href="#fpgaへの合成2-pynq-z1" aria-label="Permalink to “FPGAへの合成② (PYNQ-Z1)”">​</a></h2><p>PYNQ-Z1をターゲットにCPUを合成します。 使用するEDAのバージョンは次の通りです。</p><ul><li>Vivado v2023.2</li></ul><p>初めてPYNQ-Z1を使う人は、<a href="https://www.pynq.io/boards.html" target="_blank" rel="noreferrer">PYNQのドキュメント</a>やACRiの記事を参考に起動方法を確認して、Vivadoにボードファイルを追加してください。</p><h3 id="合成用のモジュールを作成する-1" tabindex="-1">合成用のモジュールを作成する <a class="header-anchor" href="#合成用のモジュールを作成する-1" aria-label="Permalink to “合成用のモジュールを作成する”">​</a></h3><p><img src="'+T+`" alt="PYNQ-Z1のLED(6個)"></p><p class="caption">▲図26: PYNQ-Z1のLED(6個)</p> PYNQ-Z1にはLEDが6個実装されています(図26)。 本章ではボタンの上の横並びの4つのLED(図26右下)を使用します。 <p><a href="./05b-synth.html">「8.3.1 合成用のモジュールを作成する」</a>とおなじように、 <code>led</code>ポートのビット幅を一致させるためにPYNQ-Z1の合成のためのトップモジュールを作成します。</p><p><code>src/top_pynq_z1.veryl</code>を作成し、次のように記述します(リスト22)。 top_pynq_z1モジュールの<code>led</code>ポートは4ビットとして定義して、topモジュールの<code>led</code>ポートの下位4ビットを接続しています。</p><p><span class="caption">▼リスト8.22: PYNQ-Z1用の最上位モジュール (top_pynq_z1.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/70d12437720f90babf2a2228c8fe6b9eae6de17f~1..70d12437720f90babf2a2228c8fe6b9eae6de17f#diff-257ab0e195148813de1fa11a8132d7651c48ef788d6c85108bcd5ca3c44dce04">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">import</span> eei::*;
...
</code></pre></div><h3 id="プロジェクトを作成する-1" tabindex="-1">プロジェクトを作成する <a class="header-anchor" href="#プロジェクトを作成する-1" aria-label="Permalink to “プロジェクトを作成する”">​</a></h3><p>Vivadoを開いて、プロジェクトを作成します。 Quick StartのCreate Projectを押すと、図27が出るのでNextを押します。</p><p><img src="`+x+'" alt="Nextを押す"></p><p class="caption">▲図27: Nextを押す</p> プロジェクト名とフォルダを入力します(図28)。 好きな名前と場所を入力したらNextを押します。 <p><img src="'+I+'" alt="プロジェクト名とフォルダを入力する"></p><p class="caption">▲図28: プロジェクト名とフォルダを入力する</p> プロジェクトの形式を設定します(図29)。 RTL Projectを選択して、`Do not specify sources at this time`にチェックを入れてNextを押します。 <p><img src="'+M+'" alt="プロジェクトの形式を選択する"></p><p class="caption">▲図29: プロジェクトの形式を選択する</p> ターゲットのFPGAボードを選択します(図30)。 今回はPYNQ-Z1がターゲットなので、Boardsタブに移動してPYNQ-Z1を選択します。 PYNQ-Z1が表示されない場合、ボードファイルをVivadoに追加してください。 <p><img src="'+N+'" alt="PYNQ-Z1を選択する"></p><p class="caption">▲図30: PYNQ-Z1を選択する</p> 概要を確認して、Nextを押します(図31)。 <p><img src="'+O+'" alt="Nextを押す"></p><p class="caption">▲図31: Nextを押す</p> プロジェクトが作成されました(図32)。 <p><img src="'+R+`" alt="プロジェクトの画面"></p><p class="caption">▲図32: プロジェクトの画面</p><h3 id="設計ファイルを追加する-1" tabindex="-1">設計ファイルを追加する <a class="header-anchor" href="#設計ファイルを追加する-1" aria-label="Permalink to “設計ファイルを追加する”">​</a></h3><p>Verylのソースファイルをビルドして、 生成されるファイルリスト(<code>core.f</code>)を利用して、 生成されたSystemVerilogソースファイルをプロジェクトに追加します。</p><p>Vivadoでファイルを追加するには、 ウィンドウ下部のTcl Console画面で<code>add_file</code>を実行します。 しかし、<code>add_file</code>はファイルリストの読み込みに対応していないので、 ファイルリストを読み込んで<code>add_file</code>を実行するスクリプトを作成します(リスト23)。</p><p><span class="caption">▼リスト8.23: add_files.tcl</span> <a href="https://github.com/nananapo/bluecore/compare/70d12437720f90babf2a2228c8fe6b9eae6de17f~1..70d12437720f90babf2a2228c8fe6b9eae6de17f#diff-6d6caefddfb7ea011537f7f850f1944fb9b76ed30bf128fe381ffae2ce91009c">差分をみる</a></p><div class="language-tcl"><button title="Copy Code" class="copy"></button><span class="lang">tcl</span><pre class="hljs"><code><span class="hljs-keyword">set</span> file_list [<span class="hljs-keyword">open</span> <span class="hljs-string">&quot;ファイルリストのパス&quot;</span> r]
<span class="hljs-keyword">while</span> {[<span class="hljs-keyword">gets</span> <span class="hljs-variable">$file_list</span> line] != <span class="hljs-number">-1</span>} {
<span class="hljs-comment">    # skip blank or comment line</span>
    <span class="hljs-keyword">if</span> {[<span class="hljs-keyword">string</span> trim <span class="hljs-variable">$line</span>] eq <span class="hljs-string">&quot;&quot;</span> || [<span class="hljs-keyword">string</span> index <span class="hljs-variable">$line</span> <span class="hljs-number">0</span>] eq <span class="hljs-string">&quot;#&quot;</span>} {
        <span class="hljs-keyword">continue</span>
...
</code></pre></div><h3 id="ブロック図を作成する" tabindex="-1">ブロック図を作成する <a class="header-anchor" href="#ブロック図を作成する" aria-label="Permalink to “ブロック図を作成する”">​</a></h3><p>Vivadoではモジュール間の接続をブロック図によって行えます。 設計したモジュールをブロック図に追加して、クロックやリセット、LEDの接続を行います。</p><h4 id="ブロック図の作成とトップモジュールの設定" tabindex="-1">ブロック図の作成とトップモジュールの設定 <a class="header-anchor" href="#ブロック図の作成とトップモジュールの設定" aria-label="Permalink to “ブロック図の作成とトップモジュールの設定”">​</a></h4><p>画面左のFlow Navigatorで<code>Create Block Design</code>を押してブロック図を作成します(図35)。</p><p><img src="`+V+'" alt="IP INTEGRATOR  Create Block Design"></p><p class="caption">▲図35: IP INTEGRATOR &gt; Create Block Design</p> 名前は適当なものに設定します(図36)。 <p><img src="'+F+'" alt="名前を入力する"></p><p class="caption">▲図36: 名前を入力する</p> Sourcesタブに作成されたブロック図が追加されるので、右クリックして`Create HDL Wrapper...`を押します(図37)。 <p><img src="'+Y+'" alt="Create HDL Wrapper...を押す"></p><p class="caption">▲図37: Create HDL Wrapper...を押す</p> そのままOKを押します(図38)。 <p><img src="'+U+'" alt="OKを押す"></p><p class="caption">▲図38: OKを押す</p> ブロック図がVerilogモジュールになるので、 `Set as Top`を押して、これをトップモジュールにします(図39)。 <p><img src="'+G+'" alt="Set as Topを押す"></p><p class="caption">▲図39: Set as Topを押す</p> ブロック図がトップモジュールに設定されました(図40)。 <p><img src="'+H+'" alt="ブロック図がトップモジュールに設定された"></p><p class="caption">▲図40: ブロック図がトップモジュールに設定された</p><h4 id="ブロック図の設計" tabindex="-1">ブロック図の設計 <a class="header-anchor" href="#ブロック図の設計" aria-label="Permalink to “ブロック図の設計”">​</a></h4><p>Diagram画面でブロック図を組み立てます。</p><p>まず、core_top_vモジュールを追加します。 適当な場所で右クリックして、<code>Add Module...</code>を押します(図41)。</p><p><img src="'+K+'" alt="Add Module...を押す"></p><p class="caption">▲図41: Add Module...を押す</p> core_top_vを選択して、OKを押します(図42)。 <p><img src="'+W+'" alt="core_top_vを選択する"></p><p class="caption">▲図42: core_top_vを選択する</p> core_top_vが追加されるので、 ledポートをクリックして`Make External`を押します(`xilinx/bd/8`)。 <p><img src="'+Q+'" alt="Make Externalを押す"></p><p class="caption">▲図43: Make Externalを押す</p> led_0ポートが追加されました(図44)。 これがブロック図のoutputポートになります。 <p><img src="'+Z+'" alt="led_0ポートが追加された"></p><p class="caption">▲図44: led_0ポートが追加された</p> led_0を選択して、左側のExternal Port PropertiesのNameをledに変更します。 <p><img src="'+X+'" alt="名前をledに変更した"></p><p class="caption">▲図45: 名前をledに変更した</p> 次に、+ボタンを押して ZYNQ7 Processing System、 Processor System Reset、 Clocking Wizardを追加します(図46、図47)。 <p><img src="'+z+'" alt="+ボタンを押す"></p><p class="caption">▲図46: +ボタンを押す</p> ![3つIPを追加する](./images/05b-synth/xilinx/bd/12.png) <p class="caption">▲図47: 3つIPを追加する</p> 上に`Designer Assistance Available`と出るので、`Run Block Automation`を押します(図48)。 <p><img src="'+B+'" alt="Run Block Automationを押す"></p><p class="caption">▲図48: Run Block Automationを押す</p> 図49のようになっていることを確認して、OKを押します。 <p><img src="'+$+'" alt="DDRとFIXED_IOが追加された"></p><p class="caption">▲図49: DDRとFIXED_IOが追加された</p> 図50のようにポートを接続します。 接続元から接続先にドラッグすることでポートを接続できます。 また、proc_sys_reset_0のext_reset_inをMake Externalしてrstを作成してください。 <p><img src="'+J+'" alt="ポートを接続する"></p><p class="caption">▲図50: ポートを接続する</p> ZYNQ7 Processing Systemのoutputポートには、100MHzのクロック信号`FCLK_CLK0`が定義されています。 これをそのままcore_top_vに供給しても良いですが、 現状のコードではcore_top_vが100MHzで動くように合成できません。 そのため、Clocking Wizardで50MHzに変換したクロックをcore_top_vに供給します。 <p>clk_wiz_0をダブルクリックして、入力を50MHzに変換するように設定します。 clk_out1のRequestedを50に変更してください。 また、Enable Optional ～のresetとlockedのチェックを外します(図51)。</p><p><img src="'+aa+'" alt="Clocking Wizardの設定を変更する"></p><p class="caption">▲図51: Clocking Wizardの設定を変更する</p> clk_wiz_0が少しコンパクトになりました(図52)。 <p><img src="'+sa+`" alt="Clocking Wizardが変更された"></p><p class="caption">▲図52: Clocking Wizardが変更された</p><h3 id="制約ファイルを作成する-1" tabindex="-1">制約ファイルを作成する <a class="header-anchor" href="#制約ファイルを作成する-1" aria-label="Permalink to “制約ファイルを作成する”">​</a></h3><p>ブロック図のrst、ledを、それぞれPYNQ-Z1のボタン(BTN0)、LED(LD0、LD1、LD2、LD3)に接続します。 接続の設定には物理制約ファイルを作成します。</p><p><code>pynq.xdc</code>を作成し、次のように記述します(リスト27)。</p><p><span class="caption">▼リスト8.27: 物理制約ファイル (pynq.xdc)</span> <a href="https://github.com/nananapo/bluecore/compare/70d12437720f90babf2a2228c8fe6b9eae6de17f~1..70d12437720f90babf2a2228c8fe6b9eae6de17f#diff-cf2026c8356c3bc2eb4a5665159c95b3c4e47821527e57564cdc376b43fdf4df">差分をみる</a></p><div class="language-xdc"><button title="Copy Code" class="copy"></button><span class="lang">xdc</span><pre class="hljs"><code># reset (BTN0)
...
</code></pre></div><p>リスト27では、 rstにD19を割り当てて、 led[0]、led[1]、led[2]、led[3]にR14、P14、N16、M14を割り当てます(図53)。 ボタンは押されていないときに<code>1</code>、押されているときに<code>0</code>になります。 LEDは<code>1</code>のときに点灯して、<code>0</code>のときに消灯します。</p><p><img src="`+ea+'" alt="LEDとボタン"></p><p class="caption">▲図53: LEDとボタン</p><h3 id="テスト-1" tabindex="-1">テスト <a class="header-anchor" href="#テスト-1" aria-label="Permalink to “テスト”">​</a></h3><h4 id="ledの点灯を確認する-1" tabindex="-1">LEDの点灯を確認する <a class="header-anchor" href="#ledの点灯を確認する-1" aria-label="Permalink to “LEDの点灯を確認する”">​</a></h4><p>ブロック図のcore_top_v_0をダブルクリックすることで、 core_top_vモジュールの<code>MEMORY_FILEPATH</code>パラメータを変更します。 パラメータにはテストのHEXファイルのパスを設定します(図54)。 LEDの点灯のテストのために<code>test/led.hex</code>のパスを入力します。</p><p><img src="'+ca+'" alt="テストのHEXファイルのパスを設定する"></p><p class="caption">▲図54: テストのHEXファイルのパスを設定する</p> PROGRAM AND DEBUGの`Generate Bitstream`を押して合成と配置配線を実行します(図55)。 <p><img src="'+na+'" alt="合成、配置配線"></p><p class="caption">▲図55: 合成、配置配線</p> 合成が完了したら`Open Hardware Manager`を押して、 開かれたHARDWARE MANAGERの`Open Target`の`Auto Connect`を押してPYNQ-Z1と接続します(図56)。 <p><img src="'+pa+'" alt="PYNQ-Z1を接続する"></p><p class="caption">▲図56: PYNQ-Z1を接続する</p> `Program device`を押すと、PYNQ-Z1に設計が書き込まれます。 <p><img src="'+la+'" alt="設計を書き込む"></p><p class="caption">▲図57: 設計を書き込む</p> LEDが点灯しているのを確認できます(図58)。 BTN0を押すとLEDが消灯します。 <p><img src="'+oa+'" alt="LEDの制御用レジスタの値が12()なので、LD3、LD2が点灯する"></p><p class="caption">▲図58: LEDの制御用レジスタの値が12(`64&#39;b1100`)なので、LD3、LD2が点灯する</p><h4 id="ledの点滅を確認する-1" tabindex="-1">LEDの点滅を確認する <a class="header-anchor" href="#ledの点滅を確認する-1" aria-label="Permalink to “LEDの点滅を確認する”">​</a></h4><p>core_top_vモジュールの<code>MEMORY_FILEPATH</code>パラメータの値を<code>test/ledcounter.hex</code>のパスに変更して、 再度<code>Generate Bitstream</code>を実行します。</p><p>Hardware Managerを開いてProgram deviceを押すとLEDが点滅します<sup class="footnote-ref"><a href="#fn4" id="fnref4">[4]</a></sup>。 BTN0を押すと状態がリセットされます。</p>',138),a("iframe",{width:"100%","max-width":"640",style:{"aspect-ratio":"16 / 9"},src:"https://www.youtube.com/embed/byCr_464dW4",title:"",frameborder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",referrerpolicy:"strict-origin-when-cross-origin",allowfullscreen:""},null,-1),e('<hr class="footnotes-sep"><section class="footnotes"><ol class="footnotes-list"><li id="fn1" class="footnote-item"><p>例えばメモリは同じパターンの論理回路の繰り返しで大きな面積を要します。メモリはよく利用される回路であるため、専用の回路を用意した方が空間的な効率が改善される上に、遅延が少なくなるという利点があります <a href="#fnref1" class="footnote-backref">↩︎</a></p></li><li id="fn2" class="footnote-item"><p>The RISC-V Instruction Set Manual Volume II: Privileged Architecture version 20240411 Table 3. Allocation of RISC-V CSR address ranges. <a href="#fnref2" class="footnote-backref">↩︎</a></p></li><li id="fn3" class="footnote-item"><p><a href="https://youtu.be/OpXiXha-ZnI" target="_blank" rel="noreferrer">https://youtu.be/OpXiXha-ZnI</a> <a href="#fnref3" class="footnote-backref">↩︎</a></p></li><li id="fn4" class="footnote-item"><p><a href="https://youtu.be/byCr_464dW4" target="_blank" rel="noreferrer">https://youtu.be/byCr_464dW4</a> <a href="#fnref4" class="footnote-backref">↩︎</a></p></li></ol></section>',2)])])}const ua=n(ta,[["render",da]]);export{ma as __pageData,ua as default};
