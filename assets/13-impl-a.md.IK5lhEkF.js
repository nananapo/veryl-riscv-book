...
</code></pre></div><h3 id="is-amoフラグを実装する" tabindex="-1">is_amoフラグを実装する <a class="header-anchor" href="#is-amoフラグを実装する" aria-label="Permalink to “is_amoフラグを実装する”">​</a></h3><p><code>InstCtrl</code>構造体に、 A拡張の命令であることを示す<code>is_amo</code>フラグを追加します (リスト4)。</p><p><span class="caption">▼リスト12.4: InstCtrlにis_amoを定義する (corectrl.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/481a33940df2d9c90ba5134b81637b2208012ac6~1..481a33940df2d9c90ba5134b81637b2208012ac6#diff-6e03bfb8e3afdba1e0b88b561d8b8e5e4f2a7ffc6c4efb228c5797053b78742c">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">struct</span> InstCtrl {
...
</code></pre></div><p>命令がメモリにアクセスするかを判定するinst_is_memop関数を、<code>is_amo</code>フラグを利用するように変更します (リスト5)。</p><p><span class="caption">▼リスト12.5: A拡張の命令がメモリにアクセスする命令と判定する (corectrl.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/481a33940df2d9c90ba5134b81637b2208012ac6~1..481a33940df2d9c90ba5134b81637b2208012ac6#diff-6e03bfb8e3afdba1e0b88b561d8b8e5e4f2a7ffc6c4efb228c5797053b78742c">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> inst_is_memop (
...
</code></pre></div><p>inst_decoderモジュールの<code>InstCtrl</code>を生成している部分を変更します。 opcodeが<code>OP-AMO</code>のとき、<code>is_amo</code>を<code>T</code>に設定します (リスト6)。 その他のopcodeの<code>is_amo</code>は<code>F</code>に設定してください。</p><p><span class="caption">▼リスト12.6: is_amoフラグを追加する (inst_decoder.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/481a33940df2d9c90ba5134b81637b2208012ac6~1..481a33940df2d9c90ba5134b81637b2208012ac6#diff-0520643107a80d7dcd5de7ffc77443b16b7089aa9e14564e8201c524e6d0eec8">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>OP_SYSTEM: {
...
</code></pre></div><p>また、A拡張の命令が有効な命令として判断されるようにします (リスト7)。</p><p><span class="caption">▼リスト12.7: A拡張の命令のとき、validフラグを立てる (inst_decoder.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/481a33940df2d9c90ba5134b81637b2208012ac6~1..481a33940df2d9c90ba5134b81637b2208012ac6#diff-0520643107a80d7dcd5de7ffc77443b16b7089aa9e14564e8201c524e6d0eec8">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>OP_MISC_MEM: T, <span class="hljs-comment">// FENCE</span>
...
</code></pre></div><p>A拡張の命令のメモリアドレスが、 操作するデータの幅に整列されていないとき、 Store/AMO address misaligned例外が発生します。 この例外はストア命令の場合の例外と同じです。</p><p>EXステージの例外判定でアドレスを使っている部分を変更します (リスト9)。 causeとtvalの割り当てがストア命令の場合と同じになっていることを確認してください。</p><p><span class="caption">▼リスト12.9: 例外を判定するアドレスを変更する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/481a33940df2d9c90ba5134b81637b2208012ac6~1..481a33940df2d9c90ba5134b81637b2208012ac6#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="custom-hl-bold"><span class="hljs-keyword">let</span> memaddr                       : Addr  = <span class="hljs-keyword">if</span> exs_ctrl.is_amo ? exs_rs1_data : exs_alu_result;</span>
<span class="hljs-keyword">let</span> loadstore_address_misaligned  : <span class="hljs-keyword">logic</span> = inst_is_memop(exs_ctrl) &amp;&amp; <span class="hljs-keyword">case</span> exs_ctrl.funct3[<span class="hljs-number">1</span>:<span class="hljs-number">0</span>] {
    <span class="hljs-number">2&#39;b00</span>  : <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// B</span>
    ...
    <span class="hljs-keyword">default</span>: <span class="hljs-number">1&#39;b0</span>,
};
</code></pre></div><h3 id="ライトバックする条件を変更する" tabindex="-1">ライトバックする条件を変更する <a class="header-anchor" href="#ライトバックする条件を変更する" aria-label="Permalink to “ライトバックする条件を変更する”">​</a></h3><p>A拡張の命令を実行するとき、 ロードした値をレジスタにライトバックするように変更します (リスト10)。</p><p><span class="caption">▼リスト12.10: メモリからロードした値をライトバックする (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/481a33940df2d9c90ba5134b81637b2208012ac6~1..481a33940df2d9c90ba5134b81637b2208012ac6#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> wbs_wb_data: UIntX    = <span class="hljs-keyword">switch</span> {
...
</code></pre></div><p><span class="caption">▼リスト12.14: core_data_ifインターフェースのインスタンス化 (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/8929d932a39a198be8c0e9021c3031cacc2e4480~1..8929d932a39a198be8c0e9021c3031cacc2e4480#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> d_membus_core: core_data_if;
</code></pre></div><p><span class="caption">▼リスト12.15: ポートに割り当てるインターフェースを変更する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/8929d932a39a198be8c0e9021c3031cacc2e4480~1..8929d932a39a198be8c0e9021c3031cacc2e4480#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> c: core (
    clk                    ,
    rst                    ,
    i_membus               ,
...
</code></pre></div><p>memunitモジュールのインターフェースも変更し、 <code>is_amo</code>、<code>aq</code>、<code>rl</code>、<code>amoop</code>に値を割り当てます (リスト16、 リスト17、 リスト19、 リスト18、 リスト20)。</p><p><span class="caption">▼リスト12.16: membusの型を変更する (memunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/8929d932a39a198be8c0e9021c3031cacc2e4480~1..8929d932a39a198be8c0e9021c3031cacc2e4480#diff-d3618e86de098826661fabd111bec51452d943d3e486d18f9c3aa96b2dd9a89e">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>    stall : <span class="hljs-keyword">output</span>  <span class="hljs-keyword">logic</span>               , <span class="hljs-comment">// メモリアクセス命令が完了していない</span>
...
</code></pre></div><p><span class="caption">▼リスト12.17: 一時保存するレジスタの定義 (memunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/8929d932a39a198be8c0e9021c3031cacc2e4480~1..8929d932a39a198be8c0e9021c3031cacc2e4480#diff-d3618e86de098826661fabd111bec51452d943d3e486d18f9c3aa96b2dd9a89e">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> req_wen   : <span class="hljs-keyword">logic</span>                       ;
...
</code></pre></div><p><span class="caption">▼リスト12.18: レジスタをリセットする (memunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/8929d932a39a198be8c0e9021c3031cacc2e4480~1..8929d932a39a198be8c0e9021c3031cacc2e4480#diff-d3618e86de098826661fabd111bec51452d943d3e486d18f9c3aa96b2dd9a89e">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
        state      = State::Init;
...
</code></pre></div><p><span class="caption">▼リスト12.19: membusにレジスタの値を割り当てる (memunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/8929d932a39a198be8c0e9021c3031cacc2e4480~1..8929d932a39a198be8c0e9021c3031cacc2e4480#diff-d3618e86de098826661fabd111bec51452d943d3e486d18f9c3aa96b2dd9a89e">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
...
</code></pre></div><p><span class="caption">▼リスト12.20: メモリにアクセスする命令のとき、レジスタに情報を設定する (memunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/8929d932a39a198be8c0e9021c3031cacc2e4480~1..8929d932a39a198be8c0e9021c3031cacc2e4480#diff-d3618e86de098826661fabd111bec51452d943d3e486d18f9c3aa96b2dd9a89e">差分をみる</a></p>`,91),a("div",{class:"language-veryl"},[a("button",{title:"Copy Code",class:"copy"}),a("span",{class:"lang"},"veryl"),a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-keyword"},"case"),s(` state {
...
`)])])],-1),n(`<p>amounitモジュールをtopモジュールでインスタンス化し、 coreモジュールとmmio_controllerモジュールのインターフェースを接続します (リスト21)。</p><p><span class="caption">▼リスト12.21: amounitモジュールをインスタンス化する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/8929d932a39a198be8c0e9021c3031cacc2e4480~1..8929d932a39a198be8c0e9021c3031cacc2e4480#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> amou: amounit (
    clk                  ,
    rst                  ,
    slave : d_membus_core,
    master: d_membus     ,
);
</code></pre></div><h2 id="zalrsc拡張の実装" tabindex="-1">Zalrsc拡張の実装 <a class="header-anchor" href="#zalrsc拡張の実装" aria-label="Permalink to “Zalrsc拡張の実装”">​</a></h2><p>Zalrsc拡張の命令を実装します。 予約セットのサイズは実装が自由に決めることができるため、 本書では1つのアドレスのみ保持できるようにします。</p><h3 id="lr-w、lr-d命令を実装する" tabindex="-1">LR.W、LR.D命令を実装する <a class="header-anchor" href="#lr-w、lr-d命令を実装する" aria-label="Permalink to “LR.W、LR.D命令を実装する”">​</a></h3><p>32ビット幅、64ビット幅のLR命令を実装します。 LR.W命令はmemunitモジュールで64ビットに符号拡張されるため、 amounitモジュールでLR.W命令とLR.D命令を区別する必要はありません。</p><p>amounitモジュールに予約セットを作成します (リスト22、 リスト23)。 <code>is_addr_reserved</code>で、予約セットに有効なアドレスが格納されているかを管理します。</p><p><span class="caption">▼リスト12.22: 予約セットの定義 (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/509f35fde865cb52b3bfa049ebd60daef7f9032c~1..509f35fde865cb52b3bfa049ebd60daef7f9032c#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// lr/sc</span>
...
</code></pre></div><p><span class="caption">▼リスト12.23: レジスタをリセットする (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/509f35fde865cb52b3bfa049ebd60daef7f9032c~1..509f35fde865cb52b3bfa049ebd60daef7f9032c#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>is_addr_reserved   = <span class="hljs-number">0</span>;
reserved_addr      = <span class="hljs-number">0</span>;
</code></pre></div><p>LR命令を実行するとき、予約セットにアドレスを登録してロード結果を返すようにします (リスト24、 リスト25、 リスト26)。 既に予約セットが使われている場合はアドレスを上書きします。</p><p><span class="caption">▼リスト12.24: accept_request_comb関数の実装 (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/509f35fde865cb52b3bfa049ebd60daef7f9032c~1..509f35fde865cb52b3bfa049ebd60daef7f9032c#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> accept_request_comb () {
    <span class="hljs-keyword">if</span> slave.ready &amp;&amp; slave.valid {
...
</code></pre></div><p><span class="caption">▼リスト12.25: LR命令のときにmasterにロード要求を割り当てる (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/509f35fde865cb52b3bfa049ebd60daef7f9032c~1..509f35fde865cb52b3bfa049ebd60daef7f9032c#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    reset_master();
    <span class="hljs-keyword">case</span> state {
        State::Init     : accept_request_comb();
        ...
        <span class="custom-hl-bold">} <span class="hljs-keyword">else</span> {</span>
            assign_master(slave_saved.addr, slave_saved.wen, slave_saved.wdata, slave_saved.wmask);
        <span class="custom-hl-bold">}</span>
</code></pre></div><p><span class="caption">▼リスト12.26: LR命令のときに予約セットを設定する (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/509f35fde865cb52b3bfa049ebd60daef7f9032c~1..509f35fde865cb52b3bfa049ebd60daef7f9032c#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p>`,18),a("div",{class:"language-veryl"},[a("button",{title:"Copy Code",class:"copy"}),a("span",{class:"lang"},"veryl"),a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-keyword"},"function"),s(` accept_request_ff () {
    slave_saved.valid = slave.ready && slave.valid;
...
</code></pre></div><p>それぞれの状態で結果を返し、新しく要求を受け入れるようにします (リスト28)。 <code>State::SCSuccess</code>はSC命令に成功してストアが終わったときに結果を返します。 成功したら<code>0</code>、失敗したら<code>1</code>を返します。</p><p><span class="caption">▼リスト12.28: slaveにSC命令の結果を割り当てる (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7d9dc72658a79455e8240c1cf335c3f2a1dd8de0~1..7d9dc72658a79455e8240c1cf335c3f2a1dd8de0#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>State::SCSuccess: {
    slave.ready  = master.rvalid;
    slave.rvalid = master.rvalid;
    slave.rdata  = <span class="hljs-number">0</span>;
}
...
</code></pre></div><p>SC命令を受け入れるときに予約セットを確認し、アドレスが予約セットのアドレスと異なる場合は状態を<code>State::SCFail</code>に移動します (リスト29)。 成功、失敗に関係なく、予約セットを空にします。</p><p><span class="caption">▼リスト12.29: accept_request_ff関数で予約セットを確認する (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7d9dc72658a79455e8240c1cf335c3f2a1dd8de0~1..7d9dc72658a79455e8240c1cf335c3f2a1dd8de0#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>AMOOp::SC: {
...
</code></pre></div><p>SC命令でメモリの<code>ready</code>が<code>1</code>になるのを待っているとき、 <code>ready</code>が<code>1</code>になったら状態を<code>State::SCSuccess</code>に移動します (リスト30)。 また、命令の実行が終了したときに新しく要求を受け入れるようにします。</p><p><span class="caption">▼リスト12.30: SC命令の状態遷移 (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7d9dc72658a79455e8240c1cf335c3f2a1dd8de0~1..7d9dc72658a79455e8240c1cf335c3f2a1dd8de0#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> on_clock () {
    <span class="hljs-keyword">case</span> state {
        State::Init     : accept_request_ff();
        State::WaitReady: <span class="hljs-keyword">if</span> master.ready {
...
</code></pre></div><p>SC命令によるメモリへの書き込みを実装します ( リスト31、 リスト32 )。</p><p><span class="caption">▼リスト12.31: accept_request_comb関数で、予約セットをチェックしてからストアを要求する (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7d9dc72658a79455e8240c1cf335c3f2a1dd8de0~1..7d9dc72658a79455e8240c1cf335c3f2a1dd8de0#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> slave.amoop {
...
</code></pre></div><p><span class="caption">▼リスト12.32: masterに値を割り当てる (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/7d9dc72658a79455e8240c1cf335c3f2a1dd8de0~1..7d9dc72658a79455e8240c1cf335c3f2a1dd8de0#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    reset_master();
    <span class="hljs-keyword">case</span> state {
        State::Init     : accept_request_comb();
...
</code></pre></div><h2 id="zaamo拡張の実装" tabindex="-1">Zaamo拡張の実装 <a class="header-anchor" href="#zaamo拡張の実装" aria-label="Permalink to “Zaamo拡張の実装”">​</a></h2><p>Zaamo拡張の命令はロード、演算、ストアを行います。 本章では、Zaamo拡張の命令を <code>State::Init</code> (、<code>State::AMOLoadReady</code>) 、<code>State::AMOLoadValid</code> (、<code>State::AMOStoreReady</code>) 、<code>State::AMOStoreValid</code> という状態遷移で処理するように実装します。</p><p><code>State</code>型に新しい状態を定義してください (リスト33)。</p><p><span class="caption">▼リスト12.33: Zaamo拡張の命令用の状態の定義 (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/bf16759bcbc8df3697d2a52a9942c784b9b95fb5~1..bf16759bcbc8df3697d2a52a9942c784b9b95fb5#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">enum</span> State {
    Init,
    WaitReady,
    WaitValid,
    SCSuccess,
...
</code></pre></div><p>簡単にZalrsc拡張と区別するために、 Zaamo拡張による要求かどうかを判定する関数(<code>is_Zaamo</code>)をcore_data_ifインターフェースに作成します ( リスト34、 リスト35 )。 modportにimport宣言を追加してください。</p><p><span class="caption">▼リスト12.34: is_Zaamo関数の定義 (core_data_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/bf16759bcbc8df3697d2a52a9942c784b9b95fb5~1..bf16759bcbc8df3697d2a52a9942c784b9b95fb5#diff-758b6cef60d94fd7ce6613325ed390f46f67a9270f329aae32db73abcbb60b1d">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> is_Zaamo () -&gt; <span class="hljs-keyword">logic</span> {
    <span class="hljs-keyword">return</span> is_amo &amp;&amp; (amoop != AMOOp::LR &amp;&amp; amoop != AMOOp::SC);
}
</code></pre></div><p><span class="caption">▼リスト12.35: masterにis_Zaamo関数をimportする (core_data_if.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/bf16759bcbc8df3697d2a52a9942c784b9b95fb5~1..bf16759bcbc8df3697d2a52a9942c784b9b95fb5#diff-758b6cef60d94fd7ce6613325ed390f46f67a9270f329aae32db73abcbb60b1d">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>    amoop   : <span class="hljs-keyword">output</span>,
    funct3  : <span class="hljs-keyword">output</span>,
    <span class="custom-hl-bold">is_Zaamo: <span class="hljs-keyword">import</span>,</span>
}
</code></pre></div><p>ロードした値と<code>wdata</code>、フラグを利用して、ストアする値を生成する関数を作成します (リスト36)。 32ビット演算のとき、下位32ビットと上位32ビットのどちらを使うかをアドレスによって判別しています。</p><p><span class="caption">▼リスト12.36: Zaamo拡張の命令の計算を行う関数の定義 (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/bf16759bcbc8df3697d2a52a9942c784b9b95fb5~1..bf16759bcbc8df3697d2a52a9942c784b9b95fb5#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// AMO ALU</span>
...
</code></pre></div><p>ロードした値が命令の結果になるため、 値を保持するためのレジスタを作成します ( リスト37、 リスト38 )。</p><p><span class="caption">▼リスト12.37: ロードしたデータを格納するレジスタの定義 (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/bf16759bcbc8df3697d2a52a9942c784b9b95fb5~1..bf16759bcbc8df3697d2a52a9942c784b9b95fb5#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// amo</span>
<span class="hljs-keyword">var</span> zaamo_fetched_data: UIntX;
</code></pre></div><p><span class="caption">▼リスト12.38: レジスタのリセット (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/bf16759bcbc8df3697d2a52a9942c784b9b95fb5~1..bf16759bcbc8df3697d2a52a9942c784b9b95fb5#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>    reserved_addr      = <span class="hljs-number">0</span>;
    <span class="custom-hl-bold">zaamo_fetched_data = <span class="hljs-number">0</span>;</span>
}
</code></pre></div><p>メモリアクセスが終了したら、ロードした値を返します (リスト39)。</p><p><span class="caption">▼リスト12.39: 命令の結果を返す (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/bf16759bcbc8df3697d2a52a9942c784b9b95fb5~1..bf16759bcbc8df3697d2a52a9942c784b9b95fb5#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>State::AMOStoreValid: {
    slave.ready  = master.rvalid;
    slave.rvalid = master.rvalid;
    slave.rdata  = zaamo_fetched_data;
}
</code></pre></div><p>状態に基づいて、メモリへのロード、ストア要求を割り当てます ( リスト40、 リスト41 )。</p><p><span class="caption">▼リスト12.40: accept_request_comb関数で、まずロード要求を行う (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/bf16759bcbc8df3697d2a52a9942c784b9b95fb5~1..bf16759bcbc8df3697d2a52a9942c784b9b95fb5#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">default</span>: <span class="custom-hl-bold"><span class="hljs-keyword">if</span> slave.is_Zaamo()</span> {
...
</code></pre></div><p><span class="caption">▼リスト12.41: 状態に基づいてロード、ストア要求を行う (amounit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/bf16759bcbc8df3697d2a52a9942c784b9b95fb5~1..bf16759bcbc8df3697d2a52a9942c784b9b95fb5#diff-5a1c75bb9b272891ae9766e2adfc01dce8800d1fd4faf16cb3310afc2c1e37f6">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>State::AMOLoadReady                      : assign_master      (slave_saved.addr, <span class="hljs-number">0</span>, <span class="hljs-number">0</span>, <span class="hljs-number">0</span>);
