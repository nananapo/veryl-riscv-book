...
</code></pre></div><p><span class="caption">▼リスト15.6: get_device関数でACLINTの範囲を定義する (mmio_controller.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> MMAP_ACLINT_BEGIN &lt;= addr &amp;&amp; addr &lt;= MMAP_ACLINT_END {
    <span class="hljs-keyword">return</span> Device::ACLINT;
}
</code></pre></div><p>ACLINTとのインターフェースを追加し、 reset_all_device_masters関数にインターフェースをリセットするコードを追加します ( リスト7、 リスト8 )。</p><p><span class="caption">▼リスト15.7: ポートにACLINTのインターフェースを追加する (mmio_controller.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> mmio_controller (
    clk          : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">clock</span>         ,
    rst          : <span class="hljs-keyword">input</span>   <span class="hljs-keyword">reset</span>         ,
...
</code></pre></div><p><span class="caption">▼リスト15.8: インターフェースの要求部分をリセットする (mmio_controller.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">function</span> reset_all_device_masters () {
...
</code></pre></div><p><code>ready</code>、<code>rvalid</code>を取得する関数にACLINTを登録します ( リスト9、 リスト10 )。</p><p><span class="caption">▼リスト15.9: get_device_ready関数にACLINTのreadyを追加 (mmio_controller.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: <span class="hljs-keyword">return</span> aclint_membus.ready;
</code></pre></div><p><span class="caption">▼リスト15.10: get_device_rvalid関数にACLINTのrvalidを追加 (mmio_controller.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: <span class="hljs-keyword">return</span> aclint_membus.rvalid;
</code></pre></div><p>ACLINTの<code>rvalid</code>、<code>rdata</code>を<code>req_core</code>に割り当てます ( リスト11 )。</p><p><span class="caption">▼リスト15.11: ACLINTへのアクセス結果をreqに割り当てる (mmio_controller.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: req &lt;&gt; aclint_membus;
</code></pre></div><p>ACLINTのインターフェースに要求を割り当てます ( リスト12 )。</p><p><span class="caption">▼リスト15.12: ACLINTにreqを割り当ててアクセス要求する (mmio_controller.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>Device::ACLINT: {
    aclint_membus      &lt;&gt; req;
...
</code></pre></div><p><span class="caption">▼リスト15.14: mmio_controllerモジュールと接続するインターフェースのインスタンス化 (top.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> aclint_membus  : Membus;
</code></pre></div><p>aclint_memoryモジュールをインスタンス化し、 mmio_controllerモジュールと接続します ( リスト15、 リスト16 )。</p><p><span class="caption">▼リスト15.15: aclint_memoryモジュールをインスタンス化する (top.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> aclintm: aclint_memory (
    clk                    ,
    rst                    ,
    membus: aclint_membus  ,
    aclint: aclint_core_bus,
);
</code></pre></div><p><span class="caption">▼リスト15.16: mmio_controllerモジュールと接続する (top.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> mmioc: mmio_controller (
    clk                           ,
    rst                           ,
...
</code></pre></div><p><span class="caption">▼リスト15.18: coreモジュールにaclint_ifインターフェースを接続する (top.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> c: core (
    clk                      ,
    rst                      ,
...
</code></pre></div><p>aclint_memoryモジュールに<code>msip0</code>レジスタを作成し、読み書きできるようにします ( リスト22、 リスト23、 リスト24 )。</p><p><span class="caption">▼リスト15.22: msip0レジスタの定義 (aclint_memory.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> msip0: <span class="hljs-keyword">logic</span>;
</code></pre></div><p><span class="caption">▼リスト15.23: msip0レジスタを0でリセットする (aclint_memory.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
        membus.rvalid = <span class="hljs-number">0</span>;
        membus.rdata  = <span class="hljs-number">0</span>;
        <span class="custom-hl-bold">msip0         = <span class="hljs-number">0</span>;</span>
</code></pre></div><p><span class="caption">▼リスト15.24: msip0レジスタの書き込み、読み込み (aclint_memory.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> membus.valid {
...
</code></pre></div><h3 id="mip、mieレジスタを実装する" tabindex="-1">mip、mieレジスタを実装する <a class="header-anchor" href="#mip、mieレジスタを実装する" aria-label="Permalink to “mip、mieレジスタを実装する”">​</a></h3><p><img src="`+t+'" alt="mipレジスタ"><img src="'+o+`" alt="mieレジスタ"> mipレジスタのMSIPビット、mieレジスタのMSIEビットを実装します。 mie.MSIEはMSIPビットによる割り込み待機を許可するかを制御するビットです。 mip.MSIPとmie.MSIEは同じ位置のビットに配置されています。 mip.MSIPに書き込むことはできません。</p><p>csrunitモジュールにmieレジスタを作成します ( リスト26、 リスト27 )。</p><p><span class="caption">▼リスト15.26: mieレジスタの定義 (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">var</span> mie     : UIntX ;
</code></pre></div><p><span class="caption">▼リスト15.27: mieレジスタを0でリセットする (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if_reset</span> {
    mode     = PrivMode::M;
...
</code></pre></div><p>mie、mipレジスタの値を読み込めるようにします (リスト29)。</p><p><span class="caption">▼リスト15.29: rdataにmip、mieレジスタの値を割り当てる (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::MTVEC   : mtvec,
<span class="custom-hl-bold">CsrAddr::MIP     : mip,</span>
<span class="custom-hl-bold">CsrAddr::MIE     : mie,</span>
CsrAddr::MCYCLE  : mcycle,
</code></pre></div><p>mieレジスタの書き込みマスクを設定して、MSIEビットを書き込めるようにします ( リスト30、 リスト31、 リスト32 )。 あとでMTIMEデバイスを実装するときにMTIEビットを使うため、 ここでMTIEビットも書き込めるようにしておきます。</p><p><span class="caption">▼リスト15.30: mieレジスタの書き込みマスクの定義 (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> MIE_WMASK     : UIntX = <span class="hljs-number">&#39;h0000_0000_0000_0088</span> <span class="hljs-keyword">as</span> UIntX;
</code></pre></div><p><span class="caption">▼リスト15.31: wmaskに書き込みマスクを設定する (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::MTVEC   : MTVEC_WMASK,
<span class="custom-hl-bold">CsrAddr::MIE     : MIE_WMASK,</span>
CsrAddr::MSCRATCH: MSCRATCH_WMASK,
</code></pre></div><p><span class="caption">▼リスト15.32: mieレジスタの書き込み (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> is_wsc {
...
</code></pre></div><p><span class="caption">▼リスト15.34: レジスタの場所を変数に割り当てる (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// mstatus bits</span>
...
</code></pre></div><p><span class="caption">▼リスト15.37: mem_is_newをcan_intrに割り当てる (core.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>rs1_data   : memq_rdata.rs1_data  ,
<span class="custom-hl-bold">can_intr   : mems_is_new          ,</span>
rdata      : csru_rdata           ,
</code></pre></div><p>トラップが発生するときにmemunitモジュールを無効にします ( リスト38 )。 今まではEXステージまでに例外が発生することが分かっていたら無効にしていましたが、 csrunitモジュールからトラップが発生するかどうかの情報を直接得るようにします。</p><p><span class="caption">▼リスト15.38: validの条件を変更する (core.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> memu: memunit (
    clk                                   ,
    rst                                   ,
...
<span class="custom-hl-bold">    <span class="hljs-keyword">default</span>        : <span class="hljs-number">0</span>,</span>
<span class="custom-hl-bold">};</span>
</code></pre></div><p>割り込みの時にMRET命令の判定が<code>0</code>になるようにします (リスト42)。</p><p><span class="caption">▼リスト15.42: 割り込みが発生するとき、trap_returnを0にする (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// Trap Return</span>
<span class="hljs-keyword">assign</span> trap_return = valid &amp;&amp; is_mret &amp;&amp; !raise_expt <span class="custom-hl-bold">&amp;&amp; !raise_interrupt</span>;
</code></pre></div><p>トラップが発生するとき、 例外の場合にのみmtvalレジスタに例外に固有の情報が書き込まれます。 本書では例外を優先するので、 <code>raise_expt</code>が<code>1</code>ならmtvalレジスタに書き込むようにします (リスト43)。</p><p><span class="caption">▼リスト15.43: 例外が発生したときにのみmtvalレジスタに書き込む (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> raise_trap {
...
</code></pre></div><p>例外のトラップベクタを、mtvecレジスタの下位2ビットを<code>0</code>にしたアドレス(Direct)に変更します ( リスト47、 リスト48 )。 新しく<code>expt_vector</code>を定義し、<code>trap_vector</code>に割り当てます。</p><p><span class="caption">▼リスト15.47: 例外のトラップベクタ (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> expt_vector: Addr = {mtvec[<span class="hljs-keyword">msb</span>:<span class="hljs-number">2</span>], <span class="hljs-number">2&#39;b0</span>};
</code></pre></div><p><span class="caption">▼リスト15.48: expt_vectorをtrap_vectorに割り当てる (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">assign</span> trap_vector = <span class="hljs-keyword">switch</span> {
...
</code></pre></div><p><span class="caption">▼リスト15.50: レジスタを0でリセットする (aclint_memory.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_ff</span> {
    <span class="hljs-keyword">if_reset</span> {
        membus.rvalid = <span class="hljs-number">0</span>;
        membus.rdata  = <span class="hljs-number">0</span>;
...
</code></pre></div><p><span class="caption">▼リスト15.51: mtime、mtimecmpの書き込み、読み込み (aclint_memory.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> membus.wen {
    <span class="hljs-keyword">let</span> M: <span class="hljs-keyword">logic</span>&lt;MEMBUS_DATA_WIDTH&gt; = membus.wmask_expand();
    <span class="hljs-keyword">let</span> D: <span class="hljs-keyword">logic</span>&lt;MEMBUS_DATA_WIDTH&gt; = membus.wdata &amp; M;
    <span class="hljs-keyword">case</span> addr {
        MMAP_ACLINT_MSIP    : msip0     = D[<span class="hljs-number">0</span>] | msip0 &amp; ~M[<span class="hljs-number">0</span>];
...
</code></pre></div><p><span class="caption">▼リスト15.53: mtipにタイマ割り込みが発生する条件を設定する (aclint_memory.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    aclint.msip = msip0;
    <span class="custom-hl-bold">aclint.mtip = mtime &gt;= mtimecmp0;</span>
}
</code></pre></div><h3 id="mip-mtip、割り込み原因を設定する" tabindex="-1">mip.MTIP、割り込み原因を設定する <a class="header-anchor" href="#mip-mtip、割り込み原因を設定する" aria-label="Permalink to “mip.MTIP、割り込み原因を設定する”">​</a></h3><p>mipレジスタのMTIPビットにaclint_ifインターフェースの<code>mtip</code>を接続します (リスト54)。</p><p><span class="caption">▼リスト15.54: mip.MTIPにインターフェースのmtipを割り当てる (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> mip: UIntX = {
    <span class="hljs-number">1&#39;b0</span> <span class="hljs-keyword">repeat</span> XLEN - <span class="hljs-number">12</span>, <span class="hljs-comment">// 0, LCOFIP</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// MEIP</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// 0</span>
    <span class="hljs-number">1&#39;b0</span>, <span class="hljs-comment">// SEIP</span>
...
</code></pre></div><p>WFI命令で割り込みが発生するとき、mepcレジスタに<code>pc + 4</code>を書き込むようにします ( リスト58、 リスト59 )。</p><p><span class="caption">▼リスト15.58: WFI命令の判定 (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">let</span> is_wfi: <span class="hljs-keyword">logic</span> = inst_bits == <span class="hljs-number">32&#39;h10500073</span>;
</code></pre></div><p><span class="caption">▼リスト15.59: WFI命令のとき、mepcをpc+4にする (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if</span> raise_expt || raise_interrupt {
...
</code></pre></div><p><span class="caption">▼リスト15.62: mtimeをインターフェースに割り当てる (aclint_memory.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">always_comb</span> {
    aclint.msip  = msip0;
    aclint.mtip  = mtime &gt;= mtimecmp0;
    <span class="custom-hl-bold">aclint.mtime = mtime;</span>
}
</code></pre></div><p>time、instret、cycleレジスタを読み込めるようにします (リスト63)。</p><p><span class="caption">▼リスト15.63: rdataにインターフェースのmtimeを割り当てる (csrunit.veryl)</span></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code>CsrAddr::CYCLE   : mcycle,
CsrAddr::TIME    : aclint.mtime,
CsrAddr::INSTRET : minstret,
</code></pre></div><hr class="footnotes-sep"><section class="footnotes"><ol class="footnotes-list"><li id="fn1" class="footnote-item"><p>コンパイル、実行方法は<a href="./12-impl-mmio.html">「11.6.4 出力をテストする」</a>を参考にしてください。 <a href="#fnref1" class="footnote-backref">↩︎</a></p></li><li id="fn2" class="footnote-item"><p>mhpmcounterレジスタと同じ値をとるhpmcounterレジスタもありますが、mhpmcounterレジスタを実装していないので実装しません。 <a href="#fnref2" class="footnote-backref">↩︎</a></p></li></ol></section>`,244)])])}const _=a(d,[["render",i]]);export{v as __pageData,_ as default};
