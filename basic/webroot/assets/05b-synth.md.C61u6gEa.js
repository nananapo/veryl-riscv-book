...
</code></pre></div><p>書き込みマスクはすべて書き込み可にします(リスト2)。</p><p><span class="caption">▼リスト8.2: LEDの制御用レジスタの書き込みマスク (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/43a36fa71ba6387dfd46d998062b89da286496fc~1..43a36fa71ba6387dfd46d998062b89da286496fc#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">const</span> LED_WMASK   : UIntX = <span class="hljs-number">&#39;hffff_ffff_ffff_ffff</span>;
</code></pre></div><p>LEDの制御用レジスタをcsrunitモジュールのポートに定義します。CSRの幅はUIntXです(リスト3)。</p><p><span class="caption">▼リスト8.3: LEDの制御用レジスタを定義する (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/43a36fa71ba6387dfd46d998062b89da286496fc~1..43a36fa71ba6387dfd46d998062b89da286496fc#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">module</span> csrunit (
    ...
...
</code></pre></div><p><code>rdata</code>と<code>wmask</code>にLEDの制御用レジスタの値を割り当てます(リスト4)。</p><p><span class="caption">▼リスト8.4: rdataとwmaskに値を割り当てる (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/43a36fa71ba6387dfd46d998062b89da286496fc~1..43a36fa71ba6387dfd46d998062b89da286496fc#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-comment">// read</span>
...
wmask = <span class="hljs-keyword">case</span> csr_addr {
...
</code></pre></div><p>リセット時にLEDの制御用レジスタの値を0に設定します(リスト5)。</p><p><span class="caption">▼リスト8.5: リセット値の設定 (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/43a36fa71ba6387dfd46d998062b89da286496fc~1..43a36fa71ba6387dfd46d998062b89da286496fc#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">if_reset</span> {
...
</code></pre></div><p>LEDの制御用レジスタへの書き込み処理を実装します(リスト6)。</p><p><span class="caption">▼リスト8.6: LEDの制御用レジスタへの書き込み (csrunit.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/43a36fa71ba6387dfd46d998062b89da286496fc~1..43a36fa71ba6387dfd46d998062b89da286496fc#diff-44dd9efb5b2797bbd5248f96206e5f13442629b6dd3cda87990e383f99c2aeec">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">case</span> csr_addr {
    ...
    <span class="custom-hl-bold">led     : <span class="hljs-keyword">output</span>  UIntX                                    ,</span>
</code></pre></div><p><span class="caption">▼リスト8.8: csrunitモジュールのledポートと接続する (core.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/43a36fa71ba6387dfd46d998062b89da286496fc~1..43a36fa71ba6387dfd46d998062b89da286496fc#diff-bdad1723f95a5423ff5ab8ba69bb572aabe1c8def0cda1748f6f980f61b57510">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> csru: csrunit (
    clk                            ,
    rst                            ,
    valid   : mems_valid           ,
    pc      : mems_pc              ,
...
</code></pre></div><p><span class="caption">▼リスト8.10: coreモジュールのledポートと接続する (top.veryl)</span> <a href="https://github.com/nananapo/bluecore/compare/43a36fa71ba6387dfd46d998062b89da286496fc~1..43a36fa71ba6387dfd46d998062b89da286496fc#diff-0c548fd82f89bdf97edffcd89dfccd2aab836eccf57f11b8e25c313abd0d0e6f">差分をみる</a></p><div class="language-veryl"><button title="Copy Code" class="copy"></button><span class="lang">veryl</span><pre class="hljs"><code><span class="hljs-keyword">inst</span> c: core (
    clk       ,
    rst       ,
    i_membus  ,
    d_membus  ,
...
</code></pre></div><p>CSRの読み書きによってLED制御用のポートを制御できるようになりました。</p><h3 id="テストを作成する" tabindex="-1">テストを作成する <a class="header-anchor" href="#テストを作成する" aria-label="Permalink to “テストを作成する”">​</a></h3><h4 id="ledを点灯させるプログラム" tabindex="-1">LEDを点灯させるプログラム <a class="header-anchor" href="#ledを点灯させるプログラム" aria-label="Permalink to “LEDを点灯させるプログラム”">​</a></h4><p>LEDを点灯させるプログラムを作成します(リスト11、リスト12)。 CSRRWI命令で<code>0x800</code>に12(<code>&#39;b01100</code>)を書き込みます。</p><p><span class="caption">▼リスト8.11: LEDを点灯させるプログラム (test/led.asm)</span> <a href="https://github.com/nananapo/bluecore/compare/df995f80a875eab531f1f20f47498724191f0e91~1..df995f80a875eab531f1f20f47498724191f0e91#diff-284afde569993ef66f621362c3367f42ad28b59b7784a967fb76fecfaf1cdf34">差分をみる</a></p><div class="language-asm"><button title="Copy Code" class="copy"></button><span class="lang">asm</span><pre class="hljs"><code>80065073 //  0: csrrwi x0, 0x800, 12
00000067 //  4: jal x0, 0
</code></pre></div><p><span class="caption">▼リスト8.12: LEDを点灯させるプログラム (test/led.hex)</span> <a href="https://github.com/nananapo/bluecore/compare/df995f80a875eab531f1f20f47498724191f0e91~1..df995f80a875eab531f1f20f47498724191f0e91#diff-bb7cb663c9af36f3d1c8abf0808fcce6ba06f23d970b15280e94460c26a9fe8e">差分をみる</a></p><div class="language-hex"><button title="Copy Code" class="copy"></button><span class="lang">hex</span><pre class="hljs"><code>0000006780065073
</code></pre></div><h4 id="ledを点滅させるプログラム" tabindex="-1">LEDを点滅させるプログラム <a class="header-anchor" href="#ledを点滅させるプログラム" aria-label="Permalink to “LEDを点滅させるプログラム”">​</a></h4><p>LEDを点滅させるプログラムを作成します(リスト13、リスト14)。 これはちょっと複雑です。</p><p><span class="caption">▼リスト8.13: LEDを点滅させるプログラム (test/led_counter.asm)</span> <a href="https://github.com/nananapo/bluecore/compare/df995f80a875eab531f1f20f47498724191f0e91~1..df995f80a875eab531f1f20f47498724191f0e91#diff-790bb5a898a4cda6cc0bb5372bcef8a568ba4515bad7cde1b6eada40dd3bf722">差分をみる</a></p><div class="language-asm"><button title="Copy Code" class="copy"></button><span class="lang">asm</span><pre class="hljs"><code>000f40b7 //  0: lui x1, 244
