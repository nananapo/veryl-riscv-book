...
作成したことがあってもなくても大歓迎、この本はCPU自作の面白さVerylを世に広めるために執筆されました。
...
RISC-Vの最新の仕様は、GitHubのriscv/riscv-isa-manual (@<href>{https://github.com/riscv/riscv-isa-manual/}) で確認することができます。

RISC-Vには、基本整数命令セットとしてRV32I, RV64I, RV32E, RV64E(, RV128I)が定義されています。
...
Verylの詳細や記法については@<chapref>{03-veryl}で解説します。

他には、シミュレーションやテストのためにC++, Pythonを利用します。
