...
//image[pynq_z1_gpio][LEDとボタン@<fn>{pynq_sc}][width=50%]

//footnote[pynq_sc][PYNQ-Z1 Reference Manual - Digilent Reference, https://digilent.com/reference/programmable-logic/pynq-z1/reference-manual]
