...
AMOAND.W/D		メモリから32/64ビット読み込み@<br>{}rs2の値をAND演算して書き込む
AMOOR.W/D		メモリから32/64ビット読み込み@<br>{}rs2の値をOR演算して書き込む
AMOXOR.W/D		メモリから32/64ビット読み込み@<br>{}rs2の値をXOR演算して書き込む
...
//list[top.veryl.empty.core][ポートに割り当てるインターフェースを変更する (top.veryl)][lineno=on]{
