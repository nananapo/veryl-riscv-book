...
本書は、OSを実行できる程度の機能を持ったRISC-VのCPUを、新しめのハードウェア記述言語であるVerylで記述する方法について解説した本です。
本書は無料で、pdf版は@<href>{https://github.com/nananapo/veryl-riscv-book}で入手することができます。
 ...
 * URL: @<href>{https://github.com/nananapo/veryl-riscv-book/issues}
